---
title: "使用 Resource Manager 中的 PowerShell 建立內部負載平衡器 | Microsoft Docs"
...
您可以在下列文件中找到建立虛擬機器並指派給 NIC 的逐步指示︰[使用 PowerShell 建立 Azure VM](../virtual-machines/virtual-machines-windows-ps-create.md)。
