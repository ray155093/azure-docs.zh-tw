<properties
   pageTitle="使用 Resource Manager 中的 Azure CLI 建立內部負載平衡器 | Microsoft Azure"
...
1. 若您未安裝 Azure CLI，請參閱[安裝和設定 Azure CLI](../../articles/xplat-cli-install.md)。請依照指示操作到選取 Azure 帳戶和訂用帳戶之處。
