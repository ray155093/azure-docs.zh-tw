---
title: "如何新增或變更 Azure 管理員角色 | Microsoft Docs"
...
# <a name="how-to-add-or-change-azure-administrator-roles"></a>如何新增或變更 Azure 管理員角色
 帳戶管理員、服務管理員和共同管理員是 Microsoft Azure 中的三種系統管理員角色。 若要檢視帳單資訊及訂用帳戶，您必須以帳戶管理員的身分登入[帳戶中心](https://account.windowsazure.com/Home/Index)。 下表說明這三個系統管理角色之間的差異。
...
## <a name="how-to-add-an-admin-for-a-subscription"></a>如何新增訂用帳戶的管理員
**Azure 入口網站**

若要在 Azure 入口網站中將某人新增為訂用帳戶的系統管理員，請賦予他擁有者角色。 擁有者角色只能管理您指派之訂用帳戶中的資源。 此角色沒有其他訂用帳戶的存取權限。 您透過 [Azure 入口網站](https://portal.azure.com)新增的擁有者無法管理 [Azure 傳統入口網站](https://manage.windowsazure.com)中的資源。 
...
* **Organizational account**</br>
  組織帳戶是建立在 Azure Active Directory 之下的帳戶。 組織帳戶地址的格式如下︰
    ...
    user@&lt;您的網域&gt;.onmicrosoft.com

## <a name="limitations-and-restrictions-to-administrator-accounts"></a>系統管理員帳戶的限制和約束
...
## <a name="how-to-change-service-administrator-for-a-subscription"></a>如何變更訂用帳戶的服務管理員
...
## <a name="how-to-check-the-account-administrator-of-the-subscription"></a>如何檢查訂用帳戶的帳戶管理員
...
* 如需有關 Azure Active Directory 與您的 Azure 訂用帳戶產生關聯之方式的詳細資訊，請參閱 [Azure 訂用帳戶如何與 Azure Active Directory 產生關聯](active-directory/active-directory-how-subscriptions-associated-directory.md)和[指派 Azure Active Directory 中的管理員角色](active-directory/active-directory-assign-admin-roles.md)。
