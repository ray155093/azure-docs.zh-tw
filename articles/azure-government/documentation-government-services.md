---
title: "Azure Government 服務 | Microsoft Docs"
...
---
# <a name="azure-government-services"></a>Azure Government 服務
Azure Government 持續擴充可用的服務。  這些服務是使用 Azure 公用中所使用之相同程式碼進行部署。  本節記載兩個重要類型的資訊︰
...
* [BGP 社群支援](documentation-government-networking.md#support-for-bgp-communities)
* 虛擬網路
* [負載平衡器](documentation-government-networking.md#support-for-load-balancer)
* 應用程式閘道
* [流量管理員](documentation-government-networking.md#support-for-traffic-manger)
* [VPN 閘道](documentation-government-networking.md#support-for-vpn-gateway)
...
* [金鑰保存庫](documentation-government-services-securityandidentity.md#key-vault)
