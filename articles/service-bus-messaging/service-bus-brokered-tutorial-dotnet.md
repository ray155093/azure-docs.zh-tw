...
### <a name="create-a-receiver-and-receive-messages-from-the-queue"></a>建立接收者並從佇列接收訊息
...
### <a name="end-the-queue-method-and-clean-up-resources"></a>結束 Queue 方法並清除資源
...
## <a name="build-and-run-the-queuesample-application"></a>建置並執行 QueueSample 應用程式

既然您已完成上述步驟，您可以建置並執行 **QueueSample** 應用程式。

### <a name="build-the-queuesample-application"></a>建置 QueueSample 應用程式
