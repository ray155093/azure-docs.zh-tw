# 概觀
## [什麼是服務匯流排傳訊？](service-bus-queues-topics-subscriptions.md)
...
### [搭配使用 AMQP 與 .NET API](service-bus-dotnet-advanced-message-queuing.md)
### [搭配使用 AMQP 與分割的佇列及主題](service-bus-partitioned-queues-and-topics-amqp-overview.md)
### [配對的命名空間](service-bus-paired-namespaces.md)
### [建立實體與自動轉寄的鏈結](service-bus-auto-forwarding.md)
## 管理
### [使用 ARM 範本](service-bus-resource-manager-overview.md)
