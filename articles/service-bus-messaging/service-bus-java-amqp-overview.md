...
# <a name="amqp-1.0-support-in-service-bus"></a>服務匯流排中的 AMQP 1.0 支援
...
## <a name="introduction:-what-is-amqp-1.0-and-why-is-it-important?"></a>簡介：何謂 AMQP 1.0 以及它為什麼很重要？
...
## <a name="amqp-1.0-technical-features"></a>AMQP 1.0 技術功能
...
## <a name="amqp-1.0-is-a-standard-(with-a-capital-'s')"></a>AMQP 1.0 是一項標準 (Standard 的 S 為大寫)
...
## <a name="amqp-1.0-and-service-bus"></a>AMQP 1.0 和服務匯流排
...
如需有關如何取得及使用這些程式庫與服務匯流排的詳細資訊，請參閱[服務匯流排 AMQP 開發人員指南][]。 請參閱[後續步驟](service-bus-java-amqp-overview.md#next-steps)一節以取得進一步資訊的連結。
