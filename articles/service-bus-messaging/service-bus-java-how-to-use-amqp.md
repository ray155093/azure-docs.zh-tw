<properties 
	...
	description="了解如何搭配 Azure 服務匯流排和 Advanced Message Queuing 使用 Java Message Service (JMS)。"
...
> [AZURE.NOTE] 從服務匯流排主題訂用帳戶收到在 JNDI 中指定的實體名稱應該是主題的名稱。以 JMS 應用程式程式碼建立持續性訂用帳戶時，將建立訂用帳戶名稱。[服務匯流排 AMQP 1.0 開發人員指南](service-bus-amqp-dotnet.md)提供從 JMS 處理服務匯流排主題訂用帳戶的詳細資料。
