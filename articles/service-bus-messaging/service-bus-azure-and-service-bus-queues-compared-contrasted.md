...
>[AZURE.NOTE] 所有成本都可能會變更。 上表反映目前定價，不包括目前可能適用的任何促銷優惠方案。 如需 Azure 的最新價格資訊，請參閱 [Azure 價格](https://azure.microsoft.com/pricing/)頁面。 如需服務匯流排價格的詳細資訊，請參閱[服務匯流排價格](https://azure.microsoft.com/pricing/details/service-bus/)。
