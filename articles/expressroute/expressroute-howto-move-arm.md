...
## <a name="enable-an-expressroute-circuit-for-both-deployment-models"></a>為兩種部署模型啟用 ExpressRoute 電路
...
## <a name="disable-the-expressroute-circuit-to-the-classic-deployment-model"></a>停用傳統部署模型的 ExpressRoute 電路
