...
如果前置詞數目超過此限制，則會捨棄 BGP 工作階段。我們只會接受私人對等互連連結上的預設路由。提供者或客戶必須從其對於 Azure 公用和 Microsoft 對等互連路徑的 BGP 公告中篩選出預設路由和私人 IP 位址 (RFC 1918)。
...
>[AZURE.NOTE] Microsoft 不接受任何您在向 Microsoft 通告的路由上設定的 BGP 社群值。
