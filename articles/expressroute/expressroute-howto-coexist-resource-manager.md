...
>[AZURE.IMPORTANT] 在執行下列指示之前，必須事先設定 ExpressRoute 線路。 在執行下列步驟之前，請確定您已遵循[建立 ExpressRoute 線路](expressroute-howto-circuit-arm.md)和[設定路由](expressroute-howto-routing-arm.md)的指南。
