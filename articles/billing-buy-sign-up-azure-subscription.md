...
| MPN (Microsoft 合作夥伴網路) - 成員每月都會收到免費的 Azure 點數 |•  [適用於合作夥伴的 Azure 權益](https://azure.microsoft.com/offers/ms-azr-0025p/)</br>•   [註冊為合作夥伴](http://go.microsoft.com/fwlink/?linkid=309258&clcid=0x409)或[訂閱 Microsoft Action Pack](http://go.microsoft.com/fwlink/?linkid=525768&clcid=0x409)</br>• 使用 Azure 點數 - 存取 [MPN 入口網站](https://partner.microsoft.com)，並驗證自己的資格狀態，然後遵循「軟體金鑰與權益」下方的步驟。 如果您無法驗證自己的資格，請連絡 [MPN 支援](https://partner.microsoft.com/Support/)。 |
...
3. 在 [關於您]  區段輸入個人資訊。 [深入了解](billing-troubleshoot-azure-sign-up-issues.md#i-am-getting-an-error-when-entering-my-information-to-sign-up) 如何正確輸入您的個人資訊。
...
* [我無法啟用 Azure 免費試用](billing-troubleshoot-azure-sign-up-issues.md#i-cant-activate-an-azure-free-trial)
