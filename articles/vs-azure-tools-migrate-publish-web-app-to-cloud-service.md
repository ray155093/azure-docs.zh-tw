...
1. 若要設定您的應用程式要發佈至 Azure 的服務，您必須擁有 Microsoft 帳戶和 Azure 訂用帳戶。使用下列主題中的步驟設定服務：[準備從 Visual Studio 發佈或部署 Azure 應用程式](vs-azure-tools-cloud-service-publish-set-up-required-services-in-visual-studio.md)。
