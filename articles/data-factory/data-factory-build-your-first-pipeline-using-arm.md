...
> [AZURE.NOTE] 您可以在 [Github](https://github.com/Azure/azure-quickstart-templates/blob/master/101-data-factory-blob-to-sql/azuredeploy.json) 上找到可供建立 Azure Data Factory 的其他 Resource Manager 範本範例。
