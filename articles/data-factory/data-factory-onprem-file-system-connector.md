<properties
    pageTitle="將資料移進和移出檔案系統 | Microsoft Azure"
...
> [AZURE.NOTE] 我們建議您[將閘道器升級為資料管理閘道 2.0 或更新版本](data-factory-data-management-gateway.md#update-data-management-gateway)，以利用最新功能和修正。
...
> [AZURE.NOTE] 無法同時使用 fileName 和 fileFilter。
