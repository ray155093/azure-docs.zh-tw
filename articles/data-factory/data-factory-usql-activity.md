---
title: "從 Azure Data Factory 在 Azure 資料湖分析上執行 U-SQL 指令碼"
...
---
# <a name="run-u-sql-script-on-azure-data-lake-analytics-from-azure-data-factory"></a>從 Azure Data Factory 在 Azure 資料湖分析上執行 U-SQL 指令碼
