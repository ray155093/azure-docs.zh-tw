...
### [資料移動活動](data-factory-data-movement-activities.md)
### [資料轉換活動](data-factory-data-transformation-activities.md)
...
## [教學課程︰將資料從內部部署移至雲端](data-factory-move-data-between-onprem-and-cloud.md)
## [教學課程︰在管線中建立和使用自訂活動](data-factory-use-custom-activities.md)

# 作法：
## 移動資料
### [Data Factory 複製精靈](data-factory-copy-wizard.md)
### [用複製精靈在 15 分鐘之後載入 1 TB](data-factory-load-sql-data-warehouse.md)
### [複製活動](data-factory-data-movement-activities.md)
### [混合式資料移動](data-factory-move-data-between-onprem-and-cloud.md)
### [資料管理閘道](data-factory-data-management-gateway.md)
### [複製活動的效能及微調指南](data-factory-copy-activity-performance.md)
...
## 開發
### [使用 Azure 入口網站](data-factory-copy-activity-tutorial-using-azure-portal.md)
...
### [使用 Azure Resource Manager 範本](data-factory-how-to-use-resource-manager-templates.md)
...
## 監視及管理
### [使用 Azure 入口網站](data-factory-api-change-log.md)
