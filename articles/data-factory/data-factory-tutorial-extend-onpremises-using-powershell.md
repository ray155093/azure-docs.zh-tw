<properties 
	pageTitle="逐步解說：將輸出資料複製到 SQL Server 資料庫 (Azure PowerShell)" 
...
# 逐步解說：將輸出資料複製到內部部署的 SQL Server 資料庫 (Azure PowerShell)
...
您現在可以使用[監視管線](data-factory-tutorial-using-powershell.md#monitor-pipelines)中介紹的相同步驟來監視新內部部署 ADF 資料表的新管線和資料配量。
