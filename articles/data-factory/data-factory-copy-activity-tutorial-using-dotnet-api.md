...
6. 將下列 **appSetttings** 區段新增 **App.config** 檔案。 以下 Helper 方法會使用這些設定： **Microsoft.identitymodel.waad.preview.graph.graphinterface**。 
...
9. 將下列會建立 **Azure SQL 連結服務**的程式碼新增至 **Main** 方法中。
    ...
    > [AZURE.IMPORTANT] 以您的 Azure SQL 伺服器名稱、資料庫名稱、使用者和密碼取代 **servername**、**databasename**、**username** **password**。  
...
13. 將 **Main** 方法所使用的下列 Helper 方法新增至 **Program** 類別中。  
