...
> [!NOTE]
> 如果您需要更多雲端 DMU 以提高輸送量，請連絡 [Azure 支援](https://azure.microsoft.com/support/)。 目前只有當您是將多個檔案從 Blob 儲存體複製到 Blob 儲存體、Data Lake Store 或 Azure SQL Database，且個別檔案的大小大於或等於 16 MB 時，設定 8 及 8 以上的值才有作用。
> 
> 
