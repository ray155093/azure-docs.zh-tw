...
## <a name="azure-cloud-services-web-and-worker-roles"></a>Azure 雲端服務 Web 和背景工作角色
...
### <a name="running-background-tasks-in-the-web-role"></a>在 Web 角色中執行背景工作

在 Web 角色中執行背景工作的主要優點在於裝載儲存成本，因為沒有部署其他角色的需求。

### <a name="running-background-tasks-in-a-worker-role"></a>在背景工作角色中執行背景工作
