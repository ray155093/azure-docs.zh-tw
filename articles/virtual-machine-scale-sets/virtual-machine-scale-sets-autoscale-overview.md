...
若要查看使用 PowerShell 設定自動調整的範例，請參閱 [Azure Insights PowerShell 快速入門範例](../azure-portal/insights-powershell-samples.md)。

## <a name="set-up-scaling-using-azure-cli"></a>使用 Azure CLI 設定調整

若要查看使用 Azure CLI 設定自動調整的範例，請參閱 [Azure Insights 跨平台 CLI 快速入門範例](../azure-portal/insights-cli-samples.md)。
