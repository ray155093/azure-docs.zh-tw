---
title: "建立虛擬機器擴展集 | Microsoft Docs"
description: "使用 Azure CLI 建立虛擬機器調整集"
...
---
# <a name="create-a-linux-virtual-machine-scale-set-using-azure-cli"></a>使用 Azure CLI 建立 Linux 虛擬機器調整集
