...
description: "了解如何使用 Azure CLI 2.0 建立虛擬機器擴展集"
...
---
# <a name="create-a-linux-virtual-machine-scale-set-with-the-azure-cli-20"></a>使用 Azure CLI 2.0 建立 Linux 虛擬機器擴展集

本文使用 Azure CLI 2.0。 如果您想要使用 Azure CLI 1.0，請參閱[這篇文章](./virtual-machine-scale-sets-linux-create-cli-nodejs.md)。
