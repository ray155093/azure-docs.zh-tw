<properties
	pageTitle="擴展集 CLI 入口網站建立 | Microsoft Azure"
...
您可以輕易地從入口網站使用 CentOS、CoreOS、Debian、Open Suse、Red Hat Enterprise Linux、SUSE Linux Enterprise Server，或 Ubuntu Server 映像部署擴展集。
