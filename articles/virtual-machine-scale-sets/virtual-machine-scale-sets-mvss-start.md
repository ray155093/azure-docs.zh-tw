---
title: "了解 Azure 虛擬機器擴展集範本 | Microsoft Docs"
description: "了解如何為「Azure 虛擬機器擴展集」建立最基本的可行擴展集範本"
