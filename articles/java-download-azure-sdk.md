...
**注意：**Azure Libraries for Java 的散發係以 [Apache 授權 2.0 版][授權]為依據。
...
## <a name="azure-libraries-for-java---building-with-maven"></a>Azure Libraries for Java - 使用 Maven 建置
...
2. [Azure Toolkit for Eclipse 新功能] 一文中所列的 Macintosh 或 Linux 作業系統。
3. Eclipse IDE for Java EE Developers (Indigo 或更新版本)。 這可透過 <http://www.eclipse.org/downloads/> 下載。

### <a name="basic-installation-steps"></a>基本安裝步驟
