...
---
# <a name="managing-roles-in-the-azure-cloud-services-projects-with-visual-studio"></a>在使用 Visual Studio 的 Azure 雲端服務專案中管理角色
...
## <a name="removing-and-adding-roles-in-your-cloud-service"></a>在您的雲端服務中移除和新增角色
