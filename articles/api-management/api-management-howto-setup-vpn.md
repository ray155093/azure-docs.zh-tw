...
> VPN 連線僅供**進階**和**開發人員**層使用。若要切換到它，請在 [Azure 傳統入口網站][Azure 傳統入口網站]中開啟 API 管理服務，然後開啟 [調整] 索引標籤。在 [**一般**] 區段下選取進階層，然後按一下 [儲存]。
> 
> 

若要啟用 VPN 連線，請在 [Azure 傳統入口網站][Azure 傳統入口網站]中開啟 API 管理服務，然後切換到 [設定] 索引標籤。
