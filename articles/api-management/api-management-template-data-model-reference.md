...
##  <a name="a-namesamplea-code-sample"></a><a name="Sample"></a>程式碼範例  
...
##  <a name="a-namecommenta-comment"></a><a name="Comment"></a>註解  
 `API` 實體具有下列屬性。  
...
##  <a name="a-nameissuea-issue"></a><a name="Issue"></a>問題  
 `issue` 實體具有下列屬性。  
...
##  <a name="a-namefilteringa-filtering"></a><a name="Filtering"></a>篩選  
 `filtering` 實體具有下列屬性。  
...
##  <a name="a-nameheadera-header"></a><a name="Header"></a>標頭  
 本區段描述 `parameter` 表示法。  
...
##  <a name="a-namehttprequesta-http-request"></a><a name="HTTPRequest"></a>HTTP 要求  
 本區段描述 `request` 表示法。  
...
##  <a name="a-namehttpresponsea-http-response"></a><a name="HTTPResponse"></a>HTTP 回應  
 本區段描述 `response` 表示法。  
...
##  <a name="a-nameoperationa-operation"></a><a name="Operation"></a>作業  
 `operation` 實體具有下列屬性。  
...
##  <a name="a-namemenua-operation-menu"></a><a name="Menu"></a>作業功能表  
...
##  <a name="a-namemenuitema-operation-menu-item"></a><a name="MenuItem"></a>作業功能表項目  
...
##  <a name="a-namepaginga-paging"></a><a name="Paging"></a>分頁  
 `paging` 實體具有下列屬性。  
...
##  <a name="a-nameprovidera-provider"></a><a name="Provider"></a>提供者  
 `provider` 實體具有下列屬性。  
...
##  <a name="a-namerepresentationa-representation"></a><a name="Representation"></a>表示法  
...
##  <a name="a-namesubscriptiona-subscription"></a><a name="Subscription"></a>訂用帳戶  
...
##  <a name="a-namesubscriptionsummarya-subscription-summary"></a><a name="SubscriptionSummary"></a>訂用帳戶摘要  
...
##  <a name="a-nameuseraccountinfoa-user-account-info"></a><a name="UserAccountInfo"></a>使用者帳戶資訊  
...
##  <a name="a-nameusesignina-user-sign-in"></a><a name="UseSignIn"></a>使用者登入  
...
##  <a name="a-nameusersignupa-user-sign-up"></a><a name="UserSignUp"></a>使用者註冊  
...
|名字|字串|名字。 不能空白。 長度上限是 100 個字元。|  
|姓氏|字串|姓氏。 不能空白。 長度上限是 100 個字元。|  
|UserData|字串|[註冊](api-management-page-controls.md#sign-up)註冊控制項所使用的值。|  
