...
關於 Windows 型虛擬機器的系列主題，請參閱[使用 Azure PowerShell 建立以 Windows 為基礎的虛擬機器](virtual-machines-windows-classic-create-powershell.md)。
...
如需詳細資訊，請參閱[如何在 Azure 上搭配使用 SSH 與 Linux](virtual-machines-linux-ssh-from-linux.md)。
...
建立虛擬機器之後，請參閱[如何登入執行 Linux 的虛擬機器](virtual-machines-linux-classic-log-on.md)。
