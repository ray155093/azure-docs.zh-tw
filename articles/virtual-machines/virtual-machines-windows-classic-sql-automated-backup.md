<properties
	...
	description="針對 Azure 虛擬機器中以傳統部署模式執行的 SQL Server，說明自動備份功能。"
...
Azure 中的 SQL Server VM 相關功能為 [Azure 虛擬機器中的 SQL Server 自動修補](virtual-machines-windows-classic-sql-automated-patching.md)。
