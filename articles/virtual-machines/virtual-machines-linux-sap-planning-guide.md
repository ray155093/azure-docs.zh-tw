...
您只能透過 PowerShell 或 CLI 部署 Azure Monitoring Extension for SAP (請參閱本文中的[適用於 SAP 的 Azure 監視解決方案][planning-guide-9.1]一章)。因此，在 Azure 中部署或管理 SAP NetWeaver 系統時，請務必安裝及設定 PowerShell 或 CLI。
