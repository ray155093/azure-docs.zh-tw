...
---
# <a name="sap-netweaver-on-azure-virtual-machines--dbms-deployment-guide"></a>Azure 虛擬機器上的 SAP NetWeaver - DBMS 部署指南
...
* 第三方工具。如需有關備份和 Azure 上的 SAP 的更完整討論，請參閱 [SAP 備份指南](sap-hana-backup-guide.md)以取得詳細資訊。
