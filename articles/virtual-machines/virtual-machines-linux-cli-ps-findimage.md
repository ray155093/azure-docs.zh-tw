...
在您[安裝 Azure CLI 2.0 (預覽)](https://docs.microsoft.com/cli/azure/install-az-cli2) 之後，請使用 `az vm image list` 命令來查看已快取的常用 VM 映像清單。 例如，以下的 `az vm image list -o table` 命令範例會顯示：
