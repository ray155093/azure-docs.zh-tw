...
本文說明適用於 [預期狀態設定擴充處理常式](virtual-machines-windows-extensions-dsc-overview.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)的 Resource Manager 範本。 
...
## <a name="example"></a>範例
下列範例衍生自 [DSC 擴充處理常式概觀頁面](virtual-machines-windows-extensions-dsc-overview.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)的〈開始使用〉一節。
此範例使用 Resource Manager 範本 (而不是Cmdlet) 來部署擴充功能。 儲存 「"IisInstall.ps1" 組態，將它放在 .ZIP 檔中，然後以可存取的 URL 上傳此檔案。 此範例會使用 Azure Blob 儲存體，但可能從任意位置下載 .ZIP 檔案。
...
如需詳細資料，請參閱 [DSC 的安全認證管理](virtual-machines-windows-extensions-dsc-credentials.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。 
