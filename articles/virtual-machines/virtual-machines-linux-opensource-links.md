...
### 資料庫
- [在 Azure 上最佳化 MySQL 的效能](virtual-machines-linux-classic-optimize-mysql.md)
- [MySQL 叢集](virtual-machines-linux-classic-mysql-cluster.md)
- [在 Azure 上執行 Cassandra 搭配 Linux 並透過 Node.js 進行存取](virtual-machines-linux-classic-cassandra-nodejs.md)
- [建立 MariaDbs 的多重主機叢集](virtual-machines-linux-classic-mariadb-mysql-cluster.md)

### HPC
- [開始在 Azure 中的 HPC Pack 叢集使用 Linux 運算節點](virtual-machines-linux-classic-hpcpack-cluster.md)
...
- [做法：Node.js 和 Cassandra](virtual-machines-linux-classic-cassandra-nodejs.md)
...
- [將自訂資料插入 VM 中以搭配 Cloud-init 使用](virtual-machines-windows-classic-inject-custom-data.md)


## 儲存體

- [將資料磁碟連接至 Linux VM](virtual-machines-linux-classic-attach-disk.md)
- [從 Linux VM 卸離資料磁碟](virtual-machines-linux-classic-detach-disk.md)
- [RAID](virtual-machines-linux-configure-raid.md)


## 網路
- [如何在 Azure 中的傳統虛擬機器上設定端點](virtual-machines-linux-classic-setup-endpoints.md)
...
- [使用 corosync 安裝 Postgres，使用 ILB 安裝 pg\_bouncer](https://github.com/chgeuer/postgres-azure)
