...
## <a name="create-vm-sample-with-a-network-security-group"></a>使用網路安全性群組建立 VM 範例

[!code-azurecli[主要](../../../cli_scripts/virtual-machine/create-vm-nsg/create-windows-vm-nsg.sh "使用 NSG 建立 VM")]
