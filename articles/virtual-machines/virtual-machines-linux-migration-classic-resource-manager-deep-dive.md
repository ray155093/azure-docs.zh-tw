---
title: "在 Azure 中 Linux VM 的部署模型之間移轉 | Microsoft Docs"
...
## <a name="detailed-guidance-on-migration-at-a-resource-and-feature-level"></a>資源和功能層級的詳細移轉指引
...
## <a name="illustration-of-a-simple-migration-walkthrough"></a>簡單的移轉逐步解說圖解
在以下的範例螢幕擷取畫面中，您可以看到在準備階段後帶有一部 VM (不在虛擬網路中) 的雲端服務呈現。

![顯示「準備」階段之後傳統表示法的螢幕擷取畫面](./media/virtual-machines-windows-migration-classic-resource-manager/classic-migration-prepare-portal.png)
![顯示「準備」階段之後 Resource Manager 表示法的螢幕擷取畫面](./media/virtual-machines-windows-migration-classic-resource-manager/resourcemanager-migration-prepare-portal.png)
