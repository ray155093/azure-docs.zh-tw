...
> [!IMPORTANT] 
> Azure 建立和處理資源的部署模型有二種： [Resource Manager 和傳統](../azure-resource-manager/resource-manager-deployment-model.md)。 本文涵蓋之內容包括使用傳統部署模型。 Microsoft 建議讓大部分的新部署使用 Resource Manager 模式。 了解如何[使用 Resource Manager 模型執行這些步驟](https://github.com/Azure/azure-linux-extensions/tree/master/VMAccess)。
...
* 您需要[安裝 Azure CLI](../xplat-cli-install.md)，並[連接至您的訂用帳戶](../xplat-cli-connect.md)以使用您帳戶的相關 Azure 資源。
...
## <a name="a-namepwresetcliareset-the-password"></a><a name="pwresetcli"></a>重設密碼
...
## <a name="a-namesshkeyresetcliareset-the-ssh-key"></a><a name="sshkeyresetcli"></a>重設 SSH 金鑰
...
## <a name="a-nameresetbothcliareset-both-the-password-and-the-ssh-key"></a><a name="resetbothcli"></a>同時重設密碼和 SSH 金鑰
...
## <a name="a-namecreatenewsudocliacreate-a-new-sudo-user-account"></a><a name="createnewsudocli"></a>建立新的 sudo 使用者帳戶
...
## <a name="a-namesshconfigresetcliareset-the-ssh-configuration"></a><a name="sshconfigresetcli"></a>重設 SSH 組態
...
## <a name="a-namedeletecliadelete-a-user"></a><a name="deletecli"></a>刪除使用者
...
## <a name="a-namestatuscliadisplay-the-status-of-the-vmaccess-extension"></a><a name="statuscli"></a>顯示 VMAccess 擴充的狀態
...
## <a name="a-namecheckdiskacheck-consistency-of-added-disks"></a><a name='checkdisk'></a>檢查新增的磁碟的一致性
...
## <a name="a-namerepairdiskarepair-disks"></a><a name='repairdisk'></a>修復磁碟
