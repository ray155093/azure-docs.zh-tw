---
title: "建立及上傳 Linux VHD | Microsoft Docs"
...
您也可以[使用 Azure Resource Manager 上傳自訂磁碟映像](virtual-machines-linux-upload-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)。
...
[步驟 2：準備與 Azure 的連接]: #connect
[步驟 3：將映像上傳至 Azure]: #upload
