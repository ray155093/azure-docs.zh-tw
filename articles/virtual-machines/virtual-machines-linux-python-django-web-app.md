...
1. 按照[此處](virtual-machines-linux-quick-create-portal.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)所提供的指示，建立 Ubuntu Server 14.04 LTS 散發套件的 Azure 虛擬機器。  您也可以選擇以密碼驗證取代 SSH 公開金鑰。
2. 參考 [這裡](../virtual-network/virtual-networks-create-nsg-arm-pportal.md)的指示，編輯網路安全性群組以允許連接埠 80 的傳入 http 流量。
3. 根據預設，新的虛擬機器沒有完整網域名稱 (FQDN)。  您可以遵循[這裡](virtual-machines-linux-portal-create-fqdn.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)的指示建立一個 FQDN。  此為完成本教學課程的選擇性步驟。
