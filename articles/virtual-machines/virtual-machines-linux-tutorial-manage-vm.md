...
![預設 NGINX 網站](./media/virtual-machines-linux-tutorial-manage-vm/nginx.png)  
...
教學課程 - [建立負載平衡的虛擬機器](./virtual-machines-linux-tutorial-load-balance-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)

範例 – [Azure CLI 範例指令碼](./virtual-machines-linux-cli-samples.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
