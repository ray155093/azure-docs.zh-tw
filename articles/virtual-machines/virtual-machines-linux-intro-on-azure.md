...
3. 按一下 Azure 傳統入口網站中的 [擷取]  或使用 Powershell 或 CLI 工具，將虛擬機器擷取為映像。
   ...
   * 請參閱：[如何擷取 Linux 虛擬機器作為範本使用](linux/classic/capture-image.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
...
在 Linux 上，核心可能會將資料磁碟命名為 `/dev/sdc`，而使用者必須分割、格式化及掛接該資源。 [如何將資料磁碟連接至虛擬機器](linux/classic/attach-disk.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)的教學課程中涵蓋這部分的逐步指示。
