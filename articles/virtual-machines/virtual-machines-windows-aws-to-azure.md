---
title: "將 AWS VM 移轉至 Azure | Microsoft Docs"
description: "將 Amazon Web Services (AWS) EC2 執行個體移轉至 Azure 虛擬機器。 此案例使用受控磁碟來簡化您的雲端儲存體。"
...
開始此程序前，請務必先檢閱[規劃移轉至受控磁碟](virtual-machines-windows-on-prem-to-azure.md#plan-for-the-migration-to-managed-disks)。
...
2.    從 S3 貯體下載 VHD 檔案。 選取 VHD 檔案，然後選取 [動作] > [下載]。



## <a name="log-in-to-azure"></a>登入 Azure
如果尚未安裝 Azure PowerShell 版本，請參閱 [如何安裝和設定 Azure PowerShell](/powershell/azureps-cmdlets-docs)。
