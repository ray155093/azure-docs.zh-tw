...
您可以在[音樂市集 Linux 範本](https://github.com/neilpeterson/nepeters-azure-templates/tree/master/dotnet-core-music-linux-vm-sql-db)找到「音樂市集」Resource Manager 範本
