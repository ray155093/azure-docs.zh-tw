...
> [!NOTE]
> 在支援 RDMA 的計算密集型 VM 上，必須將 HpcVmDrivers 擴充功能新增到 VM 中，才能安裝 RDMA 連線所需的 Windows 網路裝置驅動程式。在大多數部署中，會自動新增 HpcVmDrivers 擴充功能。如果您需要自行新增擴充功能，請參閱[管理 VM 擴充功能](virtual-machines-windows-classic-manage-extensions.md)。
> 
> 
