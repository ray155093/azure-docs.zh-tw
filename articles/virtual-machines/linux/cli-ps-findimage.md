...
## 後續步驟
現在，您可以精確地選擇想要使用的映像。 若要使用您剛找到的 URN 資訊來快速建立虛擬機器，或使用範本搭配該 URN 資訊，請參閱[使用 Azure CLI 建立 Linux VM](quick-create-cli.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)。
