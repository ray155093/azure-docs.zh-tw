...
# 使用 SCP 從 Linux VM 移動檔案以及將檔案移至其中
...
如需有關設定您的 `~/.ssh/config` 與 SSH 公用和私密金鑰的詳細資訊，請依照本文，[建立 SSH 金鑰](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)。
