...
根據 VM 的大小而定，Azure 會強制限制資料磁碟數量和可用的頻寬量。 如需詳細資訊，請參閱 [虛擬機器的大小](sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)。
...
如需詳細資訊，請參閱[在 Linux VM 上設定 LVM](configure-lvm.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)。
