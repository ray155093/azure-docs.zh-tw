...
* [從 Azure CLI 建立用於開發和測試的 Linux VM](quick-create-cli-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [使用 Azure 範本建立受保護的 Linux VM](create-ssh-secured-vm-from-template.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
  ...
  * 下列範例使用 GitHub 上儲存的範本來建立 VM：
    ...
    ```
* [使用 Azure CLI 建立完整的 Linux 環境](create-cli-complete-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [上傳自訂磁碟映像並從這個映像建立 Linux VM](upload-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
