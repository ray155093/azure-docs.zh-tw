...
本文會示範如何透過 Azure CLI 2.0 製作 cloud-init 指令碼來設定主機名稱、更新已安裝的封裝及管理使用者帳戶。  當您從 Azure CLI 建立 VM 時，會呼叫 cloud-init 指令碼。  您也可以使用 [Azure CLI 1.0](using-cloud-init-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) 來執行這些步驟。
