...
了解如何[使用 Resource Manager 模型執行這些步驟](https://azure.microsoft.com/documentation/templates/datastax-on-ubuntu/)。
...
##### 1\.取消佈建
使用命令 “sudo waagent –deprovision+user” 移除虛擬機器執行個體的特定資訊。請參閱[如何擷取 Linux 虛擬機器作為範本使用](virtual-machines-linux-classic-capture-image.md)，以了解映像擷取程序的詳細資訊。
