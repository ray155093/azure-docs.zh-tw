...
* [準備用於 Azure 的 Oracle Linux 6.4+ 虛擬機器](virtual-machines-linux-oracle-create-upload-vhd.md)
* [準備用於 Azure 的 Oracle Linux 7.0+ 虛擬機器](virtual-machines-linux-oracle-create-upload-vhd.md)
