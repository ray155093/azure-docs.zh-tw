...
---
# <a name="create-a-linux-vm-using-an-azure-template"></a>使用 Azure 範本建立 Linux VM
...
您也可以使用 [Azure 入口網站](virtual-machines-linux-quick-create-portal.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)來快速部署 Linux VM 範本。
