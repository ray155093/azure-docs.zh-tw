...
> [!NOTE]
> [Excel 2010 和 2013 叢集連接器] 對話方塊中有 34 個字元的限制。您可以使用此對話方塊來指定執行 UDF 的叢集。如果完整的叢集名稱過長 (例如 hpcexcelhn01.southeastasia.cloudapp.azure.com)，該名稱就無法放入對話方塊中。解決方法是使用完整叢集名稱的值設定電腦全域變數，例如 *CCP\_IAASHN*。然後，在對話方塊中輸入 *%CCP\_IAASHN%* 做為叢集前端節點名稱。
> 
> 
