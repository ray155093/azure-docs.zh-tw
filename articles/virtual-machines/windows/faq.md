...
是。 如需指示，請參閱 [將 Windows VM 映像上傳至 Azure ](upload-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
...
是。 如需指示，請參閱[如何在 Resource Manager 部署模型中建立 Windows 虛擬機器的複本](vhd-copy.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。
...
是。 若要快速建立 Linux VM 以試用，請參閱 [使用入口網站在 Azure 上建立 Linux VM](../linux/quick-create-portal.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)。
