...
現在開始建置您的 VM 組態。 在每個 VM 大小中，您可以新增至 VM 的 NIC 總數是有限制的。 深入了解 [Windows VM 大小](sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。 
...
您可以在**與 VM 相同的 VNET** 中建立新的 NIC (如本文開頭所示)，或連接現有的 NIC。 我們假設您要在 VNET 中連結現有的 NIC `MyNic3`。 
...
嘗試建立具有多個 NIC 的 VM 時，請務必檢閱 [Windows VM 大小](sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) 。 注意每個 VM 大小所支援的 NIC 數目上限。 
