        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>利用 Azure 入口網站開始使用 Windows VM</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>利用 PowerShell 開始使用 Windows VM</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>利用 Resource Manager 範本開始使用 Windows VM</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize"><p />
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/compute">計算 REST API 參考</a></p>
                    </div>
                </div>
            </div>
        </div>
