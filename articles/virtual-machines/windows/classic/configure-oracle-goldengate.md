...
* 您已經檢閱過 [Oracle 虛擬機器映像 - 其他考量](oracle-considerations.md) 主題中的＜高可用性和災害復原考量＞一節。 請注意，Azure 支援獨立的 Oracle 資料庫執行個體，但目前不支援 Oracle Real Application Cluster (Oracle RAC)。
...
[適用於 Azure 的 Oracle 虛擬機器映像](../../linux/classic/oracle-images.md)
