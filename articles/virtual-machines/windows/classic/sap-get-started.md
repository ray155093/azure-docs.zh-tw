---
title: "在 Windows 虛擬機器上使用 SAP | Microsoft Docs"
...
Microsoft 透過 Microsoft Azure 虛擬機器，提供完整的基礎結構即服務 (IaaS) 平台。 Azure 虛擬機器 (IaaS) 支援以 SAP NetWeaver 為基礎的應用程式。 下列白皮書說明如何在 Azure 中的 Windows 虛擬機器上，規劃及實作 SAP NetWeaver 的應用程式。 您也可以在 [Linux 虛擬機器](../../linux/classic/sap-get-started.md)上，實作 SAP NetWeaver 應用程式。
