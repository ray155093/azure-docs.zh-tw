...
# <a name="configure-a-sql-server-always-on-availability-group-on-azure-virtual-machines-in-different-regions"></a>在不同區域中的 Azure 虛擬機器上設定 SQL Server Always On 可用性群組
...
* [Azure 可用性設定組](../../virtual-machines-windows-manage-availability.md)
