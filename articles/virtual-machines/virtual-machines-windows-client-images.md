<properties
   pageTitle="使用 Windows 用戶端映像進行開發/測試 | Microsoft Azure"
   description="如何使用 Visual Studio 訂用帳戶權益，在 Azure 中部署 Windows 7/8/10 以進行開發/測試案例"
...
# 在 Azure 中使用 Windows 用戶端進行開發/測試
