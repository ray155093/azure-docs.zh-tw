...
為了與 Azure Resource Manager 互動，請確定您可以存取 [Active Directory 服務主體](../azure-resource-manager/resource-group-authenticate-service-principal.md)。 從服務主體中，您會取得向 Azure Resource Manager 驗證要求的權杖。
...
- 如果部署有問題，您可以查看[使用 Azure Resource Manager 針對常見的 Azure 部署錯誤進行疑難排解](../azure-resource-manager/resource-manager-common-deployment-errors.md)。
- 檢閱[使用 C# 來部署 Azure 虛擬機器](virtual-machines-windows-csharp.md)，以了解如何部署虛擬機器及支援它的資源。
