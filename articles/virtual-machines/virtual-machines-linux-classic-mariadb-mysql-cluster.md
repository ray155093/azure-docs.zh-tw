...
> [!NOTE]
> 本主題使用 [Azure CLI](../xplat-cli-install.md) 工具，請務必下載這些工具，並且根據指示將它們連線至您的 Azure 訂用帳戶。 如果您需要 Azure CLI 中可用命令的參考，請參閱 [Azure CLI 命令參考](../virtual-machines-command-line-tools.md)。 您也必須[建立驗證的 SSH 金鑰]，並且記下 .pem 檔案位置。
>
>
