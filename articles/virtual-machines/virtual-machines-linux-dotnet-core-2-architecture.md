<properties
   pageTitle="使用 Azure Resource Manager 範本部署計算資源 | Microsoft Azure"
...
# 使用 Azure Resource Manager 範本的應用程式架構
...
![儲存體帳戶](./media/virtual-machines-linux-dotnet-core/storacct.png)
