...
>[AZURE.NOTE] 這是一種等冪作業。如果發生失敗，建議您重新嘗試執行該作業。如果持續發生失敗，請建立支援票證，或是在我們的 [VM 論壇](https://social.msdn.microsoft.com/Forums/azure/zh-TW/home?forum=WAVirtualMachinesforWindows)上建立一篇標籤為 ClassicIaaSMigration 的論壇文章。
