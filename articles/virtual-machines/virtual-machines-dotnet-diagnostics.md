---
title: "如何在虛擬機器中使用 Azure 診斷 | Microsoft Docs"
...
### <a name="step-4-create-your-diagnostics-configuration-and-install-the-extension"></a>步驟 4：建立您的診斷組態並安裝擴充功能
...
[請參閱虛擬機器相關的 Azure 診斷文章清單](../monitoring-and-diagnostics/azure-diagnostics.md#virtual-machines-using-azure-diagnostics) ，以變更您收集的資料、進行問題疑難排解，或深入了解一般的診斷。
