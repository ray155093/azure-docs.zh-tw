---
title: 在傳統入口網站中建立執行 Windows 的 VM | Microsoft Docs
...
了解如何 [使用 Resource Manager 部署模型執行這些步驟](virtual-machines-windows-hero-tutorial.md)。 如果您想要使用新的 Azure 入口網站，請參閱 [在 Azure 入口網站中建立第一個 Windows 虛擬機器](virtual-machines-windows-hero-tutorial.md)。
