...
本文涵蓋適用於 Azure 的期望的狀態組態延伸模組。 如需 DSC 延伸模組處理常式的概觀，請參閱 [Azure 期望的狀態組態延伸模組處理常式簡介](virtual-machines-windows-extensions-dsc-overview.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。 
