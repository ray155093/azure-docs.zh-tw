...
---
# <a name="what-to-do-in-the-event-that-an-azure-service-disruption-impacts-azure-virtual-machines"></a>發生影響 Azure 虛擬機器的 Azure 服務中斷事件時該怎麼辦
...
## <a name="option-2-restore-a-vm-from-a-backup"></a>選項 2︰從備份還原 VM
...
## <a name="option-3-initiate-a-failover-by-using-azure-site-recovery"></a>選項 3︰使用 Azure Site Recovery 起始容錯移轉
