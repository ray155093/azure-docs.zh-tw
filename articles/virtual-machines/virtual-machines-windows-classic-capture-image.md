...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)]如需 Resource Manager 模型資訊，請參閱[建立在 Azure 中執行的複本 Windows VM](virtual-machines-windows-vhd-copy.md)。
