...
|---|---|---|
|**SQL Server 2016 RC**|Windows Server 2012 R2|[評估](https://azure.microsoft.com/marketplace/partners/microsoft/sqlserver2016rc3evaluationwindowsserver2012r2/)|
...
如果您想要手動設定可用性群組和相關聯的接聽程式，請參閱[在 Azure VM 中設定 AlwaysOn 可用性群組](virtual-machines-windows-portal-sql-alwayson-availability-groups-manual.md)。
