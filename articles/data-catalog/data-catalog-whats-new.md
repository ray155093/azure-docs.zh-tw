...
- 允許目錄系統管理員定義商務詞彙與階層以建立常用商務詞彙的商務詞彙。使用者可以標記包含詞彙的已註冊資料資產，讓您更輕鬆地探索和了解目錄的內容。如需詳細資訊，請參閱[如何設定控管標記的商務詞彙](data-catalog-how-to-business-glossary.md)  
...
- 針對商務持續性及災害復原，支援 Azure 資料目錄資料的異地複寫功能。現在所有 Azure 資料目錄的內容 (包括資料來源元資料及群眾外包註解)，會在兩個 Azure 區域之間複寫，且客戶不需支付額外的成本。Azure 區域是預先配對的，兩個區域相隔至少 500 英哩，且遵循[業務持續性和災害復原 (BCDR)：Azure 配對的區域](../best-practices-availability-paired-regions.md)一文中所述的對應。
...
- Azure 資料目錄目前已在兩個新的 Azure 區域中提供。可讓客戶佈建 Azure 資料目錄的區域除了美國東部、美國西部、西歐及澳大利亞東部之外，還增加了北歐及東南亞區域。如需詳細資訊，請參閱 [Azure 區域](https://azure.microsoft.com/regions/)。
