...
> [!NOTE]
> 這項功能目前是預覽版，其會變成可用的條件是主要資料中心內的 Hyper-V 主機伺服器是在 VMM 雲端中管理時以及 VMware 設定是由[組態伺服器](site-recovery-vmware-to-azure.md#configuration-server-prerequisites)管理時。這項功能目前不適用於新的 Azure 入口網站。
> 
> 
