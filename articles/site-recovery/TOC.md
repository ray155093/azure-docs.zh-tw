...
### [VMware 至 Azure 架構](site-recovery-architecture-vmware-to-azure.md)
...
#### [步驟 2：確認必要條件和限制](vmware-walkthrough-prerequisites.md)
...
#### [步驟 9：設定複寫原則](vmware-walkthrough-replication.md)
