...
# 開始使用
## [複寫 Azure VM (預覽)](azure-to-azure-walkthrough-overview.md)
### [步驟 1：檢閱架構](azure-to-azure-walkthrough-architecture.md)
### [步驟 2：開始之前](azure-to-azure-walkthrough-prerequisites.md)
### [步驟 3：規劃網路服務](azure-to-azure-walkthrough-network.md)
### [步驟 4：建立保存庫](azure-to-azure-walkthrough-vault.md)
### [步驟 5：啟用複寫](azure-to-azure-walkthrough-enable-replication.md)
### [步驟 6：執行測試容錯移轉](azure-to-azure-walkthrough-test-failover.md)
...
## [將 Hyper-V VM 複寫至次要站台 (使用 VMM)](vmm-to-vmm-walkthrough-overview.md)
### [步驟 1：檢閱架構](vmm-to-vmm-walkthrough-architecture.md)
### [步驟 2：檢閱必要條件和限制](vmm-to-vmm-walkthrough-prerequisites.md)
### [步驟 3：規劃網路服務](vmm-to-vmm-walkthrough-network.md)
### [步驟 4：準備 VMM 和 Hyper-V](vmm-to-vmm-walkthrough-vmm-hyper-v.md)
### [步驟 5：建立保存庫](vmm-to-vmm-walkthrough-create-vault.md)
### [步驟 6：設定來源和目標](vmm-to-vmm-walkthrough-source-target.md)
### [步驟 7：設定網路對應](vmm-to-vmm-walkthrough-network-mapping.md)
### [步驟 8：建立複寫原則](vmm-to-vmm-walkthrough-replication.md)
### [步驟 9：啟用複寫](vmm-to-vmm-walkthrough-enable-replication.md)
### [步驟 10：執行測試容錯移轉](vmm-to-vmm-walkthrough-test-failover.md)
