...
## <a name="replicate-to-azure-hyperv-vms-not-managed-by-vmm"></a>複寫至 Azure︰未由 VMM 管理的 Hyper-V VM
...
* **Hyper-V 主機**︰您需要一或多個 Windows Server 2012 R2 Hyper-V 主機伺服器。 在 Site Recovery 部署期間，您會在主機上安裝 Azure Site Recovery Provider 和 Microsoft Azure 復原服務代理程式。
...
## <a name="replicate-to-azure-hyperv-vms-managed-by-vmm"></a>複寫至 Azure︰由 VMM 管理的 Hyper-V VM
...
## <a name="replicate-to-a-secondary-site-hyperv-vms-managed-by-vmm"></a>複寫至次要網站：由 VMM 管理的 Hyper-V VM
...
## <a name="replicate-to-a-secondary-site-with-san-replication-hyperv-vms-managed-by-vmm"></a>使用 SAN 複寫來複寫至次要網站：由 VMM 管理的 Hyper-V VM
...
### <a name="onpremises"></a>內部部署
## <a name="hyperv-protection-lifecycle"></a>Hyper-V 保護生命週期
