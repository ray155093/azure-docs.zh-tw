...
**計劃性容錯移轉** | 執行以符合法規需求<br/><br/>執行計劃性維護<br/><br/>執行以容錯移轉資料，使工作負載能夠在發生已知中斷時持續執行；例如，預期的電源中斷或嚴峻的氣象報告<br/><br/>在從主要位置移轉到次要位置後執行以進行容錯回復 | 沒有資料遺失<br/><br/>在關閉主要位置上的虛擬機器並使其在次要位置啟動期間，會產生停機時間。<br/>,br/>當目標電腦在容錯移轉之後成為來源電腦時，虛擬機器就會受到影響。 | 開始容錯移轉<br/><br/>在 [工作] 索引標籤上追蹤進度。來源電腦均已關閉<br/><br/>在次要位置啟動複本機器<br/><br/>Azure - 連接到 Azure 入口網站中的複本機器<br/><br/>次要站台 - 存取相同主機上和相同雲端中的電腦<br/><br/>認可容錯移轉
