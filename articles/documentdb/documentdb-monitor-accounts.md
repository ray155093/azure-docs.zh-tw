---
title: "監視 DocumentDB 要求、使用量及儲存體 | Microsoft Docs"
...
1. 在 [Azure 入口網站](https://portal.azure.com/)中，依序按一下 [更多服務] 和 [DocumentDB (NoSQL)]，然後按一下您想要為其設定效能度量警示的 DocumentDB 帳戶名稱。
...
## <a name="monitor-documentdb-programatically"></a>以程式設計方式監視 DocumentDB
...
若要深入了解 DocumentDB 容量規劃，請參閱 [DocumentDB 容量規劃工具計算機](https://www.documentdb.com/capacityplanner)。
