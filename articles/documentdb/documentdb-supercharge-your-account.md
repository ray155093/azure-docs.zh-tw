---
title: "增加 DocumentDB S1 帳戶的輸送量 | Microsoft Docs"
...
---
# <a name="supercharge-your-documentdb-account"></a>增加 DocumentDB 帳戶的輸送量
...
6. 回到 [設定] 刀鋒視窗中，[定價層] 已變更為 [標準]，並且 [輸送量 (RU/秒)] 方塊會顯示預設值 400。 按一下 [確定]  儲存變更。 
   ...
   > [!NOTE]
   > 您可以將輸送量設定為介於 400 到 10,000 個 [要求單位](documentdb-request-units.md)/秒 (RU/秒)。 頁面底部的 [定價摘要]  會自動更新以提供每月成本估計。
   > 
   > 
   
    ![[設定] 刀鋒視窗的螢幕擷取畫面，其中顯示可供變更輸送量值的位置](./media/documentdb-supercharge-your-account/documentdb-change-performance-set-thoughput.png)
7. 回到 [資料庫]  刀鋒視窗中，您可以確認已增加集合的輸送量。 
