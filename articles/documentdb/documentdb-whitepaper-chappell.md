...
> [AZURE.NOTE] 本白皮書上次於 2015 年更新，尚未更新以考量 DocumentDB 的更新，例如[資料全球發佈](documentdb-distribute-data-globally.md)和[分割的集合](documentdb-partition-data.md)。如需 DocumentDB 目前的簡介，請參閱 [DocumentDB 簡介：NoSQL JSON 資料庫](documentdb-introduction.md)。
