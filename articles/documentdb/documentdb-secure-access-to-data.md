...
## <a name="working-with-documentdb-master-and-read-only-keys"></a>使用 DocumentDB 主要和唯讀金鑰
...
## <a name="working-with-documentdb-users-and-permissions"></a>使用 DocumentDB 使用者和權限
