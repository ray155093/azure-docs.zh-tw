---
title: 連接至具有 MongoDB 的通訊協定支援的 DocumentDB 帳戶 | Microsoft Docs
...
---
# <a name="how-to-connect-to-a-documentdb-account-with-protocol-support-for-mongodb"></a>如何連接至具有 MongoDB 的通訊協定支援的 DocumentDB 帳戶
了解如何使用標準 MongoDB 連接字串 URI 格式，連接至具有 MongoDB 的通訊協定支援的 Azure DocumentDB 帳戶。  

## <a name="get-the-account's-connection-string-information"></a>取得帳戶的連接字串資訊
...
## <a name="connecting-with-the-c#-driver-for-mongodb"></a>連接 MongoDB 的 C# 驅動程式
