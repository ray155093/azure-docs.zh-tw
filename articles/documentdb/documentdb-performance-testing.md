...
> [AZURE.NOTE] 以高輸送量佈建集合之前，請參閱[價格頁面](https://azure.microsoft.com/pricing/details/documentdb/)以估算每個集合的成本。DocumentDB 對儲存體和輸送量是以小時為基礎獨立計費，因此您可以藉由在測試後刪除或降低 DocumentDB 集合的輸送量來節省成本。
