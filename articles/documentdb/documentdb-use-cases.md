---
title: "常見的 DocumentDB 使用案例 | Microsoft Docs"
...
現今，現代應用程式具備複雜的檢視和體驗。 這些是通常是動態的，根據使用者喜好設定或情緒和品牌需求量身訂做。 因此，應用程式必須要能夠有效地擷取個人化設定，以便快速呈現 UI 項目和體驗。 
...
## <a name="retail-applications"></a>零售應用程式
...
## <a name="logging-and-time-series-data"></a>記錄和時間序列資料
