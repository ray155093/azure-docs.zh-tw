...
---
# <a name="introduction-to-documentdb-a-nosql-json-database"></a>DocumentDB 簡介：其為一種 NoSQL JSON 資料庫
...
## <a name="a-namedatamanagementahow-does-documentdb-manage-data"></a><a name="data-management"></a>DocumentDB 如何管理資料？
