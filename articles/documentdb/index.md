        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>利用 ASP.NET MVC 開始使用 DocumentDB</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>利用 Node.js 開始使用 DocumentDB</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>利用 Node.js Express 開始使用 DocumentDB</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>利用 Java JSP 應用程式開始使用 DocumentDB</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>利用 Python Flask Web 應用程式開始使用 DocumentDB</h3>
                    </div>
                </div>
            </div>
        </div>
...
### <a name="java"></a>Java
[Java SDK 參考](http://azure.github.io/azure-documentdb-java)

### <a name="net"></a>.NET
[.NET 受管理的參考](https://msdn.microsoft.com/library/azure/dn948556)

### <a name="node"></a>節點
[Node SDK 參考](http://azure.github.io/azure-documentdb-node/DocumentClient)

### <a name="python"></a>Python
[Python 參考](http://azure.github.io/azure-documentdb-python/api/pydocumentdb)

### <a name="sql"></a>SQL
[SQL 參考](https://msdn.microsoft.com/library/azure/dn782250)

### <a name="rest"></a>REST
[REST API 參考資料](/rest/api/documentdb)

[資源提供者 API 參考](/rest/api/documentdbresourceprovider)
