<properties 
   pageTitle="Log Analytics 中的警示管理方案 | Microsoft Azure"
...
# Log Analytics 中的警示管理方案

警示管理方案可協助您分析環境中的所有警示。除了合併 OMS 內產生的警示，此方案還會將連接的 System Center Operations Manager (SCOM) 管理群組中的警示匯入到 Log Analytics。在具有多個管理群組的環境中，警示管理方案提供所有管理群組的警示合併檢視。
...
| [Linux 代理程式](log-analytics-limux-agents.md) | 否 | 直接 Linux 代理程式不會產生 SCOM 警示。 |
