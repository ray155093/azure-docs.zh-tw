...
# 在 Log Analytics 中設定 Proxy 和防火牆設定
...
### 驗證 Operations Manager 已將資料傳送至 OMS 服務
...
沒有輸入防火牆需求可支援混合式 Runbook 背景工作。

執行 Hybrid Runbook Worker 的內部部署電腦必須有連接埠 443、 9354 和 30000-30199 上之 *.cloudapp.net 的對外存取權。
