...
### <a name="to-enable-web-deploy-when-you-publish-your-application"></a>在發佈應用程式時啟用 Web Deploy
...
### <a name="to-update-your-web-role-by-using-web-deploy"></a>使用 Web Deploy 更新 Web 角色
...
### <a name="to-make-web-deploy-secure"></a>讓 Web Deploy 安全無虞
...
### <a name="to-include-files-in-the-service-package"></a>將檔案納入服務封裝
