...
[AZURE.INCLUDE [vpn-gateway-gwsku-include](../../includes/vpn-gateway-gwsku-include.md)] 只能使用基本 SKU 為閘道建立原則式 VPN。
...
![VNet 對 VNet 連線](./media/vpn-gateway-about-vpngateways/demov2v.png "vnet-to-vnet")
