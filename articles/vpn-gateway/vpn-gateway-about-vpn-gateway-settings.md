...
## <a name="<a-name="gwtype"></a>gateway-types"></a><a name="gwtype"></a>閘道類型
...
## <a name="<a-name="connectiontype"></a>connection-types"></a><a name="connectiontype"></a>連線類型
...
## <a name="<a-name="vpntype"></a>vpn-types"></a><a name="vpntype"></a>VPN 類型
...
## <a name="<a-name="requirements"></a>gateway-requirements"></a><a name="requirements"></a>閘道需求
[!INCLUDE [vpn-gateway-table-requirements](../../includes/vpn-gateway-table-requirements-include.md)]

## <a name="<a-name="gwsub"></a>gateway-subnet"></a><a name="gwsub"></a>閘道子網路
...
## <a name="<a-name="lng"></a>local-network-gateways"></a><a name="lng"></a>區域網路閘道
