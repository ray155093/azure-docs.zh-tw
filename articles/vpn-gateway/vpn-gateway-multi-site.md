...
匯出您的網路組態檔。 您匯出的檔案將會用來設定新的多網站設定。 如果您需要如何匯出檔案的指示，請參閱本文中的此節：[如何在 Azure 入口網站中建立傳統 VNet](../virtual-network/virtual-networks-create-vnet-classic-pportal.md#how-to-create-a-classic-vnet-in-the-azure-portal)。
...
匯入網路組態檔。 當您匯入含有變更的這個檔案時，就會加入新的通道。 這些通道會使用您稍早建立的動態閘道。 如果您需要如何匯入檔案的指示，請參閱本文中的此節：[如何在 Azure 入口網站中建立傳統 VNet](../virtual-network/virtual-networks-create-vnet-classic-pportal.md#how-to-create-a-classic-vnet-in-the-azure-portal)。  
