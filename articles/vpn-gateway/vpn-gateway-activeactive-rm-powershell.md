<properties
   pageTitle="如何使用 Azure Resource Manager 和 PowerShell 來設定與 Azure VPN 閘道的主動-主動 S2S VPN 連線 | Microsoft Azure"
...
# <a name="configure-active-active-s2s-vpn-connections-with-azure-vpn-gateways-using-azure-resource-manager-and-powershell"></a>使用 Azure Resource Manager 和 PowerShell 來設定與 Azure VPN 閘道的主動-主動 S2S VPN 連線
...
>[AZURE.IMPORTANT] 請注意，主動-主動模式只能在 HighPerformance SKU 中使用


## <a name="<a-name-="aagateway"></a>part-1---create-and-configure-active-active-vpn-gateways"></a><a name ="aagateway"></a>第 1 部分 - 建立並設定主動-主動 VPN 閘道
...
## <a name="<a-name-="aacrossprem"></a>part-2---establish-an-active-active-cross-premises-connection"></a><a name ="aacrossprem"></a>第 2 部分 - 建立主動-主動跨單位連線
...
## <a name="<a-name-="aav2v"></a>part-3---establish-an-active-active-vnet-to-vnet-connection"></a><a name ="aav2v"></a>第 3 部分 - 建立主動-主動 VNet 對 VNet 連線
...
## <a name="<a-name-="aaupdate"></a>part-4---update-existing-gateway-between-active-active-and-active-standby"></a><a name ="aaupdate"></a>第 4 部分 - 更新主動-主動和作用中-待命之間的現有閘道
...
您必須在 PowerShell 中設定閘道物件以觸發實際的更新。
