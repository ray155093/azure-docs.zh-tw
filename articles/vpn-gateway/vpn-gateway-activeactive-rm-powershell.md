...
## <a name="a-name-aagatewayapart-1---create-and-configure-active-active-vpn-gateways"></a><a name ="aagateway"></a>第 1 部分 - 建立並設定主動-主動 VPN 閘道
...
## <a name="a-name-aacrosspremapart-2---establish-an-active-active-cross-premises-connection"></a><a name ="aacrossprem"></a>第 2 部分 - 建立主動-主動跨單位連線
...
## <a name="a-name-aav2vapart-3---establish-an-active-active-vnet-to-vnet-connection"></a><a name ="aav2v"></a>第 3 部分 - 建立主動-主動 VNet 對 VNet 連線
...
## <a name="a-name-aaupdateapart-4---update-existing-gateway-between-active-active-and-active-standby"></a><a name ="aaupdate"></a>第 4 部分 - 更新主動-主動和作用中-待命之間的現有閘道
