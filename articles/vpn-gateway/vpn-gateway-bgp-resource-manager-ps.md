<properties
   pageTitle="如何使用 Azure Resource Manager 和 PowerShell 在 Azure VPN 閘道上設定 BGP | Microsoft Azure"
...
# 如何使用 Azure Resource Manager 和 PowerShell 在 Azure VPN 閘道上設定 BGP
...
### 步驟 2 - 使用 BGP 參數建立 TestVNet1 的 VPN 閘道
