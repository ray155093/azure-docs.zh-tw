...
## <a name="office-365-triggers"></a>Office 365 觸發程序
| 觸發程序 | 說明 |
| --- | --- |
...
## <a name="office-365-actions"></a>Office 365 動作
| 動作 | 說明 |
| --- | --- |
...
#### <a name="when-an-upcoming-event-is-starting-soon"></a>即將來臨的事件快要開始時
...
| 識別碼 |string |訊息識別碼 |
| IsRead |布林值 |已讀取 |
| DateTimeReceived |string |收到的日期與時間 |
| 附件 |array |附件 |
| 副本 |string |指定電子郵件地址，並以分號分隔，例如 someone@contoso.com |
...
#### <a name="send-email-with-options"></a>傳回具有選項的電子郵件
...
| 識別碼 |字串 |事件的唯一識別碼。 |
| 出席者 |array |事件的出席者清單。 |
| body |沒有定義 |與事件相關聯的訊息主體。 |
| BodyPreview |string |與事件相關聯的訊息預覽。 |
| 類別 |array |與事件相關聯的類別。 |
| ChangeKey |string |識別事件物件的版本。 每次變更事件時，ChangeKey 也會跟著變更。 |
| DateTimeCreated |字串 |建立事件的日期與時間。 |
| DateTimeLastModified |字串 |上次修改事件的日期與時間。 |
| End |字串 |事件的結束時間。 |
| EndTimeZone |string |指定會議結束時間的時區。 此值必須如 Windows 中的定義 (範例：太平洋標準時間)。 |
...
| ResponseStatus |沒有定義 |表示為了回應事件訊息所傳送的回應類型。 |
| SeriesMasterId |字串 |「主要系列」事件類型的唯一識別碼。 |
| ShowAs |字串 |顯示為可用或忙碌中。 |
| Start |string |事件的開始時間。 |
...
#### <a name="when-a-new-event-is-created"></a>建立新事件時
...
#### <a name="when-an-event-is-modified"></a>當事件遭到修改時
...
| 屬性名稱 | 資料類型 | 說明 |
| --- | --- | --- |
| 識別碼 |string |連絡人的唯一識別碼。 |
| ParentFolderId |string |連絡人的父資料夾識別碼 |
| Birthday |字串 |連絡人的生日。 |
| FileAs |字串 |將連絡人歸檔的名稱。 |
| displayName |string |連絡人的顯示名稱。 |
| GivenName |字串 |連絡人的名字。 |
| Initials |string |連絡人的縮寫。 |
| MiddleName |字串 |連絡人的中間名。 |
| NickName |string |連絡人的暱稱。 |
| Surname |string |連絡人的姓氏。 |
| 課程名稱 |string |連絡人職稱。 |
| 世代 |字串 |連絡人的世代。 |
| EmailAddresses |array |連絡人的電子郵件地址。 |
| ImAddresses |array |連絡人的立即訊息 (IM) 地址。 |
| JobTitle |string |連絡人職稱。 |
| CompanyName |字串 |連絡人的公司名稱。 |
| department |string |連絡人的部門。 |
| OfficeLocation |字串 |連絡人的辦公室位置。 |
| Profession |字串 |連絡人的職業。 |
| BusinessHomePage |字串 |連絡人的公司首頁。 |
| AssistantName |字串 |連絡人的助理名稱。 |
| Manager |string |連絡人的經理名稱。 |
| HomePhones |array |連絡人的住家電話號碼。 |
| BusinessPhones |array |連絡人的公司電話號碼。 |
| MobilePhone1 |string |連絡人的行動電話號碼。 |
| HomeAddress |沒有定義 |連絡人的住家地址。 |
| BusinessAddress |沒有定義 |連絡人的公司地址。 |
| OtherAddress |沒有定義 |連絡人的其他地址。 |
| YomiCompanyName |字串 |連絡人的公司名稱日文拼音。 |
| YomiGivenName |字串 |連絡人的名字日文拼音。 |
| YomiSurname |字串 |連絡人的姓氏日文拼音。 |
| 類別 |array |與連絡人相關聯的類別。 |
| ChangeKey |字串 |識別事件物件的版本。 |
| DateTimeCreated |string |建立連絡人的時間。 |
| DateTimeLastModified |string |修改連絡人的時間。 |
