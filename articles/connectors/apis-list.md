...
[Dynamics-365doc]: ./connectors-create-api-crmonline.md "連接到 Dynamics CRM Online，利用您的 CRM Online 資料執行更多動作。"
...
[office365-outlookdoc]: ./connectors-create-api-office365-outlook.md "Office 365 連接器可以使用 Office 365 帳戶來傳送和接收電子郵件、管理您的行事曆及管理您的連絡人。"
...
[sql-serverdoc]: ./connectors-create-api-sqlazure.md "連接到 SQL Azure 資料庫。您可以建立、更新、取得和刪除 SQL 資料庫資料表上的項目。"
