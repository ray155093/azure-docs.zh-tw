...
2. 已安裝 [Node.js](http://nodejs.org) (此範例假設您有 Node.js 4.2.2 版)
3. 已安裝 [Git](https://git-scm.com/)
...
4. 瀏覽至包含所建構程式碼的資料夾 (在此例中為「ContactList」子資料夾)。
5. 執行 `npm install`。
...
3. 在「azurewebsites.net」網域中輸入獨有的 [應用程式名稱]，例如 NodejsAPIApp 加上數字，使它成為獨有名稱。
