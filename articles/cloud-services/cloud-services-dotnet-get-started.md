...
[!INCLUDE [安裝 SDK](../../includes/install-sdk-2015-2013.md)]
...
8. 按一下 [儀表板] 索引標籤。
9. 按一下 [管理允許的 IP 位址]。
10. 在 [Allowed Services] 下，將 [Azure 服務] 變更為 [是]。
11. 按一下 [儲存]。
...
8. 在 [方案總管] 中，於方案 (不是其中一個專案) 上按一下滑鼠右鍵，並選擇 [加入 - 新專案]。
9. 在 [加入新的專案] 對話方塊中，於左窗格的 [Visual C#] 下選擇 [Windows]，然後按一下 [類別庫] 範本。
...
1. 在 ContosoAdsCommon 專案中，刪除 *Class1.cs* 檔案，並在其位置加入來自所下載專案的 *Ad.cs* 和 *ContosoAdscontext.cs* 檔案。
