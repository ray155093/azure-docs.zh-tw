...
1. 使用其中一種方法來尋找指派給雲端服務的 **.cloudapp.net** 網域名稱。
   ...
   * 登入 [Azure 傳統入口網站]，選取您的雲端服務，再選取 [儀表板]，然後在 [Quick Glance] 區段中找出 [網站 URL] 項目。
...
1. 使用下列其中一種方法取得雲端服務的 IP 位址。
   ...
   * 登入 [Azure 傳統入口網站]，選取您的雲端服務，再選取 [儀表板]，然後在 [Quick Glance] 區段中找出 [Public Virtual IP (VIP) address] 項目。
