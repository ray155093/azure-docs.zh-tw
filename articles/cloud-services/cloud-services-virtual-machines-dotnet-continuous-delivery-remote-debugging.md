---
title: 對連續傳遞啟用遠端偵錯 | Microsoft Docs
...
## 對虛擬機器啟用遠端偵錯
1. 建立 Azure 虛擬機器。請參閱[建立執行 Windows Server 的虛擬機器](../virtual-machines/virtual-machines-windows-hero-tutorial.md)或[在 Visual Studio 中建立及管理 Azure 虛擬機器](../virtual-machines/virtual-machines-windows-classic-manage-visual-studio.md)。
