<properties
 pageTitle="對雲端服務部署問題進行疑難排解 | Microsoft Azure"
...
* 在 Azure 傳統入口網站中，依序按一下雲端服務的部署、[儀表板]，位於頁面右下角 ([快速概覽] 下)。請注意，此窗格中並沒有「屬性」標籤。
...
在主機 OS 和客體 OS 升級期間，角色大約每個月會回收一次。如需詳細資訊，請參閱部落格文章[角色執行個體由於作業系統升級而重新啟動](http://blogs.msdn.com/b/kwill/archive/2012/09/19/role-instance-restarts-due-to-os-upgrades.aspx)。
...
>[AZURE.WARNING] 如果您回收雲端服務，您會重設部署的屬性，而有效清除原始問題的資訊。
