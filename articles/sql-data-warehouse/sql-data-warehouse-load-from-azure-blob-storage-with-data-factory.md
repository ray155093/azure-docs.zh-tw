...
* **Azure Data Factory**：Azure Data Factory 會完成實際載入，因此您需要有此資源來建置資料移動管線。如果您沒有此資源，請在[開始使用 Azure Data Factory (Data Factory 編輯器)][開始使用 Azure Data Factory (Data Factory 編輯器)] 的步驟 1 了解如何建立此資源。
