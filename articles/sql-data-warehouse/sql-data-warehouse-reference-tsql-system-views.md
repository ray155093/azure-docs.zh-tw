...
> [!NOTE]
> 若要使用這些檢視表，請將 'pdw\_nodes\_' 插入名稱中，如下表所示。
> 
> 
...
| sys.dm\_pdw\_nodes\_exec\_sessions |[sys.dm\_exec\_sessions](https://msdn.microsoft.com/zh-TW/library/ms176013.aspx) |
...
| sys.dm\_pdw\_nodes\_os\_spinlock\_stats |未提供 Transact-SQL 文件。 |
