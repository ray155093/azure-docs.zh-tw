---
title: "查詢 Azure SQL 資料倉儲 (sqlcmd) | Microsoft Docs"
...
---
# <a name="query-azure-sql-data-warehouse-sqlcmd"></a>查詢 Azure SQL 資料倉儲 (sqlcmd)
...
本逐步解說使用 [sqlcmd][sqlcmd] 命令列公用程式來查詢 Azure SQL 資料倉儲。  
