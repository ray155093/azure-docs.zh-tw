...
如果找不到更新，表示您應該已安裝最新版本。若要確認已安裝 SSDT，請按一下 [說明] / [關於 Microsoft Visual Studio] 並在清單中尋找 SQL Server Data Tools。SSDT 的最新版本是 14.0.60525.0。如果無法在 Visual Studio 中使用安裝選項，或者您也可以瀏覽 [SSDT 下載][SSDT 下載]頁面，手動下載和安裝 SSDT。
