...
## 移轉報告
在工具中選取 [檢查資料庫相容性] 會產生一份報告，針對您已要求移轉的資料庫，摘要說明所有的物件不相容問題。未列在 SQL 資料倉儲中的部分 SQL Server 功能清單，可以在我們的[移轉文件][]中找到。報告產生後，您可以在 Excel 中儲存並開啟該報告。
