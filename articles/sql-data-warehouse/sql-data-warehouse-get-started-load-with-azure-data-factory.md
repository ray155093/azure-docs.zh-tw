...
* [教學課程：將資料從 Azure 儲存體 Blob 複製到 Azure SQL Database][教學課程：將資料從 Azure 儲存體 Blob 複製到 Azure SQL Database]。 在本教學課程中，您會在 Azure Data Factory 中建立管線，將資料從 Azure 儲存體 Blob 複製到 Azure SQL Database。
