...
若要暫停資料庫，請使用[Pause Database (暫停資料庫) (暫停資料庫)][Pause Database (暫停資料庫) (暫停資料庫)] REST API。 下例會暫停裝載在 Server01 伺服器上的 Database02 資料庫。 此伺服器位於 ResourceGroup1 這個 Azure 資源群組。
...
若要啟動資料庫，請使用[繼續資料庫][繼續資料庫] REST API。 下例會啟動裝載在 Server01 伺服器上的 Database02 資料庫。 此伺服器位於 ResourceGroup1 這個 Azure 資源群組。 
...
<!--MSDN references-->
[Pause Database (暫停資料庫) (暫停資料庫)]: https://msdn.microsoft.com/library/azure/mt718817.aspx
