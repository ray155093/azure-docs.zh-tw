<properties
   pageTitle="還原 Azure SQL 資料倉儲中的資料庫 (入口網站) | Microsoft Azure"
   description="還原「Azure SQL 資料倉儲」中即時或已刪除之資料庫的 Azure 入口網站工作。"
...
還原「Azure SQL 資料倉儲」中即時或已刪除之資料庫的 PowerShell 工作。
