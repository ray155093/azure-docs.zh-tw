...
### <a name="memory-allocations-per-distribution-mb"></a>每個散發套件的記憶體配置 (MB)
...
## <a name="change-a-user-resource-class-example"></a>變更使用者資源類別的範例
...
<!--MSDN references-->
[管理 Azure SQL Database 的資料庫和登入]:https://msdn.microsoft.com/library/azure/ee336235.aspx
