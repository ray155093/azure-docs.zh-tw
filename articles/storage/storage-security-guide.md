...
-   待用加密
    ...
    我們將討論儲存體服務加密，以及如何為儲存體帳戶啟用此功能，讓您的區塊 Blob 和分頁 Blob 可以在寫入 Azure 儲存體時自動加密。同時也將探討如何使用 Azure 磁碟加密，並探索磁碟加密與儲存體服務加密 vegood lucrsus 用戶端加密之間的基本差異和案例。我們將簡短探討美國政府電腦適用的 FIPS 相符性。
