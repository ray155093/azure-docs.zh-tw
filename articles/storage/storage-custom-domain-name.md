...
使用 [Set-AzureRmStorageAccount](https://docs.microsoft.com/powershell/module/azurerm.storage/Set-AzureRmStorageAccount) PowerShell cmdlet，並指定 `-CustomDomainName`引數值的空字串 (`""`)，以移除自訂網域註冊。
