---
title: "開始使用資料表儲存體和 Visual Studio 已連接服務 (ASP.NET) | Microsoft Docs"
...
---
# <a name="get-started-with-table-storage-and-visual-studio-connected-services-aspnet"></a>開始使用資料表儲存體和 Visual Studio 已連接服務 (ASP.NET)
