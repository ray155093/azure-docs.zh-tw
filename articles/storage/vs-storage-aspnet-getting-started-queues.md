---
title: "開始使用佇列儲存體和 Visual Studio 已連接服務 (ASP.NET) | Microsoft Docs"
...
---
# <a name="get-started-with-azure-queue-storage-and-visual-studio-connected-services"></a>開始使用 Azure 佇列儲存體和 Visual Studio 連線的服務
...
## <a name="use-additional-options-for-de-queuing-messages"></a>使用其他將訊息移出佇列的選項
自訂從佇列中擷取訊息的方法有兩種。
...
## <a name="use-async-await-pattern-with-common-queueapis"></a>搭配使用 Async-Await 模式和通用佇列 API
