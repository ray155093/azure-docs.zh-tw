...
## <a name="a-namememoryresourcesawhen-apps-consume-more-memory-than-expected"></a><a name="memoryresources"></a>當應用程式耗用超出預期的記憶體時
...
## <a name="a-namecpuresourcesawhen-apps-consume-more-cpu-than-expected"></a><a name="CPUresources"></a>當應用程式耗用超出預期的 CPU 時
...
## <a name="a-namesocketresourcesawhen-socket-resources-are-exhausted"></a><a name="socketresources"></a>當通訊端資源耗盡時
...
## <a name="a-nameappbackupawhen-your-app-backup-starts-failing"></a><a name="appbackup"></a>當您的應用程式備份啟動失敗時
...
## <a name="a-namenodejsawhen-new-nodejs-apps-are-deployed-to-azure-app-service"></a><a name="nodejs"></a>當新的 Node.js 應用程式部署至 Azure App Service 時
