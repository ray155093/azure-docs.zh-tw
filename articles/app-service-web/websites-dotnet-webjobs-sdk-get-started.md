...
15. 在 [發行 Web] 精靈的 [連線] 步驟中，按 [下一步]。
    
    ![Connection step](./media/websites-dotnet-webjobs-sdk-get-started/connstep.png)
16. 在 [設定] 步驟中，清除 [Use this connection string at runtime] 核取方塊，然後按 [下一步]。
...
17. 在 [預覽] 步驟中，按一下 [開始預覽]。
    ...
    預覽視窗會顯示將複製 WebJob 專案的二進位和組態檔至 Web 應用程式的 *app\_data\\jobs\\continuous* 資料夾中。
