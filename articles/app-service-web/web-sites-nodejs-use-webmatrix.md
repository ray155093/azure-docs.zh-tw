---
title: "使用 WebMatrix 來建立 Node.js Web 應用程式並部署至 Azure。"
...
---
# <a name="build-and-deploy-a-nodejs-web-app-to-azure-using-webmatrix"></a>使用 WebMatrix 來建立 Node.js Web 應用程式並部署至 Azure。
...
## <a name="create-a-site-using-a-built-in-template-for-azure"></a>使用 Azure 內建的範本建立網站
...
## <a name="modify-and-republish-your-application"></a>修改和重新發行應用程式
...
3. 儲存您所做的變更，然後按一下發行圖示。 最後，按 [下一步]  in the  ，等待發行更新。
