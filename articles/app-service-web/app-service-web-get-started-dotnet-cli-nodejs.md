---
title: "在&5; 分鐘內將您的第一個 ASP.NET Web 應用程式部署到 Azure | Microsoft Docs"
description: "藉由部署範例 ASP.NET 應用程式，了解在 App Service 中執行 Web 應用程式有多麼簡單。 快速開始進行真正的開發，並立即查看結果。"
...
---
# <a name="deploy-your-first-aspnet-web-app-to-azure-in-five-minutes"></a>在&5; 分鐘內，將您的第一個 ASP.NET Web 應用程式部署到 Azure
...
本教學課程將協助您部署一個簡單的 ASP.NET Web 應用程式至 [Azure App Service](../app-service/app-service-value-prop-what-is.md)。
...
- [Azure CLI 1.0](app-service-web-get-started-dotnet-cli-nodejs.md) – 適用於傳統和資源管理部署模型的 CLI
- [Azure CLI 2.0 (預覽)](app-service-web-get-started-dotnet.md) - 適用於資源管理部署模型的新一代 CLI
...
## <a name="deploy-an-aspnet-web-app"></a>部署 ASP.NET Web 應用程式
...
4. 切換至工作目錄 (`CD`)，並複製範例 ASP.NET 應用程式。
...
6. 在 Azure 中，以唯一的應用程式名稱和您稍早設定的部署使用者，建立 App Service 應用程式資源。 出現提示時，指定所需的區域數目。
    ...
    ![在 Azure 中建立第一個 Web 應用程式的 Azure 資源](./media/app-service-web-get-started-languages/dotnet-site-create.png)
