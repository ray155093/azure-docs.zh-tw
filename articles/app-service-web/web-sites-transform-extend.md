---
title: "Azure App Service Web 應用程式進階設定和擴充功能"
...
## <a name="a-idtransformaadvanced-configuration-through-applicationhostconfig"></a><a id="transform"></a>透過 ApplicationHost.config 的進階設定
...
## <a name="a-idextenda-extend-your-web-app"></a><a id="extend"></a> 擴充 Web 應用程式
### <a name="a-idoverviewa-overview-of-private-web-app-extensions"></a><a id="overview"></a> 私人 Web 應用程式擴充功能的概觀
...
### <a name="a-idsitesamplea-web-app-extension-example-php-manager"></a><a id="SiteSample"></a> Web 應用程式擴充功能範例：PHP Manager
...
#### <a name="a-idphpwebappa-the-php-manager-web-application"></a><a id="PHPwebapp"></a> PHP Manager Web 應用程式
...
#### <a name="a-idxdta-the-applicationhostxdt-file"></a><a id="XDT"></a> applicationHost.xdt 檔案
...
### <a name="a-iddeploya-web-app-extension-deployment"></a><a id="deploy"></a> Web 應用程式擴充功能部署
