---
title: "透過 Memcache 通訊協定，將 Azure App Service 中的 Web 應用程式連線到 Redis Cache | Microsoft Docs"
...
## <a name="enable-memcache-extension-for-php"></a>啟用適用於 PHP 的 Memcache 延伸模組
為了讓應用程式得以使用 Memcache 通訊協定，必須安裝適用於 PHP (WordPress 網站語言架構) 的 Memcache 延伸模組。

### <a name="download-the-phpmemcache-extension"></a>下載 php_memcache 延伸模組
...
### <a name="enable-the-phpmemcache-extension"></a>啟用 php_memcache 延伸模組
