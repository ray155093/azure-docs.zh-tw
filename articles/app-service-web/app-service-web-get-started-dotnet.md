---
title: "在 5 分鐘內將您的第一個 .NET Web 應用程式部署到 Azure | Microsoft Docs"
...
---
# <a name="deploy-your-first-net-web-app-to-azure-in-five-minutes"></a>在 5 分鐘內，將您的第一個 .NET Web 應用程式部署到 Azure
本教學課程將協助您部署一個簡單的 .NET Web 應用程式至 [Azure App Service](../app-service/app-service-value-prop-what-is.md)。
