---
title: "在 Azure App Service 中建立 Java Web 應用程式 | Microsoft Docs"
...
---
# <a name="create-a-java-web-app-in-azure-app-service"></a>在 Azure App Service 中建立 Java Web 應用程式
[!INCLUDE [tabs](../../includes/app-service-web-get-started-nav-tabs.md)]

本教學課程說明如何利用 [Azure 入口網站][在 Azure App Service 中建立 Web 應用程式]。 Azure 入口網站是可用來管理 Azure 資源的 Web 介面。

> [!NOTE]
> 若要完成此教學課程，您需要 Microsoft Azure 帳戶。 如果您沒有這類帳戶，可以[啟用自己的 Visual Studio 訂閱者權益]，或是[申請免費試用]。
> 
...
## <a name="a-nameportala-create-and-configure-a-java-web-app"></a><a name="portal"></a> 建立及設定 Java Web 應用程式
...
7. 建立 Web 應用程式後，依序按一下 [Web Apps] > [{您的 Web 應用程式}]。
   
    ![選取 Web 應用程式][selectwebapp]
8. 在 [Web 應用程式] 刀鋒視窗中，按一下 [設定]。
9. 按一下 [應用程式設定] 。
10. 選擇所需的 [Java 版本] 。 
11. 選擇所需的 [Java 次要版本] 。 如果您選取 [最新] ，您的應用程式會使用 App Service 可用的最新次要版本作為該 Java 主要版本。 [最新] 項目是從 [應用程式設定] 建立之 Java 應用程式所獨有。 如果您是從資源庫建立 Java 應用程式，則必須管理您自己的容器和 JVM 變更。 
...
## <a name="a-namemarketplacea-use-a-java-template-from-the-azure-marketplace"></a><a name="marketplace"></a> 使用來自 Azure Marketplace 的 Java 範本
