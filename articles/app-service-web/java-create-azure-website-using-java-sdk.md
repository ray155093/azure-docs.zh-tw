...
2. [**Java 版本**] 的預設值為 [**關閉**]；選取應用程式鎖定的 Java 版本；例如 1.7.0\_51。這麼做之後，還要確定 [**Web 容器**] 設定已設定為 Tomcat Server 的版本。
