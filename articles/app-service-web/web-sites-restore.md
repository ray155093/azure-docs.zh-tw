...
3. 在 [還原] 刀鋒視窗中，先選取備份來源。
	...
	[應用程式備份] 選項會顯示目前應用程式的所有現有備份，您可以輕鬆地選取其中一個。[儲存體] 選項可讓您從您訂用帳戶中任何現有 Azure 儲存體帳戶和容器中，選取任何備份 ZIP 檔案。如果您想要還原另一個應用程式的備份，請使用 [儲存體] 選項。

4. 接著，在 [還原目的地] 中指定應用程式還原目的地。

	![](./media/web-sites-restore/022ChooseDestination.png)
	
	>[AZURE.WARNING] 如果您選擇 [覆寫]，則目前應用程式中的所有現有資料都會被清除。按一下 [確定] 之前，請確定這確實是您想要執行的動作。
...
1. 若要查看有關應用程式還原作業成功或失敗的詳細資訊，請瀏覽至 Azure 入口網站中的 [稽核記錄] 刀鋒視窗。
