...
---
# <a name="deploy-a-sails.js-web-app-to-azure-app-service"></a>將 Sails.js Web 應用程式部署至 Azure App Service
...
## <a name="step-1:-create-a-sails.js-app-locally"></a>步驟 1︰在本機建立 Sails.js 應用程式
...
## <a name="step-3:-configure-and-deploy-your-sails.js-app"></a>步驟 3︰設定和部署 Sails.js 應用程式
...
如需詳細資訊，請參閱 [從 iisnode 取得 stdout 和 stderr 記錄](app-service-web-nodejs-sails.md#iisnodelog)。
