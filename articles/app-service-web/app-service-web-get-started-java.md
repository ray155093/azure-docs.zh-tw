...
本快速入門可幫助您在短短幾分鐘內將第一個 Java web 應用程式部署至 [Azure App Service](../app-service/app-service-value-prop-what-is.md)。

開始本快速入門之前，請確認[安裝 Azure CLI 在](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli)您的電腦上。

## <a name="create-a-java-web-app-in-azure"></a>在 Azure 中建立 Java Web 應用程式
...
恭喜您，第一個 Java web 應用程式在 Azure App Service 中即時執行。
