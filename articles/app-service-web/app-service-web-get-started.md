...
3. 按一下底部的 [建立]  。 您可以按一下頂端的通知  圖示來查看進度。
...
## <a name="deploy-code-to-your-web-app"></a>將程式碼部署至 Web 應用程式
...
就這麼簡單！ 您的程式碼現在正在 Azure 中即時執行。 在瀏覽器中，瀏覽至 http://&lt;>.azurewebsites.net 來查看其實際運作。 

## <a name="make-updates-to-your-app"></a>更新您的 App
