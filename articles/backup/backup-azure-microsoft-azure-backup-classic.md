---
title: "使用 Azure 備份伺服器將工作負載備份至 Azure 傳統入口網站 | Microsoft Docs"
...
> [!WARNING]
> Azure 備份伺服器承襲了 Data Protection Manager (DPM) 的工作負載備份功能。 您將發現其中某些功能指向 DPM 文件的指標。 不過，Azure 備份伺服器不會保護磁帶，也不會與 System Center 整合。
>
>
...
> [!NOTE]
> 建議您在具有 Windows Server 2012 R2 Datacenter 的機器上安裝 Azure 備份伺服器。 最新版的 Windows 作業系統會自動涵蓋許多必要條件。
>
>
...
3. 選取所有檔案，然後按 [下一步] 。 下載「Microsoft Azure 備份」下載頁面中的所有檔案，並將所有檔案放在相同的資料夾中。
