---
title: 使用 Resource Manager 部署模型將 Windows Server 或用戶端備份到 Azure | Microsoft Docs
...
> [!NOTE]
> 網路節流不適用於 Windows Server 2008 R2 SP1、Windows Server 2008 SP2 或 Windows 7 (含 service pack)。Azure 備份網路節流功能可保證本機作業系統上的服務品質 (QoS)。雖然 Azure 備份可保護這些作業系統，但這些平台上可用的 QoS 版本無法與 Azure 備份網路節流搭配使用。網路節流可使用於所有其他[支援的作業系統](backup-azure-backup-faq.md#installation-amp-configuration)。
> 
> 
