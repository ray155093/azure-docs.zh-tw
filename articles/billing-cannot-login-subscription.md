---
title: 我無法登入來管理我的 Azure 訂用帳戶 | Microsoft Docs
...
## 錯誤訊息「找不到任何訂用帳戶」
如果帳戶沒有足夠的使用者權限，就可能發生此問題。帳戶管理員只能存取[帳戶中心](https://account.windowsazure.com/)，而服務管理員 (SA) 和共同管理員 (CA) 則只能存取 [Azure 入口網站](https://portal.azure.com)。
...
Azure 入口網站的預設登入頁面乃供 Microsoft 帳戶使用。如果您的帳戶與組織帳戶相關聯，請選取正確的登入選項，如下所示。如需有關使用組織帳戶的詳細資訊，請參閱[以組織身分註冊 Azure](active-directory/sign-up-organization.md)。
