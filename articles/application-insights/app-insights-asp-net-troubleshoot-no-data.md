...
## <a name="a-nameq01ano-add-application-insights-option-in-visual-studio"></a><a name="q01"></a>在 Visual Studio 中沒有「新增 Application Insights」選項
...
## <a name="a-nameq02aadding-application-insights-failed"></a><a name="q02"></a>新增 Application Insights 失敗
...
## <a name="a-namenugetbuilda-nuget-packages-are-missing-on-my-build-server"></a><a name="NuGetBuild"></a> 我的組建伺服器上「NuGet 封裝遺失」
...
## <a name="a-nameq03a-no-server-data-or-no-data-at-all"></a><a name="q03"></a> 沒有任何伺服器資料 (或根本沒有資料)
...
## <a name="a-nameq04ano-data-on-page-views-browsers-usage"></a><a name="q04"></a>頁面檢視、瀏覽器、使用量上沒有任何資料
