...
---
# <a name="release-notes-for-application-insights-sdk-for-windows-phone-and-store"></a>適用於 Windows Phone 和市集的 Application Insights 版本資訊

> [!WARNING]
> 不再支援 Windows Phone 和市集 SDK。 我們建議將 [HockeyApp](https://www.hockeyapp.net/) 用於管理行動和桌面應用程式的散發和監視。
>  
...
* 核心管理於 github 中。 您可於 [github](http://github.com/Microsoft/ApplicationInsights-dotnet/releases)
