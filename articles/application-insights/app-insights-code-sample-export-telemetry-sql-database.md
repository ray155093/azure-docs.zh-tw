---
title: 程式碼範例：剖析從 Application Insights 匯出的資料
...
1. 開啟 [快速入門] 來了解如何針對應用程式的類型設定 SDK。
...
2. 在此範例中，我們正在監視 Web 應用程式，因此可以使用 Visual Studio 中的 Azure Tools 安裝 SDK。告訴 SDK 我們的 Application Insights 資源名稱：
