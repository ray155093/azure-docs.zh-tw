...
## <a name="a-namee-aa-unexpected-error"></a><a name="e-a"></a> 「未預期的錯誤」
...
## <a name="a-namecookiesaenable-third-party-cookies"></a><a name="cookies"></a>啟用協力廠商 cookie
  請參閱 [如何停用協力廠商 Cookie](http://www.digitalcitizen.life/how-disable-third-party-cookies-all-major-browsers)，但請注意，我們需要 **啟用** 它們。

## <a name="a-namee-xaif-all-else-fails"></a><a name="e-x"></a>如果這一切都失敗
