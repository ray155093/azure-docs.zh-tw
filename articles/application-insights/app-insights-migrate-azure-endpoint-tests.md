...
可用性測試是 [Azure Application Insights](app-insights-overview.md) 的一部分，是一項適用於任何 Web 應用程式的可延伸分析服務。

## <a name="so-whats-happening-to-my-endpoint-tests"></a>我的端點測試該如何處置？
...
### <a name="option-b-you-manage-andor-enable-the-new-tests"></a>選項 B︰您自行管理和/或啟用新測試。
...
新的可用性測試是 [Azure Application Insights](app-insights-overview.md) 的一部分。 以下是 [2 分鐘影片](http://go.microsoft.com/fwlink/?LinkID=733921)。
...
## <a name="what-is-and-isnt-migrated"></a>哪些項目會移轉，哪些不會？
舊端點測試的保留項目︰
