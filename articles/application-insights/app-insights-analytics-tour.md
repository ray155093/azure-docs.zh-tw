---
title: Application Insights 中分析的完整教學課程 | Microsoft Docs
...
> [!NOTE]
> 按一下資料行的標頭，以重新排列網頁瀏覽器中可用的結果。 但請注意，對大型結果集而言，下載至瀏覽器的資料列數目有限。 請注意，以這種方式排序並不一定會顯示實際的最高或最低項目。 為此，您應該使用 `top` 或 `sort` 運算子。 
> 
> 
...
> [!NOTE]
> 請注意，我們目前必須將持續時間轉換成日期時間，才能顯示於圖表上。
> 
> 
