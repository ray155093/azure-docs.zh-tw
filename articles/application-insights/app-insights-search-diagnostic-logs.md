...
### <a name="run-your-app-and-view-the-results"></a>執行應用程式並檢視結果。
開啟 [診斷搜尋]。
...
#### <a name="install-an-adapter-for-your-logging-framework"></a>為記錄架構安裝配接器
...
3. 選取 [線上] > [全部]，選取 [包含發行前版本]，然後搜尋 "Microsoft.ApplicationInsights"
