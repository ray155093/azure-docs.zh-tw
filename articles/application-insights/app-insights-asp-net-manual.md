...
1. 在 Visual Studio 中，編輯 Web 應用程式專案的 NuGet 封裝。
    ...
    ![以滑鼠右鍵按一下專案，然後選取 [管理 NuGet 封裝]](./media/app-insights-asp-net-manual/03-nuget.png)

2. 安裝 Web Apps 適用的 Application Insights SDK。

    ![搜尋「Application Insights」](./media/app-insights-asp-net-manual/04-ai-nuget.png)
...
![使用 Visual Studio 來發佈您的應用程式](./media/app-insights-asp-net-manual/15-publish.png)
...
![在您的 Web 應用程式中，依序按一下 [設定]、[延伸模組]、[加入]、[Application Insights]](./media/app-insights-asp-net-manual/05-extend.png)
...
![在您的 Web 應用程式中，開啟 [快速啟動]，然後按一下 [取得程式碼來監視我的網頁]](./media/app-insights-asp-net-manual/02-monitor-web-page.png)
