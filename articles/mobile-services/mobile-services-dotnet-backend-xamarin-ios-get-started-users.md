---
title: 開始在 Xamarin.iOS 應用程式的行動服務中使用驗證 | Microsoft Docs
...
2. 使用下列定義，將新方法 **Authenticate** 新增至 **QSTodoService**：
   ...
   > [!NOTE]
   > 當您使用 Facebook 以外的身分識別提供者時，請將上述傳遞給 **LoginAsync** 的值變更為下列其中一項值：*MicrosoftAccount*、*Twitter*、*Google* 或 *WindowsAzureActiveDirectory*。
   > 
   > 
