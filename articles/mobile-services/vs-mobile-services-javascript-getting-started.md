---
title: 在使用 Visual Studio 連接服務加入 Azure 行動服務之後，開始使用 Javascript Mobile App | Microsoft Docs
...
## 更新實體
更新資料表中的資料列。在此範例中，*todoItem* 是更新的項目，而 *item* 就是從行動服務傳回的相同項目。當行動服務回應時，就使用 [splice](http://msdn.microsoft.com/library/windows/apps/Hh700810.aspx) 方法在本機 todoItems 清單中更新此項目。在傳回的 **Promise** 物件上呼叫 [done](https://msdn.microsoft.com/library/dn802826.aspx) 方法，以取得所插入物件的複本，並處理任何錯誤。
