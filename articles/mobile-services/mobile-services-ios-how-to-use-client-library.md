---
title: 如何使用適用於 Azure 行動服務的 iOS 用戶端程式庫
...
> [!NOTE]
> 本指南使用最新的 [iOS 行動服務 SDK](https://go.microsoft.com/fwLink/?LinkID=266533&clcid=0x409)。如果您的專案使用舊版的 SDK，請先升級 Xcode 中的架構。
> 
> 
...
我們來看看如何在[行動服務快速入門]專案中快取權杖；您可以對任何專案套用類似步驟。[!INCLUDE [mobile-services-ios-authenticate-app-with-token](../../includes/mobile-services-ios-authenticate-app-with-token.md)]
