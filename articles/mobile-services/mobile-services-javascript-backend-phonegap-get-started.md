---
title: 開始使用 PhoneGap/cordova App 的 Azure 行動服務 | Microsoft Docs
...
2. 根據以下各個平台的指示，開啟並執行對應的專案。
   ...
   * **Android**
     ...
     > [!NOTE]
     > 若要能夠在 Android 模擬器中執行此專案，您必須至少定義一個 Android 虛擬裝置 (AVD)。請使用 AVD 管理員來建立和管理這些裝置。
     > 
     > 
...
> [!NOTE]
> 您可以檢閱存取行動服務來查詢和插入資料的程式碼，這可以在 js/index.js 檔案中找到。
> 
> 
