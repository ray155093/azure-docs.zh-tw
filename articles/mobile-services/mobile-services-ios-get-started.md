---
title: 開始使用適用於 iOS App 的 Azure 行動服務 | Microsoft Docs
...
4. 在 [Download and run your app] 下，按 [下載]。如此會下載與您行動服務連線之範例應用程式 *To do list* 的專案，以及行動服務 iOS SDK。請將壓縮的專案檔案儲存至本機電腦，並記下儲存位置。
