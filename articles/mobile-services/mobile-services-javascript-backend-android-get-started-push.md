...
---
title: 開始使用推播通知 (Android JavaScript) | Microsoft Docs
...
[!INCLUDE [新增 Play 服務](../../includes/mobile-services-add-google-play-services.md)]
...
## 疑難排解
### 驗證 Android SDK 版本
[!INCLUDE [確認 SDK](../../includes/mobile-services-verify-android-sdk-version.md)]
