...
- 頁面使用者介面 (UI) 自訂功能。
- 將協助您使用我們的範例內容來測試頁面 UI 自訂功能的協助程式工具。
- 每種頁面中的核心 UI 元素。
- 執行這項功能時的最佳作法。
...
如果您想要嘗試使用我們裝載於 Azure Blob 儲存體上的範例 HTML 和 CSS 內容來自訂 UI，我們提供了[簡單的協助程式工具](active-directory-b2c-reference-ui-customization-helper-tool.md)，來上傳與設定您的靜態內容。
