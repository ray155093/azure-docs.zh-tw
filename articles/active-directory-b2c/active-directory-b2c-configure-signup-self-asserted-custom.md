...
---
# <a name="azure-active-directory-b2c-modify-signup-to-add-new-claims-and-configure-user-input"></a>Azure Active Directory B2C︰修改註冊以新增宣告並設定使用者輸入。
...
## <a name="add-the-claim-to-the-singupsign-user-journey"></a>在註冊/登入使用者旅程中新增宣告
...
測試模式中的註冊畫面看起來應該像這樣︰![修改過的註冊選項螢幕擷取畫面](./media/active-directory-b2c-configure-signup-self-asserted-custom/signup-with-city-claim-dropdown-example.png)
...
## <a name="optional-remove-email-verification-from-signup-journey"></a>選擇性移除註冊旅程中的電子郵件驗證
