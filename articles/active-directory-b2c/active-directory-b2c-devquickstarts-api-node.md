<properties
	pageTitle="Azure AD B2C：使用 Node.js 保護 Web API 安全 | Microsoft Azure"
...
# Azure AD B2C：使用 Node.js 保護 Web API 安全
...
> [AZURE.NOTE]	此範例設計為使用我們的 [iOS B2C 範例應用程式](active-directory-b2c-devquickstarts-ios.md)來連接。請先執行目前的逐步解說，然後遵循該範例操作。
