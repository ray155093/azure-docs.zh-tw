...
語言自訂可讓您將使用者旅程變更為不同語言，以符合您客戶的需求。  我們提供 37 種語言的翻譯 (請參閱[其他資訊](#additional-information))。  即使您的體驗僅提供單一語言，您也可以自訂頁面上的任何文字以符合您的需求。  
...
3. **原則的預設語言** - 如果該語言未指定語言，或指定了不支援的語言，語言就會轉譯為原則的預設語言
...
3. 系統會將您帶往 [支援的語言] 刀鋒視窗。  您可以從這裡選取 [新增資源]。
4. 選取您想要支援的所有語言。  
