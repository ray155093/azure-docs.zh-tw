...
## <a name="download-the-third-party-library-nxoauth2-and-launch-a-workspace"></a>下載協力廠商程式庫 nxoauth2 並啟動工作區
...
### <a name="adding-the-library-to-your-project-using-cocoapods"></a>使用 CocoaPods 將程式庫加入至您的專案
...
## <a name="the-structure-of-the-project"></a>專案結構
我們在基本架構中為專案設定下列結構︰
...
## <a name="create-the-settingsplist-file-for-your-application"></a>建立您的應用程式的 `settings.plist` 檔案
...
## <a name="set-up-a-appdata-class-to-read-our-settings"></a>設定 AppData 類別以讀取我們的設定
...
## <a name="set-up-the-nxoauth2client-library-in-your-appdelegate"></a>在 AppDelegate 中設定 NXOAuth2Client 程式庫
...
## <a name="create-a-loginviewcontroller-class-that-we-will-use-to-handle-authentication-requests"></a>建立 `LoginViewController` 我們將用來處理驗證要求的類別
