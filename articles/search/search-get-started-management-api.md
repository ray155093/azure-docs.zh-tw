...
您可以在 GitHub 上的 [Azure 搜尋服務 .NET 管理 API 示範 (英文)](https://github.com/Azure-Samples/search-dotnet-management-api/) 找到此用戶端應用程式。
...
如果您尚未[從 GitHub 下載範例應用程式 (英文)](https://github.com/Azure-Samples/search-dotnet-management-api/)，您在此步驟中會需要它。
