---
title: 評分設定檔 (Azure 搜尋服務 REST API 版本 2015-02-28-Preview) | Microsoft Docs
...
> [!NOTE]
> 本文說明 [2015-02-28-Preview](search-api-2015-02-28-preview.md) 的評分設定檔。記載於 [MSDN](http://msdn.microsoft.com/library/azure/mt183328.aspx) 的 `2015-02-28` 版本和此處描述的 `2015-02-28-Preview` 版本，目前並無差別，不過為使文件內容完整涵蓋 API，我們仍提供此文件。
> 
> 
...
* 函數只能套用至可篩選的欄位。請參閱[建立索引 (Azure 搜尋服務 API)](search-api-2015-02-28.md#createindex) 以了解更多有關可篩選欄位的相關資訊。
