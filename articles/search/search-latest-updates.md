...
功能|已發行|狀態|詳細資料
-------|--------|------|-------
[.NET SDK 1.1](https://msdn.microsoft.com/library/azure/dn951165.aspx)|2016 年 2 月|GA|這是 .NET 用戶端程式庫 `Microsoft.Azure.Search.dll` 第一個正式推出的版本。這個版本有重大變更。如需移轉的指南，請參閱[升級至 Azure 搜尋服務 .NET SDK 版本 1.1](search-dotnet-sdk-migration.md)。
