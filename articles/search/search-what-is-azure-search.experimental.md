...
Azure 搜尋服務提供完整的功能，讓您同時符合搜尋和操作需求。
...
相較於其他搜尋解決方案，針對 Azure 上的內容存放區和資料庫處理全文檢索搜尋工作負載時，Azure 搜尋服務的功能最強大，另外還提供一層必要的功能，以支援主要依賴搜尋資訊擷取和內容導覽的應用程式。 主要優點包括︰
...
可利用 Azure 搜尋服務中最廣泛功能的使用案例，包括線上型錄、商務營運程式和文件探索應用程式。

### <a name="feature-drilldown"></a>深入探討功能
