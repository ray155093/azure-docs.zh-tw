...
> [AZURE.IMPORTANT] 當您使用 `json` 或 `jsonArray` 剖析模式時，Azure 搜尋服務會假設您資料來源中的所有 Blob 都是 JSON。如果您需要支援在相同的資料來源中混用 JSON 和非 JSON Blob，請在 [UserVoice 網站](https://feedback.azure.com/forums/263029-azure-search)上讓我們知道。
