...
您可以在下列連結中找到有關我們可支援的更多「函式」相關資訊：<http://www.blitline.com/docs/functions>
...
這代表 Blitline 已收到您的要求，它已將您的要求置入處理佇列，且當它完成影像時的影像位置： **https://s3.amazonaws.com/dev.blitline/2011110722/YOUR\_APP\_ID/CK3f0xBF_2bV6wf7gEZE8w.jpg**

## <a name="how-to-save-an-image-to-your-azure-storage-account"></a>如何將影像儲存至您的 Azure 儲存體帳戶
