...
* [Node.js 用戶端](https://github.com/shwetams/azure-batchclient-sample-nodejs/blob/master/storehbaseclient.js)
* [準備工作 Shell 指令碼](https://github.com/shwetams/azure-batchclient-sample-nodejs/blob/master/startup_prereq.sh)
* [Python csv 至 JSON 處理器](https://github.com/shwetams/azure-batchclient-sample-nodejs/blob/master/processcsv.py)
