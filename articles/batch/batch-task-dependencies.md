...
本文將討論使用 [Batch .NET][net_msdn] 程式庫設定工作相依性。我們會先告訴您如何對作業[啟用工作相依性](#enable-task-dependencies)，然後簡單地示範如何[設定工作的相依性](#create-dependent-tasks)。最後，我們將討論 Batch 支援的[相依性案例](#dependency-scenarios)。
