...
> [!NOTE]
> 在批次和 HPC 解決方案中，應用程式正在執行的執行個體通常稱為「作業」，而每項作業可能會分成「工作」。且應用程式的叢集計算資源通常稱為「運算節點」。
> 
> 
...
> [!NOTE]
> Azure 定期導入了對於您的案例可能有用的新服務。如果您有疑問，請連絡 [Azure 合作夥伴](https://pinpoint.microsoft.com/zh-TW/search?keyword=azure)或寄電子郵件到 bigcompute@microsoft.com。
> 
> 
