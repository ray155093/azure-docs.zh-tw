---
title: "將 Intel Edison (C) 連接到 Azure IoT - 開始使用 | Microsoft Docs"
...
---
# <a name="connect-your-intel-edison-device-to-your-iot-hub-using-c"></a>使用 C 將 Intel Edison 裝置連接到 IoT 中樞
...
前往[建立 IoT 中樞並登錄 Intel Edison](iot-hub-intel-edison-kit-c-lesson2-prepare-azure-iot-hub.md)。
