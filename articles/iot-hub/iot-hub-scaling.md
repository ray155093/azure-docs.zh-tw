...
---
# <a name="scaling-iot-hub"></a>調整 IoT 中樞
Azure IoT 中樞最多可支援百萬個同時連線的裝置。 如需詳細資訊，請參閱 [IoT 中樞定價][lnk-pricing]。 每個 IoT 中樞單位允許一定數量的每日訊息。
...
除了此輸送量資訊之外，請參考 [IoT 中樞配額和節流][IoT 中樞配額和節流]並據以設計您的解決方案。
...
如需特定高載效能數據，請參閱 [IoT 中樞配額和節流][IoT 中樞配額和節流]。
...
[IoT 中樞配額和節流]: iot-hub-devguide-quotas-throttling.md
