...
清單中找不到您正在尋找的裝置嗎？ 沒問題，Azure IoT SDK 是開放原始碼，並且設計為可攜式。請造訪我們的用戶端程式庫 GitHub [儲存機制](https://github.com/Azure/azure-iot-sdks)以開始使用，若您在連線裝置時發生任何問題，請在 [[問題](https://github.com/Azure/azure-iot-sdks/issues)] 區段通知我們。
...
|[Adafruit Feather M0 Wifi](https://www.adafruit.com/product/3010) |Arduino IDE(RTOS) | Arduino, C|[開始使用](https://azure.microsoft.com/zh-TW/documentation/samples/iot-hub-c-m0wifi-getstartedkit/)|
|[Adafruit Feather Huzzah](https://learn.adafruit.com/adafruit-feather-huzzah-esp8266/overview) |Arduino IDE(RTOS) | Arduino, C|[開始使用](https://azure.microsoft.com/zh-TW/documentation/samples/iot-hub-c-huzzah-getstartedkit/)|
...
|[Base Technology QuiX 感應器閘道器](https://www.quix.jp/iot/iotqsx/) |Raspbian | Python|[開始使用](https://github.com/Azure/azure-iot-sdks/blob/master/doc/get_started/raspbian-quix-sensor-gateway-python.md)|
...
|[Sparkfun ThingDev](https://www.sparkfun.com/products/13711) |Arduino IDE(RTOS)| Arduino、C|[開始使用](https://azure.microsoft.com/zh-TW/documentation/samples/iot-hub-c-thingdev-getstartedkit/)|
