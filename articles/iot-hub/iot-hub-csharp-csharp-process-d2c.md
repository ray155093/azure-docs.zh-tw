...
在本節中，您將撰寫會從「服務匯流排」佇列接收互動式訊息的 Windows 主控台應用程式。 如需有關如何使用「服務匯流排」來建構解決方案的詳細資訊，請參閱 [使用服務匯流排建置多層式應用程式][使用服務匯流排建置多層式應用程式]。
...
[使用服務匯流排建置多層式應用程式]: ../service-bus-messaging/service-bus-dotnet-multi-tier-app-using-service-bus-queues.md
