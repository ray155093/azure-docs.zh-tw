...
## [開始使用裝置對應項 (節點)](iot-hub-node-node-twin-getstarted.md)
## [開始使用裝置對應項 (.NET/節點)](iot-hub-csharp-node-twin-getstarted.md)
## [使用適用於 Node.js 的直接方法](iot-hub-node-node-direct-methods.md)
## [使用適用於 .NET/節點的直接方法](iot-hub-csharp-node-direct-methods.md)
## [開始使用適用於 Node.js 的裝置管理](iot-hub-node-node-device-management-get-started.md)
## [開始使用適用於 .NET/節點的裝置管理](iot-hub-csharp-node-device-management-get-started.md)
## [使用對應項實體的方式 (節點)](iot-hub-node-node-twin-how-to-configure.md)
## [使用對應項實體的方式 (.NET/節點)](iot-hub-csharp-node-twin-how-to-configure.md)
## [使用裝置作業來更新適用於 Node.js 的裝置韌體](iot-hub-node-node-firmware-update.md)
