---
title: 使用 CLI 建立 IoT 中樞 | Microsoft Docs
...
> [!NOTE]
> Azure 建立和處理資源的部署模型有二種：[Resource Manager 和傳統](../resource-manager-deployment-model.md)。 Azure CLI 必須處於 Azure Resource Manager 模式：
> 
> ```
...
> [!TIP]
> 文章[使用 Azure CLI 管理 Azure 資源和資源群組][lnk-CLI-arm] 提供關於如何使用 Azure CLI 管理 Azure 資源的詳細資訊。 
> 
> 
...
> [!NOTE]
> 此 CLI 命令會新增您付費的「S1 標準 IoT 中樞」。 您可以使用下列命令刪除 IoT 中樞 **exampleIoTHubName** 
> 
> ```
