...
![遙測上傳閘道管線](media/iot-hub-gateway-sdk-physical-device/gateway_ble_upload_data_flow.png)
...
![裝置命令閘道管線](media/iot-hub-gateway-sdk-physical-device/gateway_ble_command_data_flow.png)
