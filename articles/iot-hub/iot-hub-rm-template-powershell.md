---
title: 使用 Resource Manager 範本與 PowerShell 建立 IoT 中樞 | Microsoft Docs
...
> [!TIP]
> [搭配使用 Azure PowerShell 與 Azure Resource Manager][lnk-powershell-arm] 一文提供有關如何使用 PowerShell 指令碼和 Resource Manager 範本來建立 Azure 資源的詳細資訊。
> 
> 
