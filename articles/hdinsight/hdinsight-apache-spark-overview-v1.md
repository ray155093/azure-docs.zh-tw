...
![Azure HDInsight 上的 Apache Spark](./media/hdinsight-apache-spark-overview-v1/hdispark.architecture.png "Azure HDInsight 上的 Apache Spark")


**想要開始使用 Azure HDInsight 上的 Apache Spark 嗎？** 請參閱[快速入門：在 HDInsight 上建立 Spark 叢集並使用 Jupyter 和 Zeppelin 執行範例應用程式](hdinsight-apache-spark-zeppelin-notebook-jupyter-spark-sql-v1.md)。
...
| 功能 | 說明 |
|-------------------------------------|-------------------|
| 容易建立 | 您可以使用 Azure 管理入口網站、Azure PowerShell 或 HDInsight .NET SDK，在幾分鐘之內於 HDInsight 上建立新的 Spark 叢集。請參閱[在 HDInsight 中建立 Spark 叢集](hdinsight-apache-spark-provision-clusters.md) |
...
[觀看教學課程](hdinsight-apache-spark-use-bi-tools-v1.md)
...
[觀看教學課程](hdinsight-apache-spark-ipython-notebook-machine-learning-v1.md)
...
* [使用自訂選項在 HDInsight 上建立 Apache Spark 叢集](hdinsight-apache-spark-provision-clusters.md)
