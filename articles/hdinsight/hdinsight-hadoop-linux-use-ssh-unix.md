...
> [!NOTE]
> 本文中的步驟假設您是使用 Linux、Unix 或 OS X 用戶端。如果您安裝的封裝可提供 `ssh` 和 `ssh-keygen`，例如 [Windows 上 Ubuntu 上的Bash](https://msdn.microsoft.com/commandline/wsl/about)，則可能會在以 Windows 為基礎的用戶端上執行這些步驟。
> 
