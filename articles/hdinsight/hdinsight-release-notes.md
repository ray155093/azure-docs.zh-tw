...
## <a name="notes-for-10262016-release-of-r-server-on-hdinsight"></a>HDInsight 上 R 伺服器 2016/10/26 版本的相關資訊
...
## <a name="notes-for-08302016-release-of-r-server-on-hdinsight"></a>HDInsight 的 R 伺服器 2016/8/30 版本的相關資訊
...
## <a name="notes-for-08172016-release-of-r-server-on-hdinsight"></a>HDInsight 的 R 伺服器 2016/8/17 版本的相關資訊
...
> [!NOTE]
> 為了示範叢集自訂所提供的新功能，已記錄使用指令碼動作在叢集上安裝 Spark 和 R 模組的程序。 如需進一步資訊，請參閱：
