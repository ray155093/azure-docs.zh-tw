...
> [!NOTE]
> 本文件的資訊是 以 Windows 為基礎之 HDInsight 叢集的特定資訊。如需在以 Windows 為基礎的 HDInsight 上檢視和偵錯 Tez 的相關資訊，請參閱[在 HDInsight 上使用 Ambari 檢視來為 Tez 作業偵錯](hdinsight-debug-ambari-tez-view.md)。
> 
> 
...
7. [DAG 詳細資料] 上方有幾個連結可用來顯示 DAG 的相關資訊。
   ...
   * [所有工作嘗試] 顯示嘗試對此 DAG 執行工作的相關資訊。
     ...
     > [!NOTE]
     > 如果您捲動 [頂點]、[工作] 和 [工作嘗試] 的資料行顯示，請注意有連結可以檢視每個資料列的__計數器__和__檢視或下載記錄檔__。
     > 
     > 
...
10. 請注意，現在頁面頂端有與頂點和工作相關的連結。
    ...
    * [來源與接收] 顯示此頂點的資料來源和接收。
      ...
      > 
      > 
11. 選取 [工作]，然後選取名為 **00_000000_\_ 的項目。這會顯示這項工作的 [工作詳細資料]__**。在此畫面中，您可以檢視 [工作計數器]**__ 和 **[工作嘗試\_\_]。
