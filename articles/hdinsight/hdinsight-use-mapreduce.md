...
> [!NOTE]
> 在 HDInsight 2.1 版叢集上的檔案位置是 **wasbs:///example/jars/hadoop-examples.jar**。
> 
> 
...
| [遠端桌面](hdinsight-hadoop-use-mapreduce-remote-desktop.md) |透過**遠端桌面**使用 Hadoop 命令 |Windows |Windows |
