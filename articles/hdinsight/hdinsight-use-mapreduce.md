...
### <a name="hadoop-streaming"></a>Hadoop 資料流
...
> [!NOTE]
> 在 HDInsight 2.1 叢集上，檔案位置是 **wasbs:///example/jars/hadoop-examples.jar**。
...
| [遠端桌面](hdinsight-hadoop-use-mapreduce-remote-desktop.md) |透過 **遠端桌面** |Windows |Windows |
