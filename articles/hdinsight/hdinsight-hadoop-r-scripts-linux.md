---
title: "在以 Linux 為基礎的 HDInsight 上安裝 R | Microsoft Docs"
...
> [!IMPORTANT]
> HDInsight 的 [HDInsight](https://azure.microsoft.com/pricing/details/hdinsight/) 供應項目包括隨附於 HDInsight 叢集的 R 伺服器。 這可讓 R 指令碼使用 MapReduce 和 Spark 來執行分散式計算。 如需詳細資訊，請參閱 [開始使用 HDInsight 中的 R 伺服器](hdinsight-hadoop-r-server-get-started.md)。 
> 
> 
