...
4. 對於 [**帳戶名稱**]，輸入叢集相關 Azure Blob 儲存體帳戶的名稱，然後按一下 [**確定**]。這可以是[預設儲存體帳戶](hdinsight-administer-use-management-portal.md#find-the-default-storage-account)或連結儲存體帳戶。其格式為 *https://<儲存體帳戶名稱>.blob.core.windows.net/*。
...
* [使用 Microsoft Hive ODBC Driver 將 Excel 連接到 HDInsight](hdinsight-connect-excel-hive-odbc-driver.md)
