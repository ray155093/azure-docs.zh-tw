---
title: 使用 Azure 傳統入口網站管理 HDInsight 中的 Hadoop 叢集 | Microsoft Docs
...
> [!WARNING]
> 最新版的 Azure PowerShell 或 Azure CLI 預設會使用 Azure Resource Manager。無法使用 Azure 傳統入口網站來管理使用此模式建立的 HDInsight 叢集。
> 
> 
...
[!INCLUDE [資料中心清單](../../includes/hdinsight-pricing-data-centers-clusters.md)]
