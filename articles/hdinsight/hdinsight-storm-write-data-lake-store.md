...
---
# <a name="use-azure-data-lake-store-with-apache-storm-with-hdinsight"></a>搭配使用 Azure Data Lake Store 與 HDInsight 上的 Apache Storm
...
* **ADLStoreBolt**：使用 [HdfsBolt](http://storm.apache.org/javadoc/apidocs/org/apache/storm/hdfs/bolt/HdfsBolt.html) 元件，將資料寫入至 Azure Data Lake Store。
