---
title: "使用 Apache Ambari Web UI 監視和管理 HDInsight 叢集 | Microsoft Docs"
...
> [!NOTE]
> 選取任何服務的 [ **快速連結** ] 連結將會導致「找不到伺服器」的錯誤，除非您是使用安全通訊端層 (SSL) 通道以 Proxy 將 Web 流量傳送到叢集。 這是因為用來顯示這項資訊的 Web 應用程式不會在網際網路上公開。
> 
...
> [!WARNING]
> 請勿變更以 Linux 為基礎之 HDInsight 叢集上的 Ambari 看門狗 (hdinsightwatchdog) 密碼。 變更密碼將會破壞在叢集上使用指令碼動作或執行調整作業的能力。
> 
> 
