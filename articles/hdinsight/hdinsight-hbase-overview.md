...
---
# <a name="what-is-hbase-in-hdinsight-a-nosql-database-that-provides-bigtablelike-capabilities-for-hadoop"></a>什麼是 HDInsight 中的 HBase：為 Hadoop 提供類似 BigTable 功能的 NoSQL 資料庫
...
## <a name="a-namenextstepsanext-steps"></a><a name="next-steps"></a>接續步驟
...
## <a name="a-nameseealsoasee-also"></a><a name="see-also"></a>另請參閱
