---
title: 什麼是 HDInsight 中的 R？ HDInsight (預覽) 中的 R 伺服器簡介 | Microsoft Docs
...
> [!NOTE]
> 只有 HDInsight Premium 提供 R 伺服器，且目前 HDInsight Premium 僅提供給 Hadoop 與 Spark 叢集使用。因此，在 HDInsight 上目前只可搭配 Hadoop 與 Spark 叢集使用 R 伺服器。如需詳細資訊，請參閱 [HDInsight 提供的不同服務等級與 Hadoop 元件？](hdinsight-component-versioning.md)。
> 
> 
