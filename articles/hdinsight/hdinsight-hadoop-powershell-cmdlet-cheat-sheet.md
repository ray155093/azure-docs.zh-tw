---
title: HDInsight Hadoop PowerShell Cmdlet 小祕技 | Microsoft Docs
...
Microsoft Azure HDInsight 提供 PowerShell Cmdlet，對叢集執行 Hadoop 工作。**Microsoft Azure HDInsight PowerShell Cmdlet 小祕技**旨在提供您最常見的 Hadoop 工作的 PowerShell Cmdlet，例如建立叢集、執行作業、刪除叢集等。小祕技也提供一個清單，列出可供 Microsoft Azure HDInsight 使用的所有 PowerShell Cmdlet。

## HDInsight 小祕技：服務管理模型
**在這裡下載小祕技：[Microsoft Azure HDInsight PowerShell Cmdlet 小祕技](http://download.microsoft.com/download/B/7/D/B7DBB509-164D-4343-9894-12D1FB053776/HDI_PowerShell_Cmdlet_CheatSheet.pdf)**
