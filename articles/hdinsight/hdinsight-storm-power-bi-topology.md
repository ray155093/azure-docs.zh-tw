...
3. 以滑鼠右鍵按一下 [物件總管] 中的資料庫，並建立__新查詢__。將下載的專案中包含的 **IISLogsTable.sql** 檔案的內容，貼上至查詢視窗中，然後使用 Ctrl + Shift + E 來執行查詢。您應該會收到已成功完成命令的訊息。
...
7. 接著，將__方法__拖曳至報告。報告將會更新以列出詞幹和用於 HTTP 要求的對應 HTTP 方法。
