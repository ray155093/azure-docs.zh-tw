...
> [!NOTE]
> 以下步驟是 *使用 Azure Resource Manager 驗證服務主體* 文件中 [使用密碼驗證服務主體 - Azure CLI](../resource-group-authenticate-service-principal.md#authenticate-service-principal-with-password---azure-cli) 所提供之資訊的簡易版。 這些步驟可建立新的服務主體，用來驗證用於建立 Azure 資源 (例如 HDInsight 叢集) 的 REST API 要求。
> 
> 
