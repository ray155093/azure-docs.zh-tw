...
---
# <a name="overview-of-live-steaming-using-azure-media-services"></a>使用 Azure 媒體服務之即時串流的概觀
...
### <a name="program"></a>程式
[程式](https://msdn.microsoft.com/library/azure/dn783463.aspx) 可讓您控制即時資料流區段的發佈和儲存體。 通道會管理程式。 通道和程式的關聯性非常類似於傳統媒體，此處的通道有常數內容資料流，而程式的範圍是該通道上的某些計時事件。
