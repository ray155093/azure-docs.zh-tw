...
>[AZURE.NOTE] 如果您也想要以 PlayReady 加密 HLS 內容，必須建立一般內容金鑰，並將它與您的資產產生關聯。 您也必須設定內容金鑰的授權原則，如 [使用 PlayReady 動態一般加密](media-services-protect-with-drm.md) 主題中所述。
...
- 限制 (open 或 token), - 以及定義如何將金鑰傳遞至用戶端的金鑰傳遞類型的特定資訊。 
