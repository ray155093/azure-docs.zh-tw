...
## <a name="<a-id="classes"></a>media-services-.net-classes-that-are-used-to-configure-license-templates"></a><a id="classes"></a>用來設定授權範本的媒體服務 .NET 類別
...
## <a name="<a-id="schema"></a>playready-license-template-xml-schema"></a><a id="schema"></a>PlayReady 授權範本 XML 結構描述
    <?xml version="1.0" encoding="utf-8"?>
