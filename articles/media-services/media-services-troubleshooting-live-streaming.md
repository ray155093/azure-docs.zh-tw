<properties 
    pageTitle="為即時串流而設的疑難排解指南 | Microsoft Azure" 
...
###<a name="problem:-unable-to-playback-the-published-stream."></a>問題：無法播放發行的資料流。
...
>[AZURE.NOTE] 如果依循下列疑難排解步驟後仍無法順利串流處理，請使用 Azure 入口網站提交支援票證。
