...
本主題說明[媒體編碼器標準預設值](https://msdn.microsoft.com/library/azure/mt269960.aspx)所根據之 XML 結構描述的一些元素和類型。 本主題提供這些員組及其有效值的說明。 稍後會發佈完整的結構描述。  
...
如需根據此結構描述建置的 XML 預設值範例，請參閱 [MES (媒體編碼器標準) 的工作預設值](https://msdn.microsoft.com/library/azure/mt269960.aspx)。
