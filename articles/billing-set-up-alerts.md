<properties pageTitle="為您的 Microsoft Azure 訂用帳戶設定計費警示 | Microsoft Azure" description="描述如何設定您的 Azure 帳單上的警示，以避免計費出現意外的狀況。" services="計費" documentationCenter="" authors="vikdesai" manager="msmbaldwin" editor=""/ tags="計費" />
