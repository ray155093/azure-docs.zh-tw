---
title: 在 Logic Apps 中使用 SQL 連接器 | Microsoft Docs
...
> [!NOTE]
> 這一版文章適用於邏輯應用程式 2014-12-01-preview 結構描述版本。若為 Azure SQL 2015-08-01-preview 結構描述版本，請按一下 [SQL Azure API](../connectors/connectors-create-api-sqlazure.md)。
> 
> 
...
> [!NOTE]
> 此陳述式所傳回的結構描述可識別連接器中可用的屬性。所有資料行都必須命名。
> 
> 
...
## 混合式組態 (選用)
> [!NOTE]
> 只有當您在防火牆後方使用 SQL Server 內部部署時，才需要此步驟。
> 
> 
...
> [!NOTE]
> 如果您想在註冊 Azure 帳戶前開始使用 Azure Logic Apps，請移至[試用 Logic App](https://tryappservice.azure.com/?appservice=logic)，即可在 App Service 中立即建立短期入門邏輯應用程式。不需要信用卡；沒有承諾。
> 
> 
