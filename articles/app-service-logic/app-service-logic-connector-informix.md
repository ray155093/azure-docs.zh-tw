---
title: 在 Microsoft Azure App Service 中使用 Informix 連接器 | Microsoft Docs
...
> [!TIP]
> Informix Connection "*Post to EntitySet*" 會傳回身分識別資料行值，而 "*API Insert*" 會傳回受影響的資料列
> 
> 
...
## 混合式組態 (選用)
> [!NOTE]
> 只有當您在防火牆後方使用 DB2 連接器內部部署時，才需要此步驟。
> 
> 
