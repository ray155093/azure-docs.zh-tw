---
title: 在 Logic Apps 中使用 Azure 服務匯流排連接器 | Microsoft Docs
...
> [!NOTE]
> 這一版文章適用於邏輯應用程式 2014-12-01-preview 結構描述版本。若為 2015-08-01-preview 結構描述版本，請按一下[服務匯流排 API](../connectors/connectors-create-api-servicebus.md)。
> 
> 
