<properties 
	pageTitle="使用 API 應用程式建立邏輯應用程式 | Microsoft Azure" 
...
如需完整範本，請參閱[使用 API 應用程式範本的邏輯應用程式](https://github.com/Azure/azure-quickstart-templates/blob/master/201-logic-app-api-app-create/azuredeploy.json)。
