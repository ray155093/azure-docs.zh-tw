---
title: "整合帳戶與企業整合套件的概觀 | Microsoft Docs"
...
---
# <a name="overview-of-integration-accounts"></a>整合帳戶概觀
...
5. 重新整理頁面。 您將會看到已列出新的整合帳戶。 恭喜！  
   ![](./media/app-service-logic-enterprise-integration-accounts/account-5.png) 

## <a name="how-to-link-an-integration-account-to-a-logic-app"></a>如何將整合帳戶連結到邏輯應用程式
為了讓邏輯應用程式能夠存取對應、結構描述、合約，以及其他位於整合帳戶中的構件，您首先必須將整合帳戶連結到邏輯應用程式。

### <a name="here-are-the-steps-to-link-an-integration-account-to-a-logic-app"></a>以下是將整合帳戶連結到邏輯應用程式的步驟
