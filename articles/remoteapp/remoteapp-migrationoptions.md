...
[Citrix 現有的雲端解決方案](https://www.citrix.com/products/citrix-cloud/)，在架構上與 Citrix XenApp Express 相同。 Citrix 針對現有的 Azure RemoteApp 客戶提供 [50% 的促銷折扣](https://www.citrix.com/blogs/2016/10/03/special-promotion-for-microsoft-azure-remoteapp-customers/)。 

### <a name="citrix-xenapp-express-in-tech-preview"></a>**Citrix XenApp Express (處於技術預覽狀態)**
[註冊其技術預覽](http://now.citrix.com/remoteapp)，並觀察其 [Ignite 工作階段](https://myignite.microsoft.com/videos/2792) (從 20:30 分開始)。 XenApp Express 在架構上與 Citrix Cloud 相同，只不過它包含簡化的管理 UI 和其他類似於 Azure RemoteApp 的功能。 

深入了解 [Citrix XenApp Express](http://now.citrix.com/remoteapp)。   
