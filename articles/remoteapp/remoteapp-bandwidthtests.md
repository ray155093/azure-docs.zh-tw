---
title: "Azure RemoteApp - 利用一些常見案例測試您的網路頻寬使用量 | Microsoft Docs"
...
> [!NOTE]
> 如果您無法執行自己的網路測試，或者您沒有時間去做，請查看我們的 [基本的網路頻寬估計值/建議](remoteapp-bandwidthguidelines.md)。 不過，您的級距可能有所不同，因此，如果您「可以」  執行自己的測試，就應該這樣做。
> 
> 

## <a name="the-usage-tests"></a>使用量測試
