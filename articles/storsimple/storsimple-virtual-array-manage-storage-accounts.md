---
title: "管理 Microsoft Azure StorSimple Virtual Array 的 StorSimple 儲存體帳戶認證 | Microsoft Docs"
description: "針對與 StorSimple Virtual Array 相關聯的儲存體帳戶認證，說明如何使用 StorSimple Manager 的 [設定] 頁面來新增、編輯、刪除或替換安全性金鑰。"
services: storsimple
