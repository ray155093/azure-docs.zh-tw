...
4. 在 [複製磁碟區精靈] 的 [指定名稱和位置] 下：
   ...
   2. 為複製指定唯一的磁碟區名稱。此名稱必須包含 3 到 127 個字元。
      ...
      > [!NOTE]
      > 即使您複製了本機釘選磁碟區，**[將磁碟區複製為]** 欄位仍然會**分層**。 您無法變更此設定，但如果您需要在本機釘選複製的磁碟區，您可以在成功建立複製之後，將複製轉換到本機釘選的磁碟區。如需將分層磁碟區轉換到本機釘選的磁碟區之相關資訊，請前往[變更磁碟區類型](storsimple-manage-volumes-u2.md#change-the-volume-type).
      > 
      > 
