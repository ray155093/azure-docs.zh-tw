...
[!INCLUDE [建立虛擬裝置](../../includes/storsimple-create-virtual-device-u2.md)]
...
執行下列步驟來設定和註冊 StorSimple 虛擬裝置。[!INCLUDE [設定和註冊虛擬裝置](../../includes/storsimple-configure-register-virtual-device.md)]
...
[!INCLUDE [透過 HTTP 設定虛擬裝置的遠端管理](../../includes/storsimple-configure-remote-management-http-device.md)]
...
[!INCLUDE [在虛擬裝置上建立公用端點](../../includes/storsimple-create-public-endpoints-virtual-device.md)]
...
[!INCLUDE [停止和重新啟動虛擬裝置](../../includes/storsimple-stop-restart-virtual-device.md)]
...
[!INCLUDE [關閉虛擬裝置](../../includes/storsimple-shutdown-virtual-device.md)]

[!INCLUDE [刪除虛擬裝置](../../includes/storsimple-delete-virtual-device.md)]
