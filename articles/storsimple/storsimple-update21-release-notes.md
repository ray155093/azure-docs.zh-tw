<properties 
   pageTitle="StorSimple 8000 系列 Update 2.2 版本資訊 | Microsoft Azure"
...
# StorSimple 8000 系列 Update 2.2 版本資訊  
...
| 7 | Windows Management Instrumentation (WMI) | 在先前的軟體版本中，有數個帶有「<ManagementException> 提供者載入失敗」例外狀況的 Web Proxy 失敗情況。這個錯誤屬於 WMI 記憶體流失錯誤，現在已經修正。 | 是 | 否 |
