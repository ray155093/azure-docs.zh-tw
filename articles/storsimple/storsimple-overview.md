...
| 支援其他雲端服務提供者 |包含軟體更新 1 或更新版本的 StorSimple 8000 Series 支援使用 RRS 的 Amazon S3、HP 和 OpenStack 雲端服務，以及 Microsoft Azure。 (您仍然需要 Microsoft Azure 儲存體帳戶進行裝置管理。)如需詳細資訊，請參閱 [Update 1.2 的新功能](storsimple-update1-release-notes.md#whats-new-in-update-12)。 |
