---
title: "更換 StorSimple 裝置上的電池 | Microsoft Docs"
...
> [!IMPORTANT]
> 取下及更換備份電池模組之前，請閱讀 [StorSimple 硬體元件更換](storsimple-hardware-component-replacement.md)中的安全資訊。
> 
> 
...
在 Azure 傳統入口網站中，[維護] 頁面上的 [硬體狀態] 指出電池是否故障，或電池何時即將用光。 在 [共用元件] 下，電池狀態是以 [PCM 1 中的電池] 或 [PCM 0 中的電池] 指出。 此頁面會顯示 [降級] 狀態，表示電池即將用光，以及顯示 [故障]，表示電池已用光。 
...
* 如果沒有相關聯的 AC 電源喪失，而且 PCM 已開啟並連接至 AC 電源，則電池需要更換。 [Contact Microsoft Support](storsimple-contact-microsoft-support.md) ，以訂購更換備份電池模組。
