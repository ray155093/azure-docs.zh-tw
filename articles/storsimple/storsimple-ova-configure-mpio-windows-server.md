---
title: "在您的 StorSimple Virtual Array 主機上設定 MPIO| Microsoft Docs"
...
### <a name="hardware-configuration-for-storsimple-virtual-array"></a>StorSimple Virtual Array 的硬體組態
...
11. 在 [進階設定]  對話方塊中：                                        
    ...
    * [詳細資料]** 對話方塊隨即顯示。在 [MPIO]**** 索引標籤上，您可以選取適當 [負載平衡原則]**** 設定。您也可以檢視 [使用中]**** 或 [待命]**** 路徑類型。
...
14. 藉由瀏覽至 [伺服器管理員] > [儀表板] > [電腦管理]，來開啟 [電腦管理]。 在左窗格中，按一下 [存放裝置] > [磁碟管理]。 在 StorSimple Virtual Array 上建立且是此主機可以看見的磁碟區，在 [磁碟管理]  下會顯示為新磁碟。
