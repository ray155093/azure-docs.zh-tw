...
---
# <a name="integrating-data-lake-store-with-other-azure-services"></a>整合資料湖存放區與其他 Azure 服務
Azure 資料湖存放區可以與其他 Azure 服務一起使用，以啟用更廣泛的案例。 下列文章列出資料湖存放區可以整合的服務。

## <a name="use-data-lake-store-with-azure-hdinsight"></a>搭配 Azure HDInsight 使用資料湖存放區
...
## <a name="use-data-lake-store-with-azure-data-lake-analytics"></a>搭配 Azure 資料湖分析使用資料湖存放區
...
## <a name="use-data-lake-store-with-azure-data-factory"></a>搭配 Azure Data Factory 使用資料湖存放區
...
## <a name="copy-data-from-azure-storage-blobs-into-data-lake-store"></a>將資料從 Azure 儲存體 Blob 複製到資料湖存放區中
