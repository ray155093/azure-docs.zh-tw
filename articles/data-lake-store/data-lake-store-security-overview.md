...
組織想要確保其業務關鍵資料在整個生命週期中受到保護。對於傳輸中的資料，Data Lake Store 會使用業界標準的傳輸層安全性 (TLS) 通訊協定來保護在用戶端與 Data Lake Security 之間移動的資料。
