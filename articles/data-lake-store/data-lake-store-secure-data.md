...
2. 在您的 [Data Lake Store 帳戶] 刀鋒視窗中，按一下 [設定]。 從 [設定] 刀鋒視窗中，按一下 [使用者]。
...
![防火牆設定和 IP 存取](./media/data-lake-store-secure-data/firewall-ip-access.png "Firewall settings and IP address")
