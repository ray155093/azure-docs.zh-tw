...
## <a name="physical-layout-of-service-fabric-clusters-in-azure"></a>Azure 中 Service Fabric 叢集的實體配置
...
> [!NOTE]
> 叢集對應中的另一個軸會顯示升級網域，其以邏輯方式根據計劃性維護活動將節點分組。 Azure 中的 Service Fabric 叢集一律配置於五個升級網域。
> 
> 
...
### <a name="individual-machine-failures"></a>個別機器失敗
...
### <a name="multiple-concurrent-machine-failures"></a>多個並行機器失敗
...
### <a name="software-failures-and-other-sources-of-data-loss"></a>軟體失敗和資料遺失的其他來源
