---
title: Azure Service Fabric Reliable Services 組態概觀 | Microsoft Docs
...
> [!NOTE]
> 除非您打算透過程式碼設定服務，否則請**不要**刪除在 Visual Studio 方案中產生之 Settings.xml 檔案中的下列組態區段名稱。設定 ReliableStateManager 時，重新命名組態封裝或區段名稱將需要變更程式碼。
> 
> 
