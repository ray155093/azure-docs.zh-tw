...
---
# <a name="set-up-continuous-integration-for-a-service-fabric-application-by-using-visual-studio-team-services"></a>使用 Visual Studio Team Services 為 Service Fabric 應用程式設定持續整合
