...
---
# <a name="enable-stretch-database-for-a-table"></a>為資料表啟用 Stretch Database
...
## <a name="a-nameenablewizardtableause-the-wizard-to-enable-stretch-database-on-a-table"></a><a name="EnableWizardTable"></a>使用精靈以在資料表上啟用 Stretch Database
**啟動精靈**
...
## <a name="a-nameenabletsqltableause-transact-sql-to-enable-stretch-database-on-a-table"></a><a name="EnableTSQLTable"></a>使用 Transact\-SQL 以在資料表上啟用 Stretch Database
...
### <a name="create-a-new-table-with-stretch-database-enabled"></a>建立新資料表並啟用 Stretch Database
