...
標準層提供免費層的功能，加上進階偵測功能：威脅情報、行為分析、當機分析，和異常偵測。90 天的免費標準層試用已可使用。若要升級，請選取[安全性原則](security-center-policies.md#setting-security-policies-for-subscriptions)中的 [定價層]。若要深入了解，請參閱[價格頁面](https://azure.microsoft.com/pricing/details/security-center/)。
...
### 為什麼 Azure 資訊安全中心無法辨識我的 Azure VM 上所執行的反惡意程式碼軟體解決方案？
