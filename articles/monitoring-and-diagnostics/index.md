        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 Azure 入口網站建立 Azure 服務的警示</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用跨平台 CLI 建立 Azure 服務的警示</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 PowerShell 建立 Azure 服務的警示</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 Resource Manager 範本建立度量警示</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/monitor/">REST API 參考資料</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>監視</h3>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-supported-metrics">支援的計量清單</a></p>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-data-sources">監視資料的來源</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>診斷</h3>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-versioning-history">Azure 診斷延伸版本歷程記錄</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema">Azure 診斷延伸結構描述</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot0">Azure 診斷擴充結構描述 1.0</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot2">Azure 診斷擴充結構描述 1.2</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot3-and-later">Azure 診斷擴充結構描述 1.3 至 1.7</a></p>
                    </div>
                </div>
            </div>
        </div>
