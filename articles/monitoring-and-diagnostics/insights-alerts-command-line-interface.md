...
---
# <a name="use-the-cross-platform-command-line-interface-cli-to-create-alerts-for-azure-services"></a>使用跨平台命令列介面 (CLI) 建立 Azure 服務的警示
...
5. 若要建立活動記錄檔中特定條件發生時就會引發的警示，使用此格式︰
    ...
    **insights alerts rule log set** *[options] &lt;ruleName&gt; &lt;location&gt; &lt;resourceGroup&gt; &lt;operationName&gt;*
    ...
    operationName 對應到活動記錄檔中事件類型的項目。 範例包括 *Microsoft.Compute/virtualMachines/delete* 和 *microsoft.insights/diagnosticSettings/write*。
