...
* **Azure 監視器**：允許根據度量值和活動記錄檔事件的警示。 Azure 監視器包含 [Azure 監視器REST API](https://msdn.microsoft.com/library/dn931943.aspx)。  如需詳細資訊，請參閱 [使用 Azure 入口網站、PowerShell 或命令列介面來建立警示](insights-alerts-portal.md)。
