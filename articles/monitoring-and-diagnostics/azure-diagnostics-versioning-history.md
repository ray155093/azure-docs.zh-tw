---
title: "Azure 診斷版本歷程記錄 | Microsoft Docs"
...
Azure SDK 2.8 已增加將診斷資料傳送至 [Application Insights](../application-insights/app-insights-cloudservices.md) 的功能，因此可更容易在應用程式以及系統和基礎結構層級中診斷問題。
