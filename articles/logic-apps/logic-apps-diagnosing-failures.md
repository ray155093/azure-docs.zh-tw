---
title: "診斷 Azure 邏輯應用程式中的失敗 | Microsoft Docs"
...
* **執行中**。 工作流程目前正在執行中。 這可能會出現於正在進行節流處理的流程，或者因為目前的定價方案所導致。 如需詳細資訊，請參閱 [定價頁面](https://azure.microsoft.com/pricing/details/app-service/plans/) 上的動作限制。 設定診斷功能 (執行歷程記錄下方列出的圖表) 也可以提供所發生的任何節流事件的相關資訊。
...
> [!NOTE]
> 如果您看見任何不了解的內容，這可能有助於了解 Logic Apps 功能如何 [處理不同的內容類型](../logic-apps/logic-apps-content-type.md) 。
> 
> 
