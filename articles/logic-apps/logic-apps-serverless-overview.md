...
---
<a id="overview-of-azure-serverless-with-functions-and-logic-apps" class="xliff"></a>

# Azure 無伺服器搭配 Functions 和 Logic Apps 的概觀

無伺服器應用程式提供的好處包括加速開發、減少必要的程式碼，以及簡單調整。  本文描述無伺服器解決方案的各種屬性和 Azure 無伺服器供應項目。

<a id="what-is-serverless" class="xliff"></a>
...
<a id="what-are-azure-functions" class="xliff"></a>
...
<a id="what-are-azure-logic-apps" class="xliff"></a>
...
<a id="how-can-i-build-and-deploy-serverless-applications-in-azure" class="xliff"></a>

## 如何在 Azure 中建置和部署無伺服器應用程式？
