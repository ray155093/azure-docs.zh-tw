...
<a name=”role”></a>
### **角色**  
用於控制可指派給使用者、群組和服務的存取權的方式。角色能夠在 Azure 資源上執行建立、管理及讀取之類的動作。請參閱 [RBAC：內建角色](./active-directory/role-based-access-built-in-roles.md)
...
另請參閱[有關虛擬機器擴充功能和功能 (Windows)](./virtual-machines/virtual-machines-windows-extensions-features.md) 或[有關虛擬機器擴充功能和功能 (Linux)](./virtual-machines/virtual-machines-linux-extensions-features.md)
