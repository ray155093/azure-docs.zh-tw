...
如果您從 MongoDB 匯入資料，而且想要將這些資料用於 DocumentDB API，必須使用「資料移轉工具」匯入資料。 如需詳細資訊，請參閱[資料移轉工具](import-data.md)。
...
右窗格中有您成功連接到您的帳戶所需的所有資訊。
    ...
    ![連接字串刀鋒視窗](./media/mongodb-migrate/ConnectionStringBlade.png)
