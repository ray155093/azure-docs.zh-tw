...
|**快速入門**|[Azure Cosmos DB：使用 .NET 和資料表 API 建置應用程式 (英文)](https://aka.ms/acdbtnetqs)|
...
若要深入了解 Azure Cosmos DB 資料表 API，請參閱 [Azure Cosmos DB 簡介：資料表 API](table-introduction.md)。 
