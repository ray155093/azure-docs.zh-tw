...
---
# 管理 Azure 流量管理員設定檔
您可以使用流量管理員設定檔來指定流量管理員要監視的雲端服務或網站端點，以及您要使用何種流量路由方法將連接散發到這些端點。
...
### 建立新的流量管理員設定檔
1. **將您的雲端服務和網站部署到您的生產環境中。** 如需雲端服務的詳細資訊，請參閱[雲端服務](http://go.microsoft.com/fwlink/p/?LinkId=314074)。如需雲端服務的相關資訊，請參閱[最佳做法](https://msdn.microsoft.com/library/azure/5229dd1c-5a91-4869-8522-bed8597d9cf5#bkmk_TrafficManagerBestPracticesProfile)。如需網站的詳細資訊，請參閱[網站](http://go.microsoft.com/fwlink/p/?LinkId=393327)。
