...
# <a name="configure-round-robin-routing-method"></a>設定循環配置資源路由方法
...
## <a name="routing-traffic-equally-round-robin-across-a-set-of-endpoints"></a>將流量平均地路由 (循環配置資源) 到一組端點：
