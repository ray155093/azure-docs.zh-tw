...
## <a name="verify-that-you-have-the-latest-version-of-powershell"></a>確認您擁有最新版本的 PowerShell

請確認您已安裝最新版的 Azure Resource Manager PowerShell Cmdlet。 如需如何安裝 PowerShell Cmdlet 的詳細資訊，請參閱 [如何安裝和設定 Azure PowerShell](/powershell/azureps-cmdlets-docs) 。
...
#### <a name="if-a-record-set-already-exists"></a>如果記錄集已經存在
...
### <a name="3-add-a-record"></a>3.新增記錄
...
## <a name="create-a-record-set-of-each-type-with-a-single-record"></a>針對每一種類型建立含有單一記錄的記錄集
