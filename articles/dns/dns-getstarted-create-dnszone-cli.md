...
安裝 Azure CLI。您可以安裝適用於 Windows、Linux 或 MAC 的 Azure CLI。必須先完成下列步驟，才能使用 Azure CLI 管理 Azure DNS。您可以在[安裝 Azure CLI](../xplat-cli-install.md) 中取得詳細資訊。使用下列命令，可以找到 CLI 上的所有網路提供者命令：
