---
title: "使用 PowerShell 管理 Azure 服務的反向 DNS 記錄 | Microsoft Docs"
...
---
# <a name="how-to-manage-reverse-dns-records-for-your-azure-services-using-azure-powershell"></a>如何使用 Azure PowerShell 管理 Azure 服務的反向 DNS 記錄
