---
title: "使用 Azure CLI 1.0 建立 DNS 區域 | Microsoft Docs"
description: "了解如何建立 Azure DNS 中的 DNS 區域。 這份逐步指南，將引導您使用 Azure CLI 1.0 來建立與管理第一個 DNS 區域。"
services: dns
...
# <a name="create-an-azure-dns-zone-using-azure-cli-10"></a>使用 Azure CLI 1.0 建立 Azure DNS 區域
