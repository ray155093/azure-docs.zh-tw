...
### Azure DevTest Labs 中有哪些不同的安全性層級？  
...
### 為什麼我在 [Azure 虛擬機器] 刀鋒視窗中沒看到可在 Azure DevTest Labs 看到的某些 VM？
...
### 如何將現有 Azure VM 移到 Azure DevTest Labs 實驗室？ 
...
1. 在 Azure DevTest Labs 實驗室內[建立自訂映像](devtest-lab-create-template.md)。
1. 在實驗室中從自訂映像建立 VM
