---
title: 我的 MVC 專案 (Visual Studio Azure Active Directory 已連線服務) 發生什麼事 | Microsoft Docs
...
## 已加入程式碼
### 程式碼檔案加入至專案
驗證啟動類別 **App\_Start/Startup.Auth.cs** 加入至專案，內含 Azure AD 驗證的啟動邏輯。另外也已加入控制器類別 Controllers/AccountController.cs，內含 **SignIn()** 和 **SignOut()** 方法。最後，已加入部分檢視 **Views/Shared/\_LoginPartial.cshtml**，內含 SignIn/SignOut 的動作連結。
