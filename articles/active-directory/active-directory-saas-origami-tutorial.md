...
# 教學課程：Azure Active Directory 與 Origami 整合
...
7. 在結果窗格中，選取 [Origami]，然後按一下 [完成] 以加入應用程式。
...
5. 在 [告訴我們這位使用者] 對話方塊頁面上，執行以下步驟：![建立 Azure AD 測試使用者](./media/active-directory-saas-origami-tutorial/create_aaduser_05.png)
