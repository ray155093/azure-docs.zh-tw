...
5. 在搜尋方塊中，輸入 **Workday**。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-workday-inbound-tutorial/IC701021.png "從資源庫新增應用程式")
6. 在結果窗格中，選取 [Workday]，然後按一下 [完成] 以加入應用程式。
   
   ![應用程式資源庫](./media/active-directory-saas-workday-inbound-tutorial/IC701022.png "應用程式資源庫")
...
## <a name="configure-user-import-in-azure-ad"></a>在 Azure AD 中設定使用者匯入
...
2. 在 [設定及管理員認證] 頁面上，執行以下步驟，然後按一下 [下一步]： 
    ...
    ![設定及管理員認證](./media/active-directory-saas-workday-inbound-tutorial/IC750995.png "設定及管理員認證")    
  1. 在 [Workday 管理使用者名稱] 文字方塊中，輸入您在＜建立整合系統使用者＞一節中建立的使用者名稱。
  2. 在 [Workday 管理員使用者密碼] 文字方塊中，輸入您在＜建立整合系統使用者＞一節中建立的使用者密碼。
...
5. 在 [開始佈建] 對話方塊中，按一下 [完成]。 
    ...
    ![開始佈建](./media/active-directory-saas-workday-inbound-tutorial/IC750998.png "開始佈建")
