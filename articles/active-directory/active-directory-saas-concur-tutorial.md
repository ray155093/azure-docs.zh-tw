...
## <a name="enable-the-application-integration-for-concur"></a>啟用 Concur 的應用程式整合
...
4. 若要開啟 [應用程式庫]，請按一下 [新增應用程式]，然後按一下 [新增應用程式讓我的組織使用]。
  ...
  ![您要怎麼做？](./media/active-directory-saas-concur-tutorial/IC700995.png "您要怎麼做？")
5. 在**搜尋方塊**中，輸入 **Concur**。
   
  ![應用程式資源庫](./media/active-directory-saas-concur-tutorial/IC721727.png "應用程式資源庫")
