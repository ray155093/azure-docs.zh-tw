...
如要讓單一登入順利運作，Azure AD 必須要知道與某位 Azure AD 使用者互相對應的 Domo 使用者。 換句話說，必須要建立某位 Azure AD 使用者與 Domo 中相關使用者之間的連結關聯性。  
...
6. 如要為您的應用程式設定 SSO，請透過 [support@domo.com](mailto: support@domo.com) 與您的 Domo 支援小組連絡，並在電子郵件中附加您下載的憑證，同時提供 [簽發者 URL]、[SAML SSO URL] 及 [登出 URL]。
