...
若要設定將 SensoScientific Wireless Temperature Monitoring System 整合到 Azure AD 中，您需要從資源庫將 SensoScientific Wireless Temperature Monitoring System 新增到受管理的 SaaS 應用程式清單。
