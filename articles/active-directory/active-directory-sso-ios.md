...
請注意，下列文件假設您已了解如何[在 Azure Active directory 的舊版入口網站中佈建應用程式](develop/active-directory-how-to-integrate.md)，並且已整合應用程式和 [Microsoft Identity iOS SDK](https://github.com/AzureAD/azure-activedirectory-library-for-objc)。
