...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 Ariba 單一登入 (SSO)
...
## <a name="add-ariba-from-the-gallery"></a>從資源庫加入 Ariba
若要設定 Ariba 與 Azure AD 整合，您需要從資源庫將 Ariba 加入受管理的 SaaS 應用程式清單中。
...
7. 在結果窗格中，選取 [Ariba]，然後按一下 [完成] 以新增應用程式。
...
本節的目標是要說明如何以名為 "Britta Simon" 的測試使用者為基礎，設定及測試與 Ariba 搭配運作的 Azure AD SSO。

若要讓 SSO 運作，Azure AD 必須知道 Ariba 與 Azure AD 中互相對應的使用者。 換句話說，必須建立 Azure AD 使用者和 Ariba 中相關使用者之間的連結關聯性。

建立此連結關聯性的方法，是將 Azure AD 中**使用者名稱**的值，指派為 Ariba 中 **Username** 的值。

若要設定及測試與 Ariba 搭配運作的 Azure AD SSO，您需要完成下列建置組塊：

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
3. **[建立 Ariba 測試使用者](#creating-a-ariba-test-user)** - 讓 Britta Simon 在 Ariba 中有一個對應身分連結到她的 Azure AD 代表身分。
4. **[指派 Azure AD 測試使用者](#assigning-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** - 驗證組態是否能運作。

### <a name="configure-azure-ad-sso"></a>設定 Azure AD SSO
本節的目標是要在 Azure 傳統入口網站中啟用 Azure AD SSO，並在您的 Ariba 應用程式中設定 SSO。

**若要設定與 Ariba 搭配運作的 Azure AD SSO，請執行下列步驟：**
...
3. 在 [設定應用程式設定]  對話方塊頁面上，執行下列步驟：
  ...
  1. 在 [登入 URL] 文字方塊中，使用下列模式輸入使用者用來登入 Ariba 應用程式的 URL：**“https://<companyname>.sourcing.ariba.com"** 或 **"https://<CompanyName>.supplier.ariba.com”**。
  2. 按 [下一步] 。
...
4. 在 [設定在 Ariba 單一登入]  頁面上，執行下列步驟：
  ...
  2. 按 [下一步] 。
5. 若要為您的應用程式設定 SSO，請透過 **1-866-218-2155**連絡您的 Ariba 支援小組。

 >[!NOTE]
 >請確定 Ariba 系統中的使用者名稱必須符合 Azure AD，否則整合將無法運作。
 >  
...
### <a name="create-a-ariba-test-user"></a>建立 Ariba 測試使用者
本節的目標是要在 Ariba 中建立名為 Britta Simon 的使用者。 請與 Ariba 支援小組合作，在 Ariba 系統中新增使用者。 

 >[!NOTE]
 >如果您需要手動建立使用者，您需要連絡 Ariba 支援小組。
 >  
