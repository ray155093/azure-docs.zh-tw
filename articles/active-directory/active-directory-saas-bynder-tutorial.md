<properties
	pageTitle="教學課程：Azure Active Directory 與 Bynder 整合 | Microsoft Azure"
...
# 教學課程：Azure Active Directory 與 Bynder 整合
...
7. 在結果窗格中，選取 [Bynder]，然後按一下 [完成] 以加入應用程式。
...
> [AZURE.NOTE] 如果您需要手動建立使用者，就必須連絡 Bynder 支援小組。
