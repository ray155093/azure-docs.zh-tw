...
若要設定將 itslearning 整合到 Azure AD 中，您需要從資源庫將 itslearning 新增到受管理的 SaaS app 清單。
...
3. 在 [itslearning 網域及 URL] 區段中，執行下列步驟：
    ...
    b.這是另一個 C# 主控台應用程式。 在 [識別碼] 文字方塊中輸入 URL：`urn:mace:saml2v2.no:services:com.itslearning`
