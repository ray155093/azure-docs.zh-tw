...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-mimecast-admin-console-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **Mimecast Admin Console**。
   
   ![應用程式資源庫](./media/active-directory-saas-mimecast-admin-console-tutorial/IC795009.png "應用程式資源庫")
...
**若要將使用者指派給 Mimecast Admin Console，請執行下列步驟：**
