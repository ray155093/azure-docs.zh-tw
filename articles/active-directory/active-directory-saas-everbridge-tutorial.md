...
# 教學課程：Azure Active Directory 與 Everbridge 整合
...
建立此連結關聯性的方法是將 Azure AD 中**使用者名稱**的值指定為 Everbridge 中 **Username** 的值。
...
在本節中，您會在 Everbridge 中建立名為 Britta Simon 的使用者。請透過 <mailto:support@everbridge.com> 來與 Everbridge 支援小組合作，在 Anaplan 平台中加入使用者。
