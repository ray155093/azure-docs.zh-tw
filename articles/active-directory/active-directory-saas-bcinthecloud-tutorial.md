...
若要設定將 BC in the Cloud 整合到 Azure AD 中，您需要從資源庫將 BC in the Cloud 新增到受管理的 SaaS 應用程式清單。
...
3. 在 [BC in the Cloud 網域及 URL] 區段上，執行下列步驟：
    ...
    b.這是另一個 C# 主控台應用程式。 在 [識別碼] 文字方塊中，將 URL 輸入為：`https://app.bcinthecloud.com`

    > [!NOTE] 
    > 這不是真實的值。 使用實際的「登入 URL」來更新此值。 請連絡 [BC in the Cloud 用戶端支援小組](https://www.bcinthecloud.com/supportcenter/)以取得此值。 
