...
## <a name="enabling-the-application-integration-for-cisco-webex"></a>啟用 Cisco Webex 的應用程式整合
本節的目的是要說明如何啟用 Cisco Webex 的應用程式整合。

### <a name="to-enable-the-application-integration-for-cisco-webex-perform-the-following-steps"></a>若要啟用 Cisco Webex 的應用程式整合，請執行下列步驟：
...
### <a name="to-assign-users-to-cisco-webex-perform-the-following-steps"></a>若要將使用者指派給 Cisco Webex，請執行下列步驟：
