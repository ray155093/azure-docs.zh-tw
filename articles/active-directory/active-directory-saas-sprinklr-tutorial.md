...
6. 在**搜尋方塊** 中，輸入 **Sprinklr**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-sprinklr-tutorial/IC782901.png "應用程式資源庫")
...
3. 在 [設定應用程式 URL] 頁面的 [Sprinklr 登入 URL] 文字方塊中，使用下列模式輸入您的 URL："*https://\<tenant-name\>.sprinklr.com*"，然後按 [下一步]。
...
### <a name="to-provision-a-user-account-in-sprinklr-perform-the-following-steps"></a>若要佈建使用者帳戶到 Sprinklr，請執行下列步驟：
