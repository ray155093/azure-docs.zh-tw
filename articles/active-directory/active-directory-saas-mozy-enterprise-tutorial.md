...
完成本教學課程之後，您指派給 Mozy Enterprise 的 Azure AD 使用者就能夠單一登入您 Mozy Enterprise 公司網站 (服務提供者起始登入) 的應用程式，或是使用 [存取面板簡介](active-directory-saas-access-panel-introduction.md)。
...
### <a name="to-enable-the-application-integration-for-mozy-enterprise-perform-the-following-steps"></a>若要啟用 Mozy Enterprise 的應用程式整合，請執行下列步驟：
...
### <a name="to-assign-users-to-mozy-enterprise-perform-the-following-steps"></a>若要將使用者指派給 Mozy Enterprise，請執行下列步驟：
