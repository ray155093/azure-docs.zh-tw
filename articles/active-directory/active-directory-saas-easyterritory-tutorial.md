...
4. 在搜尋方塊中，輸入 **EasyTerritory**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-easyterritory-tutorial/tutorial_easyterritory_001.png)

5. 在結果窗格中，選取 [EasyTerritory]，然後按一下 [新增] 按鈕以新增應用程式。
...
5. 在 [SAML 簽署憑證] 區段上，按一下 [建立新憑證]。
    ...
    ![設定單一登入](./media/active-directory-saas-easyterritory-tutorial/tutorial_easyterritory_04.png)     
...
8. 在 [變換憑證] 快顯視窗上，按一下 [確定]。
    ...
    ![設定單一登入](./media/active-directory-saas-easyterritory-tutorial/tutorial_general_400.png)

9. 在 [SAML 簽署憑證] 區段上，按一下 [中繼資料 XML]，然後將中繼資料檔案儲存在您的電腦上。

    ![設定單一登入](./media/active-directory-saas-easyterritory-tutorial/tutorial_easyterritory_06.png) 
...
2. 移至 [使用者和群組]，然後按一下 [所有使用者] 以顯示使用者清單。
    ...
    ![建立 Azure AD 測試使用者](./media/active-directory-saas-easyterritory-tutorial/create_aaduser_02.png) 
...
2. 在應用程式清單中，選取 [EasyTerritory]。
    ...
    ![設定單一登入](./media/active-directory-saas-easyterritory-tutorial/tutorial_easyterritory_50.png) 
