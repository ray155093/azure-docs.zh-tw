---
title: "Office 365 服務的條件式存取裝置原則 | Microsoft Docs"
...
---
# <a name="conditional-access-device-policies-for-office-365-services"></a>Office 365 服務的條件式存取裝置原則
...
## <a name="how-does-conditional-access-policy-work"></a>條件式存取原則如何運作？
