...
## <a name="how-to-customize-the-expiration-date-for-your-federation-certificate"></a>如何自訂同盟憑證的到期日期
...
5. 按一下 [下載憑證] 。 若要成功更新您的憑證，您必須執行下列兩個步驟：
   ...
   * 在 Azure AD 中，選取對話方塊底部的確認核取方塊啟用新的憑證，然後按 [下一步]  送出。
     ...
     > [!IMPORTANT]
     > 只完成這兩個步驟的任何其中一步時會停用應用程式的單一登入，但是完成第二個步驟後會再次啟用。 因此，為了減少停機時間，請準備好在短時間內互相完成這兩個步驟。
     > 
     > 
