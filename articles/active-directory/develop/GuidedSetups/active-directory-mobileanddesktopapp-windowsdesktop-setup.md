...
> 想要改為下載此範例的 Visual Studio 專案嗎？ [下載專案](https://github.com/Azure-Samples/active-directory-dotnet-desktop-msgraph-v2/archive/master.zip) 並跳至[設定](#create-an-application-express "設定步驟")步驟，以在執行之前先設定程式碼範例。
