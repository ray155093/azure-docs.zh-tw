...
* 您可以讓使用者使用他們的 Azure AD 帳戶自動登入 Deputy 單一登入 (*SSO)
...
本節的目標是要說明如何以名為 "Britta Simon" 的測試使用者為基礎，設定及測試與 Deputy 搭配運作的 Azure AD SSO。

若要讓 SSO 運作，Azure AD 必須知道 Deputy 中與 Azure AD 互相對應的使用者。 換句話說，必須要建立某位 Azure AD 使用者與 Deputy 中相關使用者之間的連結關聯性。

建立此連結關聯性的方法，是將 Azure AD 中**使用者名稱**的值，指派為 Deputy 中 **Username** 的值。

若要設定及測試與 Deputy 搭配運作的 Azure AD SSO，您需要完成下列建置組塊：
...
在本節中，您會在傳統入口網站中啟用 Azure AD 單一登入，然後在您的 Deputy 應用程式中設定 SSO。
...
5. 在 [告訴我們這位使用者]  對話方塊頁面上，執行下列步驟：
   ...
   3. 按一下 [下一步]。6. 在 [使用者設定檔] 對話方塊頁面上，執行下列步驟：
...
### <a name="create-a-deputy-test-user"></a>建立 Deputy 測試使用者
...
5. AAD 帳戶的持有者會收到一封電子郵件，並遵循連結在啟用其帳戶前進行確認。 您可以使用任何其他的 Deputy 使用者帳戶建立工具或 Deputy 提供的 API 來佈建 AAD 使用者帳戶。
    
### <a name="assign-the-azure-ad-test-user"></a>指派 Azure AD 測試使用者
本節的目標是將對 Deputy 的存取權授與 Britta Simon，使她能夠使用 Azure SSO。
