...
完成本教學課程之後，您指派給 ZScaler ZSCloud 的 Azure AD 使用者就能夠單一登入您 ZScaler ZSCloud 公司網站 (服務提供者起始登入) 的應用程式，或是使用 [存取面板簡介](active-directory-saas-access-panel-introduction.md)
...
## <a name="enabling-the-application-integration-for-zscaler-zscloud"></a>啟用 ZScaler ZSCloud 的應用程式整合
本節的目的是要說明如何啟用 ZScaler ZSCloud 的應用程式整合。

### <a name="to-enable-the-application-integration-for-zscaler-zscloud-perform-the-following-steps"></a>若要啟用 ZScaler ZSCloud 的應用程式整合，請執行下列步驟：
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-zscaler-zscloud-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **ZScaler ZSCloud**。
   
   ![應用程式資源庫](./media/active-directory-saas-zscaler-zscloud-tutorial/IC800276.png "應用程式資源庫")
...
### <a name="to-assign-users-to-zscaler-zscloud-perform-the-following-steps"></a>若要指派使用者給 ZScaler ZSCloud，請執行下列步驟：
