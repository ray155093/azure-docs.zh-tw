...
## <a name="how-an-azure-subscription-is-related-to-azure-ad"></a>Azure 訂用帳戶如何與 Azure AD 有關
...
## <a name="how-to-manage-a-subscription-and-a-directory"></a>如何管理訂用帳戶和目錄
...
## <a name="why-cant-i-manage-the-directory-with-my-current-user-account"></a>為什麼我無法使用目前的使用者帳戶來管理目錄？
...
## <a name="using-your-work-or-school-account-to-manage-an-azure-subscription-that-was-created-by-using-a-microsoft-account"></a>使用您的工作或學校帳戶來管理使用 Microsoft 帳戶建立的 Azure 訂用帳戶
...
## <a name="signing-in-when-you-used-your-work-email-for-your-microsoft-account"></a>當您使用公司電子郵件作為 Microsoft 帳戶時登入
...
### <a name="i-do-not-have-a-subscription-for-azure"></a>我沒有 Azure 訂用帳戶
...
### <a name="i-do-have-a-subscription-for-azure-using-my-microsoft-account"></a>我沒有使用 Microsoft 帳戶的 Azure 訂用帳戶
