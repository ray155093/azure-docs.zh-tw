...
1. 在 [自訂屬性對應] 區段中，選擇您想要與 Azure AD 宣告對應的欄位。在此範例中，會使用 http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress** 的值對應 **emailaddress** 宣告。這是 Azure AD 針對電子郵件宣告所提供的預設宣告名稱。
...
8. 在 Azure 傳統入口網站上，選取 [單一登入設定確認]，然後按 [下一步]。
