<properties
	pageTitle="教學課程：Azure Active Directory 與 HireVue 整合 | Microsoft Azure"
...
# 教學課程：Azure Active Directory 與 HireVue 整合
...
7. 在結果窗格中，選取 [HireVue]，然後按一下 [完成] 以加入應用程式。
...
建立此連結關聯性的方法，是將 Azure AD 中**使用者名稱**的值指派為 HireVue 中 **Username** 的值。
...
5. 在 [告訴我們這位使用者] 對話方塊頁面上，執行以下步驟：![建立 Azure AD 測試使用者](./media/active-directory-saas-hirevue-tutorial/create_aaduser_05.png)
