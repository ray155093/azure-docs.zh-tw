...
若要設定將 InsideView 整合到 Azure AD 中，您需要從資源庫將 InsideView 新增到受管理的 SaaS app 清單。
...
9. 在 [加入新的 SAML]  區段中，執行下列步驟：
    ...
    b.這是另一個 C# 主控台應用程式。 在 [SamlP/WS-Fed 來路不明端點] 文字方塊中，貼上您從 Azure 入口網站複製的 [SAML 單一登入服務 URL] 值。
