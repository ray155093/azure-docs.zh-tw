...
## <a name="enable-the-application-integration-for-insideview"></a>啟用 InsideView 的應用程式整合
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-insideview-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **InsideView**。
   
   ![應用程式資源庫](./media/active-directory-saas-insideview-tutorial/IC794129.png "應用程式資源庫")
...
7. 在 [加入新的 SAML]  區段中，執行下列步驟：
   ...
   5. 完成下列步驟：
    * 在 [CRM 使用者識別碼對應] 文字方塊中，輸入 **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress**。
    * 在 [CRM 電子郵件對應] 文字方塊中，輸入 **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress**。
    * 在 [CRM 名字對應] 文字方塊中，輸入 **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname**。
    * 在 [CRM 姓氏對應] 文字方塊中，輸入 **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname**。
   9. 按一下 [儲存] 。
...
2. 在 [InsideView] 應用程式整合頁面上，按一下 [指派使用者]。
