...
本教學課程旨在說明如何整合 GaggleAMP 與 Azure Active Directory (Azure AD)。
...
6. 在搜尋方塊中，輸入 **GaggleAMP**。![建立 Azure AD 測試使用者](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_01.png)

7. 在結果窗格中，選取 [GaggleAMP]，然後按一下 [完成] 加入應用程式。
...
4. **[建立 GaggleAMP 測試使用者](#creating-a-GaggleAMP-test-user)** - 在 GaggleAMP 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表 Britta Simon 的項目連結。
...
2. 在 [要如何讓使用者登入 GaggleAMP] 頁面上，選取 [Azure AD 單一登入]，然後按 [下一步]。
...
3. 在 [設定 App 設定] 對話方塊頁面執行下列步驟：
    ...
    > [AZURE.NOTE]如果您需要應用程式的登入 URL，請連絡您的 [GaggleAMP 銷售小組](mailto:sales@gaggleamp.com)。
...
2. 在應用程式清單中，選取 [GaggleAMP]。![Azure 清單](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_50.png)
