...
### <a name="to-enable-the-application-integration-for-panopto-perform-the-following-steps"></a>若要啟用 Panopto 的應用程式整合，請執行下列步驟：
...
### <a name="to-assign-users-to-panopto-perform-the-following-steps"></a>若要將使用者指派給 Panopto，請執行下列步驟：
