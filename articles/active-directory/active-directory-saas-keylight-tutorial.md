---
title: "教學課程：Azure Active Directory 與 Keylight 整合 | Microsoft Docs"
...
---
# <a name="tutorial-azure-active-directory-integration-with-keylight"></a>教學課程：Azure Active Directory 與 Keylight 整合
...
3. **[建立 Keylight 測試使用者](#creating-a-keylight-test-user)** - 在 Keylight 中建立一個與 Azure AD 中代表 Britta Simon 的項目連結的 Britta Simon 對應項目。
