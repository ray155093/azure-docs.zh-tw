<properties
    pageTitle="Azure Active Directory 登入活動報告 API 參考 | Microsoft Azure"
...
# Azure Active Directory 登入活動報告 API 參考


本主題是 Azure Active Directory 報告 API 相關主題集合的一部分。Azure AD 報告提供的 API 可讓您使用程式碼或相關工具來存取登入活動報告資料。本主題的範疇是為您提供有關**登入活動報告 API** 的參考資訊。
...
> [AZURE.NOTE] 使用 Graph 總管時，您需要針對篩選欄位中的字母使用正確的大小寫。
