...
本教學課程旨在說明如何整合 HR2day by Merces 與 Azure Active Directory (Azure AD)。  
...
建立此連結關聯性的方法，就是將 Azure AD 中**使用者名稱**的值，指派為 HR2day by Merces 中 **Username** 的值。
...
2. 在頂端功能表中，按一下 [快速入門]  to open the  對話方塊。
...
### <a name="creating-a-hr2day-by-merces-test-user"></a>建立 HR2day by Merces 測試使用者
