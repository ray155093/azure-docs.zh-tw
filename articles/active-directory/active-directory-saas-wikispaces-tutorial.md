...
### <a name="to-enable-the-application-integration-for-wikispaces-perform-the-following-steps"></a>若要啟用 Wikispaces 的應用程式整合，請執行下列步驟：
...
5. 將中繼資料檔傳送給 Wikispaces 支援小組。
    ...
    > [!NOTE]
    > 單一登入組態必須由 Wikispaces 支援小組執行。 設定完成後，您將會收到通知。
    > 
    > 
...
### <a name="to-assign-users-to-wikispaces-perform-the-following-steps"></a>若要指派使用者給 Wikispaces，請執行下列步驟：
