---
title: 開始使用 Azure AD NodeJS | Microsoft Docs
...
> [!NOTE]
> 本文不涵蓋如何使用 Azure AD B2C 實作登入、註冊和管理設定檔。而會著重在如何在使用者已通過驗證後呼叫 Web API。如果您還沒進行，您應該開始[如何與 Azure Active Directory 整合文件](active-directory-how-to-integrate.md)以了解 Azure Active Directory 的基本概念。
> 
> 
...
## 7\.將 Passport-Azure-AD 加入您的 Web API
...
## 13\.使用 Moongoose 新增 MongoDB 模型和結構描述資訊
