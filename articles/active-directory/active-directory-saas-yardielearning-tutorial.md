<properties
	pageTitle="教學課程：Azure Active Directory 與 Yardi eLearning 整合 | Microsoft Azure"
...
# 教學課程：Azure Active Directory 與 Yardi eLearning 整合
...
7. 在結果窗格中，選取 [Yardi eLearning]，然後按一下 [完成] 加入應用程式。
...
建立此連結關聯性的方法，就是將 Azure AD 中 [使用者名稱] 的值，指派為 Yardi eLearning 中 [使用者名稱] 的值。

如要設定及測試搭配 Yardi eLearning 的 Azure AD 單一登入，您需要完成下列構成元素：

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[建立 Yardi eLearning 測試使用者](#creating-a-yardi-elearning-test-user)** - 讓 Britta Simon 在 Yardi eLearning 中有一個對應身分連結到他的 Azure AD 代表身分。
...
3. 在 [設定 App 設定] 對話方塊頁面執行下列步驟：
    ...
    a.在 [登入 URL] 文字方塊中，使用下列模式輸入使用者用來登入Yardi eLearning 應用程式的 URL：**“https://<公司名稱>.yardielearning.com/login”**。
...
> [AZURE.NOTE] 如果您需要手動建立使用者，就必須連絡 Yardi eLearning 支援小組。
