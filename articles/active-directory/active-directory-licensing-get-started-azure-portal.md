...
title: "在 Azure 入口網站中開始使用 Azure Active Directory 授權 | Microsoft Docs"
...
# <a name="get-started-with-azure-active-directory-licensing-in-the-azure-portal"></a>在 Azure 入口網站中開始使用 Azure Active Directory 授權
