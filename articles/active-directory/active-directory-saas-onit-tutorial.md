...
### <a name="to-enable-the-application-integration-for-onit-perform-the-following-steps"></a>若要啟用 Onit 的應用程式整合，請執行下列步驟：
...
### <a name="to-assign-users-to-onit-perform-the-following-steps"></a>若要指派使用者給 Onit，請執行下列步驟：
