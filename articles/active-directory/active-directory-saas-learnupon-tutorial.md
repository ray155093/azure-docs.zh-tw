...
1. 在 [設定在 LearnUpon 單一登入]  頁面上，執行下列步驟：
...
5. 在 [一般設定]  區段中，執行下列步驟：
    ...
    b.這是另一個 C# 主控台應用程式。 選取 [2.0] 做為 [版本]。
