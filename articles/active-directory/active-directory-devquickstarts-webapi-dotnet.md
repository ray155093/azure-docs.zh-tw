...
* 完成註冊後，請瀏覽至 [設定] 索引標籤，然後尋找 [應用程式識別碼 URI] 欄位。  為此值輸入租用戶特定識別碼，例如 `https://contoso.onmicrosoft.com/TodoListService`
...
## <a name="3----configure-a-client-application--run-the-service"></a>*3.  設定用戶端應用程式及執行服務*
