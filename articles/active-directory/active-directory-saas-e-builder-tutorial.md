...
## <a name="enable-the-application-integration-for-e-builder"></a>啟用 e-Builder 的應用程式整合
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-e-builder-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **e-Builder**。
   
   ![應用程式資源庫](./media/active-directory-saas-e-builder-tutorial/IC777379.png "應用程式資源庫")
