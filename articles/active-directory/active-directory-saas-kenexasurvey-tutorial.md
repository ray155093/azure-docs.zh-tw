...
3. 在 [設定 App 設定]  對話方塊頁面執行下列步驟：
    ...
    a. 在 [識別碼] 文字方塊中，使用下列模式輸入 URL：`https://surveys.kenexa.com/<company code>`
   
    b. 在 [回覆 URL] 文字方塊中，以下列模式輸入 URL：`https://surveys.kenexa.com/<company code>/tools/sso.asp`
...
### <a name="creating-an-ibm-kenexa-survey-enterprise-test-user"></a>建立 IBM Kenexa Survey Enterprise 測試使用者
