---
title: 透過 Microsoft Passport 不需要密碼就能驗證身分識別 | Microsoft Docs
...
---
# <a name="authenticating-identities-without-passwords-through-microsoft-passport"></a>透過 Microsoft Passport 不需要密碼就能驗證身分識別
...
## <a name="about-microsoft-passport"></a>關於 Microsoft Passport
...
## <a name="why-enterprises-should-adopt-microsoft-passport"></a>為什麼企業應該採用 Microsoft Passport
...
## <a name="how-microsoft-passport-works"></a>Microsoft Passport 的運作方式
...
## <a name="how-the-microsoft-passport-lifecycle-works"></a>Microsoft Passport 週期的運作方式
...
4. IDP 接著會驗證並發出驗證權杖，讓使用者和裝置能夠存取受保護的資源。 IDP 可以撰寫跨平台的應用程式，或者透過 JavaScript/Webcrypto API 使用瀏覽器支援，為其使用者建立和使用 Microsoft Passport 認證。

## <a name="the-deployment-requirements-for-microsoft-passport"></a>Microsoft Passport 的部署需求
