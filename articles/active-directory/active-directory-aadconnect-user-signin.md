...
[設定使用 AD FS 的 SSO](connect/active-directory-aadconnect-get-started-custom.md#configuring-federation-with-ad-fs)
...
您無法與 Azure AD 中的預設 .onmicrosoft.com 網域或 Azure AD 中未驗證的自訂網域建立同盟。 當您執行 Azure AD Connect 精靈時，如果您選取要與未驗證的網域建立同盟，則 Azure AD Connect 會提示您必須建立的記錄，其中要有該網域的 DNS 裝載位置資訊。 如需詳細資訊，請參閱 [這裡](connect/active-directory-aadconnect-get-started-custom.md#verify-the-azure-ad-domain-selected-for-federation)。
