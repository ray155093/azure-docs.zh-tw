...
4. 在搜尋方塊中，輸入 **Fuse**。
    ...
    ![建立 Azure AD 測試使用者](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_001.png)

5. 在結果窗格中，選取 [Fuse]，然後按一下 [新增] 按鈕以新增應用程式。
...
2. 在 [單一登入] 對話方塊上，選取 [SAML 型登入] 做為 [模式]，以啟用單一登入。
    ...
    ![設定單一登入](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_01.png)
...
5. 在 [建立新憑證] 對話方塊中，按一下行事曆圖示並選取 [到期日]。 然後按一下 [儲存] 按鈕。
    ...
    ![設定單一登入](./media/active-directory-saas-fuse-tutorial/tutorial_general_300.png)
...
9. 在 [Fuse 組態] 區段上，按一下 [設定 Fuse] 以開啟 [設定登入] 視窗。

    ![設定單一登入](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_06.png) 

    ![設定單一登入](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_07.png)
...
1. 在 **Azure 管理入口網站**的左方瀏覽窗格中，按一下 [Azure Active Directory] 圖示。
    ...
    ![建立 Azure AD 測試使用者](./media/active-directory-saas-fuse-tutorial/create_aaduser_01.png) 

2. 移至 [使用者和群組]，然後按一下 [所有使用者] 以顯示使用者清單。
    
    ![建立 Azure AD 測試使用者](./media/active-directory-saas-fuse-tutorial/create_aaduser_02.png) 
