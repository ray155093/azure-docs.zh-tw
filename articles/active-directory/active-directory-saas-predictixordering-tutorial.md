...
3. 在 [設定 App 設定]  對話方塊頁面執行下列步驟：
    ...
    a. 在 [登入 URL] 文字方塊中，使用以下模式輸入您使用者用以登入 Predictix Ordering 應用程式的 URL：**https://\<公司名稱定價>.ordering.predictix.com/sso/request\>.ordering.predictix.com/sso/request**。
...
### <a name="creating-an-predictix-ordering-test-user"></a>建立 Predictix Ordering 測試使用者
