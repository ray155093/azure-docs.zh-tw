...
6.  在**搜尋方塊**中，輸入 **Zendesk**。
    ...
    ![應用程式庫](./media/active-directory-saas-zendesk-tutorial/IC773084.png "應用程式庫")
...
本節的目的是要說明如何依據 SAML 通訊協定來使用同盟，讓使用者能夠用自己的 Azure AD 帳戶驗證到 Zendesk。設定 Zendesk 的單一登入需要您從憑證抓取憑證指紋值。如果您不熟悉這個程序，請參閱[如何抓取憑證的指紋值](http://youtu.be/YKQF266SAxI)。
