...
## <a name="enable-the-application-integration-for-citrix-sharefile"></a>啟用 Citrix ShareFile 的應用程式整合
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-citrix-sharefile-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **Citrix ShareFile**。
   
   ![應用程式資源庫](./media/active-directory-saas-citrix-sharefile-tutorial/IC773621.png "應用程式資源庫")
...
3. 輸入您想要佈建之有效 Azure AD 帳戶的**電子郵件**、**名字**和**姓氏**。
   ...
   ![基本資訊](./media/active-directory-saas-citrix-sharefile-tutorial/IC799951.png "的基本資訊")
4. 按一下 [加入使用者] 。
   >[!NOTE]
