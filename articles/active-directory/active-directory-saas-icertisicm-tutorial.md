...
本教學課程旨在說明如何整合 Icertis 合約管理平台與 Azure Active Directory (Azure AD)。

整合 Icertis 合約管理平台與 Azure AD 可以提供下列優點：

* 您可以在 Azure AD 中控制誰有 Icertis 合約管理平台的存取權
* 您可以讓使用者使用他們的 Azure AD 帳戶自動登入 Icertis 合約管理平台單一登入 (SSO)
...
## <a name="add-icertis-contract-management-platform-from-the-gallery"></a>從資源庫新增 Icertis 合約管理平台
若要設定將 Icertis 合約管理平台整合到 Azure AD 中，您需要從資源庫把 Icertis 合約管理平台新增到受管理的 SaaS 應用程式清單。
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
    ...
    ![應用程式][4]
6. 在搜尋方塊中，輸入 [Icertis 合約管理平台] 。
   
    ![建立 Azure AD 測試使用者](./media/active-directory-saas-icertisicm-tutorial/tutorial_icertisicm_01.png)
7. 在結果窗格中，選取 [Icertis 合約管理平台]，然後按一下 [完成] 以新增應用程式。
   
    ![選取資源庫中的應用程式](./media/active-directory-saas-icertisicm-tutorial/tutorial_icertisicm_001.png)

## <a name="configure-and-test-azure-ad-sso"></a>設定並測試 Azure AD SSO
本節的目標在於示範如何以名為 "Britta Simon" 的測試使用者，來設定及測試搭配 Icertis 合約管理平台的 Azure AD SSO。

如要讓 SSO 順利運作，Azure AD 必須要知道與某位 Azure AD 使用者互相對應的 Icertis 合約管理平台使用者。 換句話說，必須要建立某位 Azure AD 使用者與 Icertis 合約管理平台中相關使用者之間的連結關聯性。

建立此連結關聯性的方法，是將 Azure AD 中**使用者名稱**的值，指派為 Icertis 合約管理平台中**使用者名稱**的值。

若要設定及測試與 Icertis 合約管理平台搭配運作的 Azure AD SSO，您需要完成下列建置組塊：

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
3. **[建立 Icertis 合約管理平台測試使用者](#creating-a-icertis-contract-management-platform-test-user)** - 在 Icertis 合約管理平台中建立 Britta Simon 的對應項目，且該項目必須與 Azure AD 中代表 Britta Simon 的項目連結。
4. **[指派 Azure AD 測試使用者](#assigning-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** - 驗證組態是否能運作。

### <a name="configure-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入
在本節中，您會在傳統入口網站中啟用 Azure AD SSO，並在您的 Icertis 合約管理平台中設定 SSO。

**若要設定 Azure AD 單一登入與 Icertis 合約管理平台，請執行下列步驟：**

1. 在傳統入口網站的 **Icertis 合約管理平台**應用程式整合頁面上，按一下 [設定單一登入] 來開啟 [設定單一登入] 對話方塊。
   
    ![設定單一登入][6] 
2. 在 [要如何讓使用者登入 Icertis 合約管理平台] 頁面上，選取 [Azure AD 單一登入]，然後按 [下一步]。
...
3. 在 [設定應用程式設定] 對話方塊頁面上，執行下列步驟，然後按 [下一步]。
  ...
  1. 在 [登入 URL] 文字方塊中，以下列模式輸入 URL：`https://<company name>.icertis.com`
  2. 按 [下一步] 。

   >[!NOTE]
   >請注意這些不是真正的值。 您必須以實際的登入 URL 更新這些值。 若要取得這些值，請連絡 Icertis 合約管理平台。
   >

1. 在 [設定在 Icertis 合約管理平台單一登入] 頁面上，執行下列步驟，然後按 [下一步]：
   
    ![設定單一登入](./media/active-directory-saas-icertisicm-tutorial/tutorial_icertisicm_05.png)
  1. 按一下 [下載中繼資料]，然後將檔案儲存在您的電腦上。
  2. 按 [下一步] 。
2. 若要為您的應用程式設定 SSO，請連絡您的 Icertis 合約管理平台支援小組，並提供下列資訊： 
   *  **下載的中繼資料**檔案 
   *   **實體識別碼** 
   *   **SAML SSO URL** 
   *   **單一登出服務 URL**
...
### <a name="create-a-icertis-contract-management-platform-test-user"></a>建立 Icertis 合約管理平台測試使用者
在本節中，您要在 Icertis 合約管理平台中建立名為 Britta Simon 的使用者。 請與 Icertis 合約管理平台支援小組合作，在 Icertis 合約管理平台中新增使用者。

### <a name="assign-the-azure-ad-test-user"></a>指派 Azure AD 測試使用者
本節的目標，是要授與 Britta Simon 對 Icertis 合約管理平台的存取權，讓她能夠使用 Azure SSO。
