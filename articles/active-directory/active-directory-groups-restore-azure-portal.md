---
title: "在 Azure Active Directory 預覽版中還原已刪除的 Office 365 群組 | Microsoft Docs"
...
當您在 Azure Active Directory (Azure AD) 預覽版中刪除 Office 365 群組時，從刪除日起算，仍會保留已刪除的群組 30 天，但您看不見該群組。 如此便能讓您視需要還原該群組及其內容。 此功能專屬於 Azure AD 中的 Office 365 群組。 無法針對安全性群組和發佈群組使用。
...
您可以使用下列 Cmdlet 來檢視已刪除的群組，以確認您感興趣的一或多個群組尚未被永久清除。 這些 Cmdlet 是 [Azure Active Directory PowerShell V2 預覽版模組](https://www.powershellgallery.com/packages/AzureADPreview) (下載連結) 的一部分。 如需此模組的詳細資訊，請參閱 [Azure Active Directory PowerShell 第 2 版](https://docs.microsoft.com/powershell/azuread/)一文。
...
## <a name="how-to-restore-an-office-365-group"></a>如何還原 Office 365 群組
