...
## <a name="enable-the-application-integration-for-canvas"></a>啟用 Canvas 的應用程式整合
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-canvas-lms-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **Canvas**。
   
   ![應用程式資源庫](./media/active-directory-saas-canvas-lms-tutorial/IC775985.png "應用程式資源庫")
...
設定 Canvas 的 SSO 需要您從憑證擷取指紋值。 如果您不熟悉這個程序，請參閱 [如何擷取憑證的指紋值](http://youtu.be/YKQF266SAxI)
