...
## <a name="enabling-the-application-integration-for-jobscience"></a>啟用 Jobscience 的應用程式整合
本節的目的是要說明如何啟用 Jobscience 的應用程式整合。

### <a name="to-enable-the-application-integration-for-jobscience-perform-the-following-steps"></a>若要啟用 Jobscience 的應用程式整合，請執行下列步驟：
...
12. 在 [SAML 單一登入設定編輯]  對話方塊中，執行下列步驟：
    ...
    9. 按一下 [儲存] 。
13. 在 [系統管理員] 區段的左方導覽窗格中，按一下 [定義域管理] 展開相關的區段，然後按一下 [我的網域] 來開啟 [我的網域] 頁面。 
...
此頁面會顯示您公司的單一登入 URL (例如 *https://companyname.my.salesforce.com?so=companyid*)。
...
### <a name="to-assign-users-to-jobscience-perform-the-following-steps"></a>若要指派使用者給 Jobscience，請執行下列步驟：
