...
3. 在 [設定應用程式 URL]  頁面上，執行下列步驟：
    ...
    a. 在 [Replicon 登入 URL] 文字方塊中，輸入 Replicon 租用戶 URL (例如︰https://na2.replicon.com/company/saml2/sp-sso/post)。

    b.這是另一個 C# 主控台應用程式。 在 [Replicon 回覆 URL] 文字方塊中，輸入您的 Replicon **AssertionConsumerService** URL (例如：https://global.replicon.com/!/saml2/company/sso/post)。  
...
6. 若要設定 SAML 2.0，請執行下列步驟：
   ...
   1. 若要顯示 [EnableSAML Authentication2] 對話方塊，請將下列內容附加至 URL 的公司金鑰之後︰  
