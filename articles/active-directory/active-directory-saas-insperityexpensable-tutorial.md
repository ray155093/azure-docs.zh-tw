...
3. 在 [Insperity ExpensAble 網域及 URL] 區段上，執行下列步驟：
    ...
    > [!NOTE] 
    > 這不是真實的值。 使用實際的登入 URL 來更新此值。 請連絡 [Insperity ExpensAble 用戶端支援小組](http://expensable.com/support/support-overview)以取得此值。 
...
6. 在 [Insperity ExpensAble 組態] 區段中，按一下 [設定 Insperity ExpensAble] 開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 **SAML 實體識別碼和 SAML 單一登入服務 URL**。
