...
若要設定 Moxi Engage 與 Azure AD 的整合作業，您必須從資源庫將 Moxi Engage 新增至受管理的 SaaS 應用程式清單。
...
3. 在 [Moxi Engage 網域與 URL] 區段中，執行下列步驟：
    ...
    > [!NOTE] 
    > 這不是真實的值。 使用實際的「登入 URL」來更新此值。 請連絡 [Moxi Engage 用戶端支援小組](mailto:support@moxiworks.com)以取得此值。 
