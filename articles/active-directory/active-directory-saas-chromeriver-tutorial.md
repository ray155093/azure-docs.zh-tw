...
## <a name="enabling-the-application-integration-for-chromeriver"></a>啟用 Chromeriver 的應用程式整合
本節的目的是要說明如何啟用 Chromeriver 的應用程式整合。

### <a name="to-enable-the-application-integration-for-chromeriver-perform-the-following-steps"></a>若要啟用 Chromeriver 的應用程式整合，請執行下列步驟：
...
5. 將下載的中繼資料檔傳送給 Chromeriver 支援小組。
   ...
   > [!NOTE]
   > Chromeriver 支援小組必須執行實際的 SSO 組態。  
...
### <a name="to-assign-users-to-chromeriver-perform-the-following-steps"></a>若要指派使用者給 Chromeriver，請執行下列步驟：
