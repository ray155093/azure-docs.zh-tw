...
## <a name="enable-the-application-integration-for-chromeriver"></a>啟用 Chromeriver 的應用程式整合
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
      ![從資源庫新增應用程式](./media/active-directory-saas-chromeriver-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **Chromeriver**。
   
   ![應用程式資源庫](./media/active-directory-saas-chromeriver-tutorial/IC802756.png "應用程式資源庫")
...
3. 在 [設定應用程式設定]  頁面上，執行下列步驟：
   ...
   ![設定應用程式設定](./media/active-directory-saas-chromeriver-tutorial/IC802759.png "進行應用程式設定")
...
5. 將下載的中繼資料檔傳送給 Chromeriver 支援小組。
 ...
 >[!NOTE]
 >Chromeriver 支援小組必須執行實際的 SSO 組態。 當您的訂用帳戶啟用 SSO 之後，您會收到通知。
 >
