...
完成本教學課程之後，您指派給 ZScaler Two 的 Azure AD 使用者就能夠單一登入您 ZScaler Two 公司網站 (服務提供者起始登入) 的應用程式，或是使用[存取面板簡介](active-directory-saas-access-panel-introduction.md)進行單一登入。
...
5. 在 [欲執行動作] 對話方塊中，按一下 [從資源庫加入應用程式]。
   ...
   ![從組件庫新增應用程式](./media/active-directory-saas-zscaler-two-tutorial/IC749322.png "從組件庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **ZScaler Two**。
   
   ![應用程式庫](./media/active-directory-saas-zscaler-two-tutorial/IC800200.png "應用程式庫")
...
3. 按一下 [使用者管理]。
   ...
   ![加](./media/active-directory-saas-zscaler-two-tutorial/IC781037.png "加")
4. 在 [使用者] 索引標籤中，按一下 [新增]。
   
   ![加](./media/active-directory-saas-zscaler-two-tutorial/IC781037.png "新增")
