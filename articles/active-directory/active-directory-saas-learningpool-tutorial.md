---
title: 教學課程：Azure Active Directory 與 Learningpool 整合 | Microsoft Docs
...
5. 在 [欲執行動作] 對話方塊中，按一下 [從資源庫加入應用程式]。
   ...
   ![從組件庫新增應用程式](./media/active-directory-saas-learningpool-tutorial/IC749322.png "從組件庫新增應用程式")
