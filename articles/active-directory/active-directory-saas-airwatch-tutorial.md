...
## <a name="enable-the-application-integration-for-airwatch"></a>啟用 AirWatch 的應用程式整合
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-airwatch-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **AirWatch**。
   
   ![應用程式資源庫](./media/active-directory-saas-airwatch-tutorial/IC791914.png "應用程式資源庫")
...
1. 在 Azure 傳統入口網站的 [AirWatch] 應用程式整合頁面上，按一下 [設定單一登入] 來開啟 [設定單一登入] 對話方塊。
