...
3. 在 [設定 App 設定]  對話方塊頁面執行下列步驟：
    ...
    b.這是另一個 C# 主控台應用程式。 在 [識別碼] 文字方塊中，使用以下模式輸入 URL：`https://<company name>.sabacloud.com/Saba/SAML/sso/alias/<company name>``
...
5. 在 [告訴我們這位使用者] 對話方塊頁面上，執行下列步驟： ![建立 Azure AD 測試使用者](./media/active-directory-saas-learning-at-work-tutorial/create_aaduser_05.png) 
...
### <a name="creating-an-learning-at-work-test-user"></a>建立 Learning at Work 測試使用者
