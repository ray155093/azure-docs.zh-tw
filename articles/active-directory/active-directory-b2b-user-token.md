---
title: "了解 Azure Active Directory B2B 共同作業中的使用者權杖 | Microsoft Docs"
...
# <a name="understand-user-tokens-in-azure-active-directory-b2b-collaboration"></a>了解 Azure Active Directory B2B 共同作業中的使用者權杖

若有興趣了解 B2B 共同作業使用者的權杖看起來像什麼樣子，以下是資源租用戶 (對於 tenantid:04dcc6ab-388a-4559-b527-fbec656300ea) 中 AAD 來賓與 MSA 來賓的持有人權杖詳細資料與權杖內容。 您可以使用 [https://jwt.io/](https://jwt.io/) 或 [http://calebb.net](http://calebb.net/)/ 來查看 JWT 權杖內容。

## <a name="azure-ad-guest-user-token"></a>Azure AD 來賓使用者權杖
```
...
## <a name="microsoft-account-guest"></a>Microsoft 帳戶來賓
```
