...
>
>DirSync 和 Azure AD Sync 已被取代。如需詳細資訊，請參閱[升級 Microsoft Azure Active Directory Sync (“DirSync”) 和 Azure Active Directory Sync (“Azure AD Sync”)](https://azure.microsoft.com/documentation/articles/active-directory-aadconnect-dirsync-deprecated/?WT.mc_id=DirSyncDepACOM)。
