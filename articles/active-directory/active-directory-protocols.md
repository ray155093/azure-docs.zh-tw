...
- [OAuth 2.0 授權碼授與](active-directory-protocols-oauth-code.md)︰了解 OAuth2.0「授權程式碼」授權授與，以及它在 Azure AD 中的實作。
- [OAuth 2.0 隱含授權](active-directory-dev-understanding-oauth2-implicit-grant.md)︰深入了解 OAuth 2.0「隱含」授權授與，以及它是否適合您的應用程式。
