...
## <a name="enabling-the-application-integration-for-envoy"></a>啟用 Envoy 的應用程式整合
本節的目的是要說明如何啟用 Envoy 的應用程式整合。

### <a name="to-enable-the-application-integration-for-envoy-perform-the-following-steps"></a>若要啟用 Envoy 的應用程式整合，請執行下列步驟：
