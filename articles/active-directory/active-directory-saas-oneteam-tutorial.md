...
6. 在搜尋方塊中，輸入 **Oneteam**。
    ...
    ![建立 Azure AD 測試使用者](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_001.png)

7. 在結果窗格中，選取 [Oneteam]，然後按一下 [完成] 以加入應用程式。
...
1. 在傳統入口網站的 **Oneteam** 應用程式整合頁面上，按一下 [設定單一登入] 來開啟 [設定單一登入] 對話方塊。

    ![設定單一登入][6]

2. 在 [要如何讓使用者登入 Oneteam] 頁面上，選取 [Azure AD 單一登入]，然後按 [下一步]。
 
    ![設定單一登入](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_02.png)
...
5. 在 [設定在 Oneteam 單一登入] 頁面上，按一下 [下載中繼資料]，然後將檔案儲存在您的電腦中：
    ...
    ![設定單一登入](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_05.png) 

6. 若要設定您應用程式的 SSO，您可以從<a href="https://support.one-team.com/hc/en-us/requests/new">這裡</a>向 Oneteam 支援小組提出支援票證，並提供他們下載的**中繼資料**。
...
1. 在 **Azure 傳統入口網站**中，按一下左方瀏覽窗格的 [Active Directory]。
    ...
    ![建立 Azure AD 測試使用者](./media/active-directory-saas-oneteam-tutorial/create_aaduser_09.png) 
...
7. 在 [取得暫時密碼] 對話方塊頁面上，按一下 [建立]。
    ...
    ![建立 Azure AD 測試使用者](./media/active-directory-saas-oneteam-tutorial/create_aaduser_07.png) 
...
2. 在應用程式清單中，選取 [Oneteam]。
    ...
    ![設定單一登入](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_50.png) 
