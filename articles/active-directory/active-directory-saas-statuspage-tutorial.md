...
7. 在結果窗格中，選取 [StatusPage]，然後按一下 [完成] 加入應用程式。
...
4. **[建立 StatusPage 測試使用者](#creating-a-statuspage-test-user)** - 使 StatusPage 中，Britta Simon 的對應使用者連結到她在 Azure AD 中的代表項目。
5. **[指派 Azure AD 測試使用者](#assigning-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** - 驗證組態是否能運作。

### 設定 Azure AD 單一登入

本節目標是在 Azure 傳統入口網站啟用 Azure AD 單一登入功能，並在您的 StatusPage 應用程式中設定單一登入功能。
...
1. 在 [SSO 設定] 頁面上，執行下列步驟：
    ...
    a.在 Azure 傳統入口網站的 [設定在 StatusPage 單一登入] 對話方塊頁面上，複製 [單一登入服務 URL] 的值，然後貼到 [SSO 目標 URL] 文字方塊中。
...
本節目標是在 StatusPage 中建立名為 Britta Simon 的使用者。StatusPage 支援 Just-in-Time 佈建。您已在[設定 Azure AD 單一登入](#configuring-azure-ad-single-single-sign-on)中啟用。
...
本節目標是授與 Britta Simon 對 StatusPage 的存取權，讓她能夠使用 Azure 單一登入。
