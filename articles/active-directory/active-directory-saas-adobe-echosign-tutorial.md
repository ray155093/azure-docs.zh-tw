...
* 有效的 Azure 訂閱
* 已啟用 Adobe EchoSign 單一登入 (SSO) 的訂用帳戶
...
## <a name="enable-the-application-integration-for-adobe-echosign"></a>啟用 Adobe EchoSign 的應用程式整合
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-adobe-echosign-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **Adobe EchoSign**。
   
   ![應用程式資源庫](./media/active-directory-saas-adobe-echosign-tutorial/IC789514.png "應用程式資源庫")
...
1. 在 Azure 傳統入口網站的 [Adobe EchoSign] 應用程式整合頁面上，按一下 [設定單一登入] 來開啟 [設定單一登入] 對話方塊。
...
**若要指派使用者給 Adobe EchoSign，請執行下列步驟：**
