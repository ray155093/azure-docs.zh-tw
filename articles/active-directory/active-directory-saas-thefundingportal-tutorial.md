...
建立此連結關聯性的方法是將 Azure AD 中**使用者名稱**的值指派為 The Funding Portal 中 **Username** 的值。
...
### <a name="creating-a-the-funding-portal-test-user"></a>建立 The Funding Portal 測試使用者
在本節中，您要在 The Funding Portal 中建立名為 Britta Simon 的使用者。 如果您不知道如何在 The Funding Portal 中新增 Britta Simon，請與 The Funding Portal 支援小組合作，以新增測試使用者並啟用 SSO。 透過 info@regenteducation.com 與他們連絡。
