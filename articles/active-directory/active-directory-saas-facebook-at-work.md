---
title: 教學課程：Azure Active Directory 與 Facebook at Work 整合 | Microsoft Docs
...
---
# <a name="tutorial:-azure-active-directory-integration-with-facebook-at-work"></a>教學課程：Azure Active Directory 與 Facebook at Work 整合
...
## <a name="adding-facebook-at-work-from-the-gallery"></a>從資源庫加入 Facebook at Work
...
7. 在結果窗格中，選取 [Facebook at Work]，然後按一下 [完成] 以新增應用程式。
...
## <a name="automatically-provisioning-users-to-facebook-at-work"></a>自動佈建使用者至 Facebook at Work
...
## <a name="assigning-users-to-facebook-at-work"></a>將使用者指派給 Facebook at Work
