---
title: "在 iOS 上開始使用憑證式驗證 | Microsoft Docs"
...
---
# <a name="get-started-with-certificate-based-authentication-on-ios---public-preview"></a>在 iOS 上開始使用憑證式驗證 - 公開預覽
...
### <a name="testing-eas-client-applications-on-ios"></a>在 iOS 上測試 EAS 用戶端應用程式
