...
本節目標是在 Azure 傳統入口網站中啟用 Azure AD 單一登入功能，以及在您的 Workrite 應用程式中設定單一登入功能。
...
4. 在 [設定在 Workrite 單一登入]  頁面上，執行下列步驟：
    ...
    b. 連絡您的 Workrite 支援小組 [support@workrite.co.uk](mailto:support@workrite.co.uk)，提供他們下載的憑證、**簽發者 URL** (實體識別碼)、**單一登入服務 URL**、**單一登出 URL**，然後要求他們為 Workrite 應用程式設定 SSO。 
...
4. 在 [建立使用者]  對話方塊中，執行下列步驟：
    ...
    b.這是另一個 C# 主控台應用程式。 對 [選擇角色] 選取 [用戶端系統管理員]。 
   
    c. 按一下 [儲存] 。   

### <a name="assigning-the-azure-ad-test-user"></a>指派 Azure AD 測試使用者
本節目標是授與 Britta Simon 對 Workrite 的存取權，讓她能夠使用 Azure 單一登入。
