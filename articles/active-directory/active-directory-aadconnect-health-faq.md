...
當您從伺服器移除代理程式時，系統不會自動從 Azure AD Connect 入口網站移除伺服器。  如果您以手動方式從伺服器移除代理程式，或移除伺服器本身，就需要以手動方式從 Azure AD Connect Health 入口網站中刪除伺服器項目。 如需詳細資訊，請移至[刪除伺服器或服務執行個體](active-directory-aadconnect-health-operations.md#delete-a-server-or-service-instance)
