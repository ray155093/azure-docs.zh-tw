...
2. 在 [設定 App 設定] 對話方塊頁面執行下列步驟：
    ...
    a.在 [登入 URL] 文字方塊中，以下列模式輸入使用者用來登入您 Asset Bank 應用程式的 URL：**“https://<公司名稱>.assetbank-server.com”**。
...
6. 在 [使用者設定檔]對話方塊頁面上，執行下列步驟：
   ...
   e.按 [下一步]。
7. 在 [取得暫時密碼] 對話方塊頁面上，按一下 [建立]。![建立 Azure AD 測試使用者](./media/active-directory-saas-assetbank-tutorial/create_aaduser_07.png)
...
### 指派 Azure AD 測試使用者
本節的目標是要授與 Britta Simon 對 Asset Bank 的存取權，讓她能夠使用 Azure 單一登入。
