...
## <a name="enable-the-application-integration-for-cornerstone-ondemand"></a>啟用 Cornerstone OnDemand 的應用程式整合
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-cornerstone-ondemand-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **cornerstone ondemand**。
   
   ![應用程式資源庫](./media/active-directory-saas-cornerstone-ondemand-tutorial/IC781594.png "應用程式資源庫")
...
5. 將下列項目傳送至 Cornerstone OnDemand 支援小組：  
   ...
   >[!NOTE]
   >單一登入必須由 Cornerstone OnDemand 支援小組設定。 設定完成後，您會收到來自支援小組的通知。
   > 
...
**若要指派使用者給 Cornerstone OnDemand，請執行下列步驟：**
