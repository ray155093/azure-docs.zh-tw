...
* 您可以讓使用者透過其 Azure AD 帳戶自動登入 Predictix Assortment Planning 單一登入 (SSO)
...
* Azure AD 訂用帳戶
* 啟用 Predictix Assortment Planning SSO 功能的訂用帳戶
...
在本節中，您會以名為 "Britta Simon" 的測試使用者身分，使用 Predictix Assortment Planning 設定及測試 Microsoft Azure AD SSO。

若要讓 SSO 運作，Azure AD 必須知道 Predictix Assortment Planning 與 Azure AD 中互相對應的使用者。 換句話說，必須要建立某位 Azure AD 使用者與 Predictix Assortment Planning 中相關使用者之間的連結關聯性。
...
**若要使用 Predictix Assortment Planning 設定 Microsoft Azure AD SSO，請執行下列步驟：**
...
3. 在 [設定 App 設定]  對話方塊頁面執行下列步驟：
  ...
  1. 在 [登入 URL] 文字方塊中，使用以下模式輸入您使用者用以登入 Predictix Assortment Planning 應用程式的 URL：**https://\<company name-pricing\>.ap.predictix.com/sso/request**。
  2. 按一下 [下一步] 
...
5. 若要為您的應用程式設定 SSO，請連絡 Predictix Assortment Planning 支援小組，並提供下列資訊：
  ...
  * **SAML SSO URL**
  * **單一登出服務 URL**
6. 在傳統入口網站中，選取 SSO 設定確認項目，然後按 [下一步]。
...
5. 在 [告訴我們這位使用者]  對話方塊頁面上，執行下列步驟：
    ...
    ![建立 Azure AD 測試使用者](./media/active-directory-saas-predictix-assortment-planning-tutorial/create_aaduser_05.png) 
  1. 針對 [使用者類型]，選取 [您組織中的新使用者]。
  2. 在 [使用者名稱] 文字方塊中，輸入 **BrittaSimon**。
  3. 按 [下一步] 。
6. 在 [使用者設定檔]  對話方塊頁面上，執行下列步驟：

   ![建立 Azure AD 測試使用者](./media/active-directory-saas-predictix-assortment-planning-tutorial/create_aaduser_06.png) 
...
### <a name="create-an-predictix-assortment-planning-test-user"></a>建立 Predictix Assortment Planning 測試使用者
