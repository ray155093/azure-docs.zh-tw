...
## <a name="enabling-the-application-integration-for-greenhouse"></a>啟用 Greenhouse 的應用程式整合
本節的目的是要說明如何啟用 Greenhouse 的應用程式整合。

### <a name="to-enable-the-application-integration-for-greenhouse-perform-the-following-steps"></a>若要啟用 Greenhouse 的應用程式整合，請執行下列步驟：
...
### <a name="to-assign-users-to-greenhouse-perform-the-following-steps"></a>若要將使用者指派給 Greenhouse，請執行下列步驟：
