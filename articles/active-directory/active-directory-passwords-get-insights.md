...
---
# <a name="how-to-get-operational-insights-with-password-management-reports"></a>如何使用密碼管理報告取得 Operational Insights
> [!IMPORTANT]
...
* [**檢視您組織中的密碼重設登錄活動**](#view-password-reset-registration-activity)
* [**檢視您組織中的密碼重設活動**](#view-password-reset-activity)
...
1. 按一下 **Azure 管理入口網站**中的 [Active Directory][](https://manage.windowsazure.com) 擴充功能。
2. 從入口網站顯示的清單中選取您的目錄。
3. 按一下 [報告]  索引標籤。
4. 查看 [活動記錄檔]  區段。
...
## <a name="how-to-access-password-management-reports-from-an-api"></a>如何從 API 存取密碼管理報告
...
## <a name="view-password-reset-registration-activity"></a>檢視密碼重設註冊活動
...
## <a name="view-password-reset-activity"></a>檢視密碼重設活動
