...
1. 在 [設定在 Skydesk Email 單一登入]  頁面上，執行下列步驟：
    ...
    b. 按 [下一步] 。
2. 若要在 **Skydesk Email**中啟用 SSO，請執行下列步驟：
...
3. 在 [SAML 驗證]  對話方塊頁面上執行下列步驟：
   ...
   > 
    ...
    b.這是另一個 C# 主控台應用程式。 在 Azure AD 傳統入口網站中，複製**單一登出服務 URL** 值，然後將其貼到 [登出 URL] 文字方塊中。
