...
* 有效的 Azure 訂閱
* 已啟用 Brightspace by Desire2Learn 單一登入 (SSO) 的訂用帳戶
...
## <a name="enable-the-application-integration-for-brightspace-by-desire2learn"></a>啟用 Brightspace by Desire2Learn 的應用程式整合
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-brightspace-desire2learn-tutorial/IC749322.png "從資源庫新增應用程式")
