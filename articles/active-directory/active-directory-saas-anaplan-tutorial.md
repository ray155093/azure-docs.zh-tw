...
# 教學課程：Azure Active Directory 與 Anaplan 整合
...
7. 在結果窗格中，選取 [Anaplan]，然後按一下 [完成] 以加入應用程式。
...
建立此連結關聯性的方法，就是將 Azure AD 中 [使用者名稱] 的值，指派為 Anaplan 中 [使用者名稱] 的值。
...
在本節中，您要在 Anaplan 中建立名為 Britta Simon 的使用者。請透過 <mailto:support@anaplan.com> 來與 Anaplan 支援小組合作，在 Anaplan 平台中加入使用者。
