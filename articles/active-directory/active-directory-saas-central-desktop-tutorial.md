...
## <a name="enable-the-application-integration-for-central-desktop"></a>啟用 Central Desktop 的應用程式整合
...
3. 在 [設定應用程式 URL] 頁面上，執行下列步驟，然後按 [下一步]： 
   ...
   1. 在 [Central Desktop 登入 URL] 文字方塊中，輸入您的 Central Desktop 租用戶 URL (例如：*http://contoso.centraldesktop.com*)。
   2. 在 [Central Desktop 回覆 URL] 文字方塊中，輸入您的 Central Desktop AssertionConsumerService URL (例如：https://contoso.centraldesktop.com/saml2-assertion.php)。
...
**若要指派使用者給 Central Desktop，請執行下列步驟：**
