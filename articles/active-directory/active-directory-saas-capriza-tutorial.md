...
---
# <a name="tutorial-azure-active-directory-integration-with-capriza"></a>教學課程：Azure Active Directory 與 Capriza 整合
本教學課程旨在說明如何整合 Capriza 與 Azure Active Directory (Azure AD)。  
Capriza 與 Azure AD 整合提供下列優點：
...
## <a name="adding-capriza-from-the-gallery"></a>從資源庫新增 Capriza
...
若要讓單一登入運作，Azure AD 必須知道 Capriza 與 Azure AD 中互相對應的使用者。 換句話說，必須建立 Azure AD 使用者和 Capriza 中相關使用者之間的連結關聯性。  
建立此連結關聯性的方法，就是將 Azure AD 中 [使用者名稱] 的值，指派為 Capriza 中 [Username] 的值。
...
當您在存取面板中按一下 [Capriza] 圖格時，應該會自動登入您的 Capriza 應用程式。
