...
完成本教學課程之後，您指派給 Pagerduty 的 Azure AD 使用者就能夠單一登入 (SSO) 您 Pagerduty 公司網站 (服務提供者起始登入) 的應用程式，或是使用 [存取面板簡介](active-directory-saas-access-panel-introduction.md)。
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-pagerduty-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中輸入 **Pagerduty**。
   
   ![應用程式資源庫](./media/active-directory-saas-pagerduty-tutorial/IC778529.png "應用程式資源庫")
