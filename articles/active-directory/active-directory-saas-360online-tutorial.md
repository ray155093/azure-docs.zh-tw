<properties
    pageTitle="教學課程：Azure Active Directory 與 360° Online 整合 | Microsoft Azure"
...
# <a name="tutorial:-azure-active-directory-integration-with-360°-online"></a>教學課程：Azure Active Directory 與 360° Online 整合


本教學課程旨在說明如何整合 360° Online 與 Azure Active Directory (Azure AD)。
...
若要設定將 360° Online 整合到 Azure AD 中，您需要從資源庫將 360° Online 加入受管理的 SaaS 應用程式清單中。
...
4. **[建立 360° Online 測試使用者](#creating-a-360-online-test-user)** - 在 360° Online 中建立一個與 Azure AD 中代表 Britta Simon 的項目連結的 Britta Simon 對應項目。
...
本節目標是在 Azure 傳統入口網站中啟用 Azure AD 單一登入功能，以及在您的 360° Online 應用程式中設定單一登入功能。

**若要使用 360° Online 設定 Azure AD 單一登入，請執行下列步驟：**


1. 在 Azure 傳統入口網站的 **360° Online** 應用程式整合頁面上，按一下 [設定單一登入] 來開啟 [設定單一登入] 對話方塊。

    ![設定單一登入][13] 

2. 在 [要如何讓使用者登入 360° Online] 頁面上，選取 [Azure AD 單一登入]，然後按 [下一步]。

    ![設定單一登入](./media/active-directory-saas-360online-tutorial/tutorial_360online_03.png) 

3. 在 [設定應用程式 URL] 對話方塊頁面上，執行下列步驟，然後按 [下一步]。
...
本節目標是在 360° Online 中建立名為 Britta Simon 的使用者。 

若要取得在 360° Online 中建立的使用者，您需要透過 [360online@software-innovation。com](mailto:360online@software-innovation。com)。


### <a name="assigning-the-azure-ad-test-user"></a>指派 Azure AD 測試使用者

本節目標是授與 Britta Simon 對 360° Online 的存取權，讓她能夠使用 Azure 單一登入。
