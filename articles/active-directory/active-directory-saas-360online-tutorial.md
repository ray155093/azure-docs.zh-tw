...
本節的目標是要說明如何以名為 "Britta Simon" 的測試使用者為基礎，設定及測試與 360 Online 搭配運作的 Azure AD 單一登入。
...
本節的目標是要在 360 Online 中建立名為 Britta Simon 的使用者。 

若要取得在 360 Online 中建立的使用者，您需要透過 [360online@software-innovation.com](mailto:360online@software-innovation.com) 連絡 360 Online 支援團隊。
