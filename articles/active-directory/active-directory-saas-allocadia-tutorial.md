...
2. 在 [要如何讓使用者登入 Allocadia] 頁面上，選取 [Azure AD 單一登入]，然後按 [下一步]。
...
4. 在 [設定在 Allocadia 單一登入]  頁面上，執行下列步驟：
...
5. 若要為您的應用程式設定 SSO，請連絡 [Allocadia 支援](mailTo:support@allocadia.com) 小組，他們將會協助您設定 SSO。 請注意，您必須傳送電子郵件並附加已下載的中繼資料檔案，才能在 Allocadia 端設定 SSO。
