...
## <a name="enabling-the-application-integration-for-bime"></a>啟用 Bime 的應用程式整合
本節的目的是要說明如何啟用 Bime 的應用程式整合。

### <a name="to-enable-the-application-integration-for-bime-perform-the-following-steps"></a>若要啟用 Bime 的應用程式整合，請執行下列步驟：
...
### <a name="to-assign-users-to-bime-perform-the-following-steps"></a>若要指派使用者給 Bime，請執行下列步驟：
