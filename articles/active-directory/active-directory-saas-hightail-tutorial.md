...
1. 如果您想要在 [設定應用程式設定] 對話方塊頁面上以 **SP 起始模式**設定應用程式，請按一下 [顯示進階設定 (選擇性)]，然後輸入**登入 URL** 並按 [下一步]。
...
> [!NOTE]
> 如果您需要手動建立使用者，您必須透過 [support@hightail.com](mailto:support@hightail.com) 連絡 Hightail 支援小組。
> 
> 
