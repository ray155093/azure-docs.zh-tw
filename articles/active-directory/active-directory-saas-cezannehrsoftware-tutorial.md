...
3. 在 [設定應用程式設定] 對話方塊頁面上，執行下列步驟，然後按 [下一步]：
    ...
    b. 在 [回覆 URL] 文字方塊中，以下列模式輸入 URL：`https://w3.cezanneondemand.com:443/CezanneOnDemand/-/<tenant id>/Saml/samlp`。
   
    c. 依序按一下 [ **下一步**
   
   > [!NOTE]
   > 請注意，您必須使用實際的「登入 URL」及「回覆 URL」來更新這些值。 若要取得這些值，請透過 <mailto:info@cezannehr.com> 聯絡 Cezanne HR Software 支援小組。
   > 
   > 
...
2. 在左側的導覽窗格上，按一下 [系統設定] 。 移至 [管理使用者] 。 然後瀏覽至 [新增使用者] 。
   ...
   ![新使用者](./media/active-directory-saas-cezannehrsoftware-tutorial/tutorial_cezannehrsoftware_005.png "New User")
3. 在 [人員詳細資料]  區段中，執行下列步驟︰
   
   ![新使用者](./media/active-directory-saas-cezannehrsoftware-tutorial/tutorial_cezannehrsoftware_006.png "New User")
...
4. 在 [帳戶資訊]  區段中，執行下列步驟︰
   ...
   ![新使用者](./media/active-directory-saas-cezannehrsoftware-tutorial/tutorial_cezannehrsoftware_007.png "New User")
