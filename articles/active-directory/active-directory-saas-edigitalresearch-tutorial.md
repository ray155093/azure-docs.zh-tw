<properties
	pageTitle="教學課程：Azure Active Directory 與 eDigitalResearch 整合 | Microsoft Azure"
...
# 教學課程：Azure Active Directory 與 eDigitalResearch 整合
...
7. 在結果窗格中，選取 [eDigitalResearch]，然後按一下 [完成] 加入應用程式。
