...
若要設定將 ScaleX Enterprise 整合到 Azure AD 中，您需要從資源庫將 ScaleX Enterprise 新增到受管理的 SaaS 應用程式清單。
...
11. 完成表單，如下所示：
    ...
    b.這是另一個 C# 主控台應用程式。 **服務提供者 SAML**︰將 ***urn:oasis:names:tc:SAML:2.0:nameid-format:persistent*** 值貼上
