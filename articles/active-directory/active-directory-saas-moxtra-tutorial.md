...
## 從資源庫加入 Moxtra
若要設定 Moxtra 與 Azure AD 整合，您需要從資源庫將 Moxtra 加入受管理的 SaaS 應用程式清單中。
...
<br><br> ![應用程式][4]<br>
6. 在搜尋方塊中，輸入 **Moxtra**。
<br><br> ![建立 Azure AD 測試使用者](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_01.png)<br>
7. 在結果窗格中，選取 [Moxtra]，然後按一下 [完成] 以加入應用程式。
<br><br> ![建立 Azure AD 測試使用者](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_02.png)<br>
...
<br><br> ![設定單一登入](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_09.png) <br>



**若要使用 Moxtra 設定 Azure AD 單一登入，請執行下列步驟：**

1. 在 Azure 傳統入口網站中的 [Moxtra] 應用程式整合頁面上，按一下 [設定單一登入] 來開啟 [設定單一登入] 對話方塊。
<br><br> ![設定單一登入][6] <br>
...
<br><br>![設定單一登入](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_05.png) <br>
...
<br><br>![設定單一登入](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_06.png) <br>


1. 在 [SAML] 頁面上，執行下列步驟：
<br><br>![設定單一登入](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_08.png) <br>
...
1. 若要將自訂屬性對應加入您的 SAML 權杖屬性設定中，請按一下頂端功能表中的 [屬性] 來開啟 [SAML 權杖屬性] 對話方塊。
<br><br>![設定單一登入](./media/active-directory-saas-moxtra-tutorial/tutorial_general_80.png) <br>



1. 針對下表中的每個資料列，執行下列步驟：
...
1. 按一下 [套用變更]。
<br><br>![設定單一登入](./media/active-directory-saas-moxtra-tutorial/tutorial_general_84.png) <br>
...
在 [使用者] 清單中，選取 [Britta Simon]。<br><br>![建立 Azure AD 使用者][20]<br>

**若要在 Azure AD 中建立測試使用者，請執行下列步驟：**

1. 在 **Azure 傳統入口網站**中，按一下左方瀏覽窗格中的 [Active Directory]。
<br><br>![建立 Azure AD 測試使用者](./media/active-directory-saas-moxtra-tutorial/create_aaduser_09.png) <br> 

2. 從 [目錄] 清單中，選取要啟用目錄整合的目錄。

3. 若要顯示使用者清單，請按一下功能表頂端的 [使用者]。
<br><br> ![建立 Azure AD 測試使用者](./media/active-directory-saas-moxtra-tutorial/create_aaduser_03.png) <br>
 
4. 若要開啟 [新增使用者] 對話方塊，請按一下底部工具列上的 [新增使用者]。
<br><br> ![建立 Azure AD 測試使用者](./media/active-directory-saas-moxtra-tutorial/create_aaduser_04.png) <br>

5. 在 [告訴我們這位使用者] 對話方塊頁面上，執行以下步驟：
<br><br> ![建立 Azure AD 測試使用者](./media/active-directory-saas-moxtra-tutorial/create_aaduser_05.png) <br>
...
<br><br>![建立 Azure AD 測試使用者](./media/active-directory-saas-moxtra-tutorial/create_aaduser_06.png) <br>
...
<br><br> ![建立 Azure AD 測試使用者](./media/active-directory-saas-moxtra-tutorial/create_aaduser_07.png) <br>
 
8. 在 [取得暫時密碼] 對話方塊頁面上，執行下列步驟：
<br><br>![建立 Azure AD 測試使用者](./media/active-directory-saas-moxtra-tutorial/create_aaduser_08.png) <br>
...
1. 在左邊工具列中，按一下 [管理主控台] > [使用者管理]，然後按一下 [加入使用者]。
<br><br>![設定單一登入](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_10.png) <br>
...
本節目標是授與 Britta Simon 對 Moxtra 的存取權，讓她能夠使用 Azure 單一登入。
<br><br>![指派使用者][200] <br>

**若要將 Britta Simon 指派到 Moxtra，請執行下列步驟：**

1. 在 Azure 傳統入口網站中，若要開啟應用程式檢視，請在目錄檢視中，按一下頂端功能表中的 [應用程式]。
<br><br>![指派使用者][201] <br>

2. 在應用程式清單中，選取 [Moxtra]。
<br><br>![設定單一登入](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_50.png) <br>
...
本節目標是使用存取面板測試您的 Azure AD 單一登入設定。<br> 
