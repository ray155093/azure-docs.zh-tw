...
### <a name="to-enable-the-application-integration-for-citrix-gotomeeting-perform-the-following-steps"></a>若要啟用 Citrix GoToMeeting 的應用程式整合，請執行下列步驟：
...
### <a name="to-assign-users-to-citrix-gotomeeting-perform-the-following-steps"></a>若要指派使用者給 Citrix GoToMeeting，請執行下列步驟：
