...
* 您可以讓使用者使用他們的 Azure AD 帳戶自動登入 Samanage 單一登入 (SSO)
...
3. 若要開啟應用程式檢視，請在目錄檢視中，按一下頂端功能表中的 [應用程式]  。
   ...
   ![應用程式](./media/active-directory-saas-samanage-tutorial/tutorial_general_02.png "應用程式")
4. 按一下頁面底部的 [新增]  。
   
   ![新增應用程式](./media/active-directory-saas-samanage-tutorial/tutorial_general_03.png "新增應用程式")
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   
   ![從資源庫新增應用程式](./media/active-directory-saas-samanage-tutorial/tutorial_general_04.png "從資源庫新增應用程式")
6. 在 [搜尋方塊]中，輸入 **Samanage**。
   
   ![應用程式資源庫](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_01.png "應用程式資源庫")
...
本節目標是說明如何以名為 "Britta Simon" 的測試使用者為基礎，設定及測試透過 Samanage 使用 Azure AD (SSO)。

若要讓 SSO 運作，Azure AD 必須知道 Samanage 與 Azure AD 中互相對應的使用者。 換句話說，必須在 Azure AD 使用者和 Samanage 中的相關使用者之間建立連結關聯性。

建立此連結關聯性的方法，就是將 Azure AD 中 [使用者名稱] 的值，指派為 Samanage 中 **Username** 的值。

若要設定及測試與 Samanage 搭配運作的 Azure AD SSO，您需要完成下列構成要素：
...
在本節中，您會在傳統入口網站中啟用 Azure AD 單一登入，然後在您的 Samanage 應用程式中設定 SSO。

**若要設定透過 Samanage 使用 Azure AD SSO 功能，請執行下列步驟：**

1. 在 Azure 傳統入口網站的 [Samanage] 應用程式整合頁面上，按一下 [設定單一登入] 來開啟 [設定單一登入] 對話方塊。
   
   ![設定單一登入](./media/active-directory-saas-samanage-tutorial/tutorial_general_05.png "設定單一登入")
2. 在 [要如何讓使用者登入 Samanage] 頁面上，選取 [Microsoft Azure AD 單一登入]，然後按 [下一步]。
   
   ![Microsoft Azure AD 單一登入](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_03.png "Microsoft Azure AD 單一登入")
3. 在 [設定 App 設定] 對話方塊頁面執行下列步驟：
   
   ![設定應用程式 URL](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_04.png "設定應用程式 URL") 
 1. 在 [登入 URL] 文字方塊中，以下列模式輸入 URL：`https://<Company Name>.samanage.com/saml_login/<Company Name>`。 
 2. 按一下 [下一步]。
...
4. 在 [設定在 Samanage 單一登入] 頁面上，按一下 [下載憑證]，然後將憑證檔案儲存在您的電腦上。
   ...
   ![設定單一登入](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_05.png "設定單一登入")
...
8. 瀏覽至 [使用 SAML 登入]  區段，執行下列步驟︰
 ...
 2. 在 [識別提供者 URL] 文字方塊中，放入得自 Azure AD 應用程式組態精靈的 [識別提供者識別碼] 值。    
 3. 確認 [登入 URL] 符合步驟 3 的 [登入 URL]。
 4. 在 [登出 URL] 文字方塊中，放入得自 Azure AD 應用程式組態精靈的 [遠端登出 URL] 值。
 5. 在 [SAML 簽發者] 文字方塊中，輸入識別提供者中所設定的應用程式識別碼 URI。
 6. 在記事本中開啟您的 base-64 編碼的憑證，將其內容複製到您的剪貼簿，然後貼到 [在下面貼上識別提供者 x.509 憑證] 文字方塊中。
 7. 按一下 [若 Samanage 中不存在使用者則加以建立]。
 8. 按一下 [更新] 。
9. 在傳統入口網站中，選取單一登入設定確認項目，然後按 [下一步] 。
   
   ![設定單一登入](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_06.png "設定單一登入")
10. 在 [單一登入確認] 頁面上，按一下 [完成]。
    
    ![設定單一登入](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_07.png "設定單一登入")
...
### <a name="create-a-samanage-test-user"></a>建立 Samanage 測試使用者
...
5. 輸入您想要佈建之 Azure AD 帳戶的 [名稱] 與 [電子郵件地址]，然後按一下 [建立使用者]。
   ...
   >[!NOTE]
   >AAD 帳戶的持有者會收到一封電子郵件，並依照連結在啟用其帳戶前進行確認。 您可以使用任何其他的 Samanage 使用者帳戶建立工具或 Samanage 提供的 API 來佈建 AAD 使用者帳戶。
   >  

### <a name="assign-the-azure-ad-test-user"></a>指派 Azure AD 測試使用者
本節的目標是授與 Britta Simon 對 Samanage 的存取權，使她能夠使用 Azure SSO。

![指派使用者](./media/active-directory-saas-samanage-tutorial/assign_aaduser_00.png "指派使用者")

**若要將 Britta Simon 指派給 Samanage，請執行下列步驟：**

1. 在傳統入口網站中，若要開啟應用程式檢視，請在目錄檢視中，按一下頂端功能表中的 [應用程式]  。
   
    ![指派使用者](./media/active-directory-saas-samanage-tutorial/assign_aaduser_01.png "指派使用者")
2. 在應用程式清單中，選取 [Samanage] 。
   
    ![設定單一登入](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_08.png)
3. 在頂端的功能表中，按一下 [使用者] 。
   
    ![指派使用者](./media/active-directory-saas-samanage-tutorial/assign_aaduser_02.png "指派使用者")
4. 在 [使用者] 清單中，選取 [Britta Simon] 。
5. 在底部的工具列中，按一下 [指派] 。
   
    ![指派使用者](./media/active-directory-saas-samanage-tutorial/assign_aaduser_03.png "指派使用者")
