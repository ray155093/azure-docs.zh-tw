...
![何謂 Azure AD Connect](./media/active-directory-aadconnect-ports/required2.png)
...
## <a name="table-6---pass-through-authentication"></a>表 6 - 傳遞驗證
此表說明連接器與 Azure AD 之間通訊所需的連接埠和通訊協定。
