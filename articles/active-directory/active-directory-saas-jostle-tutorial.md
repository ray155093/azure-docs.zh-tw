...
1. 在 [設定在 Jostle 單一登入] 頁面上，按一下 [下載中繼資料]，然後將檔案儲存在您的電腦中。
   
    ![設定單一登入](./media/active-directory-saas-jostle-tutorial/tutorial_jostle_08.png)
2. 若要為您的應用程式設定 SSO，請連絡 Jostle 客戶經理或 Jostle 支援。他們會以適當管道提供協助來讓您設定 SSO。請注意，您必須傳送電子郵件並附加已下載的中繼資料檔案到 <mailto:support@jostle.me>。
