...
## <a name="enable-the-application-integration-for-aha"></a>啟用 Aha! 的應用程式整合
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-aha-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **Aha!**。
   
   ![應用程式資源庫](./media/active-directory-saas-aha-tutorial/IC798945.png "應用程式資源庫")
...
1. 在 Azure 傳統入口網站的 [Aha!] **Aha!** 應用程式整合頁面上，按一下 [設定單一登入] 來開啟 [設定單一登入] 對話方塊。
