...
* 有效的 Azure 訂閱
* 已啟用 AppDynamics 單一登入 (SSO) 的訂用帳戶
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-appdynamics-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **AppDynamics**。
   
   ![應用程式資源庫](./media/active-directory-saas-appdynamics-tutorial/IC790210.png "應用程式資源庫")
