...
3. 在 [設定應用程式設定]  對話方塊頁面上，執行下列步驟：
    ...
    a. 在 [登入 URL] 文字方塊中，使用以下模式輸入使用者登入您的應用程式時所使用的 URL：`https://<server-name>.soonr.com/singlesignon/saml/SSO`。

    b. 按一下頁面底部的 [新增] 來單一登入應用程式。

1. 在 [設定在 Soonr Workplace 單一登入]  頁面上，執行下列步驟：
    ...
    D. **單一登出服務 URL**
2. 若要設定在 Soonr Workplace 單一登入，請在<a href="https://na01.safelinks.protection.outlook.com/?url=http%3A%2F%2Fsoonr.com%2FAWPHelp%2FContent%2F0_HOME%2FSupport_for_End_Clients.htm&data=01%7C01%7Cv-saikra%40microsoft.com%7Ccbb4367ab09b4dacaac408d3eebe3f42%7C72f988bf86f141af91ab2d7cd011db47%7C1&sdata=FB92qtE6m%2Fd8yox7AnL2f1h%2FGXwSkma9x9H8Pz0955M%3D&reserved=0/">這裡</a>連絡 Sooner 小組。
...
### <a name="creating-a-soonr-workplace-test-user"></a>建立 Soonr Workplace 測試使用者
 本節的目標是在 Soonr Workplace 中建立名為 Britta Simon 的使用者。 請與 Sooner 支援小組合作，在平台中建立使用者。 您可以從<a href="https://na01.safelinks.protection.outlook.com/?url=http%3A%2F%2Fsoonr.com%2FAWPHelp%2FContent%2F0_HOME%2FSupport_for_End_Clients.htm&data=01%7C01%7Cv-saikra%40microsoft.com%7Ccbb4367ab09b4dacaac408d3eebe3f42%7C72f988bf86f141af91ab2d7cd011db47%7C1&sdata=FB92qtE6m%2Fd8yox7AnL2f1h%2FGXwSkma9x9H8Pz0955M%3D&reserved=0/">這裡</a>向 Sooner 提出支援票證。
