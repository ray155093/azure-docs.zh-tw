...
### <a name="to-enable-the-application-integration-for-lucidchart-perform-the-following-steps"></a>若要啟用 Lucidchart 的應用程式整合，請執行下列步驟：
...
### <a name="to-assign-users-to-lucidchart-perform-the-following-steps"></a>若要指派使用者給 Lucidchart，請執行下列步驟：
