...
# 教學課程：將 Azure Active Directory 與 Novatus 整合
...
7. 在結果窗格中，選取 [Novatus]，然後按一下 [完成] 加入應用程式。
...
4. **[建立 Novatus 測試使用者](#creating-a-Novatus-test-user)** - 讓 Britta Simon 在 Novatus 中有一對應身分連結到她的 Azure AD 代表身分。
...
> [AZURE.NOTE] 如果您需要手動建立使用者，您需要連絡 Novatus 支援小組。
