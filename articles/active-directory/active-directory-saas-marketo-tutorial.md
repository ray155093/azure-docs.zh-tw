<properties
	pageTitle="教學課程：Azure Active Directory 與 Marketo 整合 | Microsoft Azure"
...
# 教學課程：Azure Active Directory 與 Marketo 整合
...
6.	若要設定應用程式中的 SSO，請遵循下列步驟︰
	...
	> [AZURE.NOTE] 如果您的使用者識別碼不是 UPN 值，則至 [屬性] 索引標籤中變更其值。
