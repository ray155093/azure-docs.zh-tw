...
完成本教學課程之後，您已指派至 Igloo Software 的 Azure AD 使用者將能夠在 Igloo Software 公司網站 (服務提供者起始登入) 透過單一登入來存取應用程式，或使用[存取面板簡介](active-directory-saas-access-panel-introduction.md)來存取。
...
## <a name="enable-the-application-integration-for-igloo-software"></a>啟用 Igloo Software 的應用程式整合
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-igloo-software-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中，輸入 **Igloo Software**。
   
   ![應用程式資源庫](./media/active-directory-saas-igloo-software-tutorial/IC783962.png "應用程式資源庫")
7. 在結果窗格中，選取 [Igloo Software]，然後按一下 [完成] 以新增應用程式。
   
   ![Igloo](./media/active-directory-saas-igloo-software-tutorial/IC783963.png "Igloo")
   
## <a name="configure-sso"></a>設定 SSO

本節的目的是要說明如何依據 SAML 通訊協定來使用同盟，讓使用者能夠用自己的 Azure AD 帳戶在 Igloo Software 中進行驗證。  

在此程序中，您需要上傳 Base-64 編碼憑證到您的 Central Desktop 租用戶。 如果您不熟悉此程序，請參閱 [如何將二進位憑證轉換成文字檔](http://youtu.be/PlgrzUZ-Y1o)。
...
3. 在 [設定應用程式 URL] 頁面的 [Igloo Software 登入 URL] 文字方塊中，使用下列模式輸入您的 URL："*https://company.igloocommunities.com/?signin*"，然後按 [下一步]。
