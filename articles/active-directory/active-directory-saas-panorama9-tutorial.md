...
## <a name="enabling-the-application-integration-for-panorama9"></a>啟用 Panorama9 的應用程式整合
本節的目的是要說明如何啟用 Panorama9 的應用程式整合。

### <a name="to-enable-the-application-integration-for-panorama9-perform-the-following-steps"></a>若要啟用 Panorama9 的應用程式整合，請執行下列步驟：
...
### <a name="to-assign-users-to-panorama9-perform-the-following-steps"></a>若要將使用者指派給 Panorama9，請執行下列步驟：
