...
## <a name="enable-the-application-integration-for-panorama9"></a>啟用 Panorama9 的應用程式整合
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-panorama9-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中輸入 **Panorama9**。
   
   ![應用程式資源庫](./media/active-directory-saas-panorama9-tutorial/IC790017.png "應用程式資源庫")
...
設定 Panorama9 的 SSO 需要您從憑證擷取指紋值。  
...
>[!NOTE]
>您可以使用任何其他的 Panorama9 使用者帳戶建立工具或 Panorama9 提供的 API，佈建 AAD 使用者帳戶。
>
>
