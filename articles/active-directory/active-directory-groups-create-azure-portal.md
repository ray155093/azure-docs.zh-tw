<properties
	pageTitle="在 Azure Active Directory 預覽版中建立新群組 | Microsoft Azure"
...
# 在 Azure Active Directory 預覽版中建立新群組
...
5. 在 [成員] 刀鋒視窗上，選取一或多個要新增到群組中的使用者或裝置，然後選取刀鋒視窗底部的 [選取] 按鈕來將它們新增到群組中。[使用者] 方塊會根據將您的輸入內容與使用者或裝置名稱的任何部分進行比對來篩選顯示。該方塊中不接受任何萬用字元。

6. 完成將成員新增到群組中時，在 [群組] 刀鋒視窗上選取 [建立]。
