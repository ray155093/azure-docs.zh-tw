---
title: 教學課程：Azure Active Directory 與 Amazon Web 服務 (AWS) 整合 | Microsoft Docs
...
3. **[建立 Amazon Web Service (AWS) 測試使用者](#creating-a-halogen-software-test-user)** - 使 Amazon Web Service (AWS) 中對應的 Britta Simon 連結到她在 Azure AD 中的代表項目。
