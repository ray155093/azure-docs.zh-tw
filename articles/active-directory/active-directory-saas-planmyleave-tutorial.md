...
6. 在搜尋方塊中，輸入 **PlanMyLeave**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-planmyleave-tutorial/tutorial_planmyleave_01.png)
    
7. 在結果窗格中，選取 [PlanMyLeave]，然後按一下 [完成] 以新增應用程式。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-planmyleave-tutorial/tutorial_planmyleave_011.png)
...
在本節中，您會在傳統入口網站中啟用 Azure AD 單一登入，然後在您的 PlanMyLeave 應用程式中設定單一登入。


**若要使用 PlanMyLeave 設定 Azure AD 單一登入，請執行下列步驟：**

1. 在傳統入口網站的 [PlanMyLeave] 應用程式整合頁面上，按一下 [設定單一登入] 來開啟 [設定單一登入] 對話方塊。
     
    ![設定單一登入][6] 

2. 在 [要如何讓使用者登入 PlanMyLeave] 頁面上，選取 [Azure AD 單一登入]，然後按 [下一步]。
...
3. 在 [設定 App 設定] 對話方塊頁面執行下列步驟：
    ...
    - 在 [登入 URL] 文字方塊中，使用以下模式輸入使用者登入您的 PlanMyLeave 應用程式時所使用的 URL：`https://<company-name>.planmyleave.com/Login.aspx`。
    
    > [!NOTE]
    > 請注意，您必須使用實際的「登入 URL」來更新這些值。 若要取得這些值，請連絡 [PlanMyLeave 支援小組](emaiLto:support@planmyleave.com)。
         
4. 在 [設定在 PlanMyLeave 單一登入] 頁面上，按一下 [下載中繼資料]，然後將檔案儲存在您的電腦中：

    ![設定單一登入](./media/active-directory-saas-planmyleave-tutorial/tutorial_planmyleave_05.png)
   
5. 若要為您的應用程式設定 SSO，請在<a href=“mailto:support@planmyleave.com”>這裡</a>聯絡 PlanMyLeave 支援小組，並提供下列資訊：
...
1. 在 **Azure 傳統入口網站**中，按一下左方瀏覽窗格的 [Active Directory]。
    ...
    ![建立 Azure AD 測試使用者](./media/active-directory-saas-planmyleave-tutorial/create_aaduser_09.png) 
...
5. 在 [告訴我們這位使用者] 對話方塊頁面上，執行下列步驟： ![建立 Azure AD 測試使用者](./media/active-directory-saas-planmyleave-tutorial/create_aaduser_05.png) 
...
6.  在 [使用者設定檔] 對話方塊頁面上，執行下列步驟：![建立 Azure AD 測試使用者](./media/active-directory-saas-planmyleave-tutorial/create_aaduser_06.png) 
...
7. 在 [取得暫時密碼] 對話方塊頁面上，按一下 [建立]。
    ...
    ![建立 Azure AD 測試使用者](./media/active-directory-saas-planmyleave-tutorial/create_aaduser_07.png) 

8. 在 [取得暫時密碼]  對話方塊頁面上，執行下列步驟：

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-planmyleave-tutorial/create_aaduser_08.png) 
...
在本節中，您會在 PlanMyLeave 中建立名為 Britta Simon 的使用者。 請在<a href=“mailto:support@planmyleave.com”>這裡</a>利用 PlanMyLeave 支援小組新增 PlanMyLeave 平台中的使用者。
