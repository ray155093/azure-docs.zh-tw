...
若要設定將 Atomic Learning 整合到 Azure AD 中，您需要從資源庫將 Atomic Learning 新增到受管理的 SaaS 應用程式清單。
...
3. 在 [Atomic Learning 網域及 URL] 區段上，執行下列步驟：
    ...
    > [!NOTE] 
    > 這不是真正的值。 使用實際的「登入 URL」來更新此值。 請連絡 [Atomic Learning 用戶端支援小組](mailto:cs@atomiclearning.com)以取得此值。 
