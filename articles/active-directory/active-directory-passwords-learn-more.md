---
title: "深入了解：Azure AD 密碼管理 | Microsoft Docs"
...
> [!NOTE]
> 「辦公室電話」不會出現在註冊入口網站中，因為使用者目前無法在目錄中編輯此屬性。
>
>
...
#### <a name="data-accessible-with-azure-ad-powershell"></a>可使用 Azure AD PowerShell 存取的資料
...
##### <a name="alternate-email"></a>替代電子郵件
```
Connect-MsolService
