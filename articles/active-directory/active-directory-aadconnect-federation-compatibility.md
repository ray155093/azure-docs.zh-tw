...
如需有關搭配 AD FS 使用 Azure Active Directory 的詳細資訊，請參閱 [Active Directory 同盟服務 (ADFS)](connect/active-directory-aadconnect-get-started-custom.md#configuring-federation-with-ad-fs)
