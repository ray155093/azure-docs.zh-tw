...
本教學課程的目的是要示範如何設定 Azure Active Directory 與 New Relic 之間的單一登入 (SS)O)。
...
5. 在 [欲執行動作] 對話方塊上，按一下 [從資源庫中新增應用程式]。
   ...
   ![從資源庫新增應用程式](./media/active-directory-saas-new-relic-tutorial/IC749322.png "從資源庫新增應用程式")
6. 在**搜尋方塊**中輸入 **New Relic**。
   
   ![應用程式資源庫](./media/active-directory-saas-new-relic-tutorial/IC797031.png "應用程式資源庫")
