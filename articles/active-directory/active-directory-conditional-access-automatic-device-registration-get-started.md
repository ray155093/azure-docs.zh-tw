...
> [!NOTE]
> 執行 Windows 10 11 月更新之已加入網域的 Windows 10 電腦只有在已設定導入群組原則物件的情況下，才會自動向 Azure AD 註冊。
> 
> 
...
> [!NOTE]
> 對於所有非 Windows 10/Windows Server 2016 電腦，建議使用如本文件後面所述的 Windows Installer 套件。
> 
> 
