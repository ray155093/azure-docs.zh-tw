<properties
	pageTitle="教學課程：Azure Active Directory 與 Predictix Price Reporting 整合 | Microsoft Azure"
...
# 教學課程：Azure Active Directory 與 Predictix Price Reporting 整合
...
1. 從資源庫加入 Predictix Price Reporting
2. 設定並測試 Azure AD 單一登入


## 從資源庫加入 Predictix Price Reporting
若要設定 Predictix Price Reporting 與 Azure AD 的整合作業，您需要從資源庫將 Predictix Price Reporting 加入受管理的 SaaS 應用程式清單中。

**若要從資源庫加入 Predictix Price Reporting，請執行下列步驟：**
...
建立此連結關聯性的方法是將 Azure AD 中**使用者名稱**的值指定為 Predictix Price Reporting 中 **Username** 的值。

若要使用 Predictix Price Reporting 設定並測試 Azure AD 單一登入，您需要完成下列建置組塊：

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
3. **[建立 Predictix Price Reporting 測試使用者](#creating-a-predictix-price-reporting-test-user)** - 在 Predictix Price Reporting 中建立 Britta Simon 的對應項目，且該項目必須與 Azure AD 中代表 Britta Simon 的項目連結。
4. **[指派 Azure AD 測試使用者](#assigning-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** - 驗證組態是否能運作。

### 設定 Azure AD 單一登入

在本節中，您會在傳統入口網站中啟用 Azure AD 單一登入，並在您的 Predictix Price Reporting 應用程式中設定單一登入。


**若要使用 Predictix Price Reporting 設定 Azure AD 單一登入，請執行下列步驟：**

1. 在傳統入口網站的 [Predictix Price Reporting] 應用程式整合頁面上，按一下 [設定單一登入] 來開啟 [設定單一登入] 對話方塊。
...
5. 若要為您的應用程式設定 SSO，請連絡 Predictix Price Reporting 支援小組，並提供下列資訊：
...
5. 在 [告訴我們這位使用者] 對話方塊頁面上，執行以下步驟：![建立 Azure AD 測試使用者](./media/active-directory-saas-predictixpricereporting-tutorial/create_aaduser_05.png)
...
### 建立 Predictix Price Reporting 測試使用者

在本節中，您要在 Predictix Price Reporting 中建立名為 Britta Simon 的使用者。請與 Predictix Price Reporting 支援小組合作，在 Predictix Price Reporting 平台加入使用者。


### 指派 Azure AD 測試使用者

在本節中，您會把 Predictix Price Reporting 的存取權授與 Britta Simon，讓她能夠使用 Azure 單一登入。
