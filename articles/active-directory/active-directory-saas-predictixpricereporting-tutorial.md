...
5. 在 [告訴我們這位使用者]  對話方塊頁面上，執行下列步驟：
    ...
    ![建立 Azure AD 測試使用者](./media/active-directory-saas-predictixpricereporting-tutorial/create_aaduser_05.png) 
...
### <a name="creating-an-predictix-price-reporting-test-user"></a>建立 Predictix Price Reporting 測試使用者
