---
title: "目前無法使用伺服器上的資料庫，連接到 SQL Database | Microsoft Docs"
...
---
# <a name="error-database-on-server-is-not-currently-available-when-connecting-to-sql-database"></a>連接到 SQL Database 時發生「目前無法使用伺服器上的資料庫」錯誤
