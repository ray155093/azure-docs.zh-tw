...
- Azure Active Directory 支援來自 SQL Server Management Studio 的連線，其中使用包含 Multi-Factor Authentication (MFA) 的 Active Directory 通用驗證。MFA 提供堅強的驗證功能，可利用多種簡易驗證選項，例如，電話、簡訊、含有 PIN 的智慧卡或行動應用程式通知。
