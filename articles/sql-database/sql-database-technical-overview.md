...
本文介紹與效能、延展性和管理能力相關的 SQL Database 核心概念和功能，並提供連結讓您進一步了解詳細資料。 如果您已準備開始進行實際操作教學課程，請移至[建立您的第一個 SQL Database](sql-database-get-started.md)，或者[建立彈性集區](sql-database-elastic-pool-manage-portal.md)。 如需簡短的影片示範，請觀看此影片。
