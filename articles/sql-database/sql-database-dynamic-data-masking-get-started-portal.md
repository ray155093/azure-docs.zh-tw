---
title: 開始使用 SQL Database 動態資料遮罩 (Azure 傳統入口網站)
...
> [!NOTE]
> 若要在 Azure 入口網站中設定動態資料遮罩，請參閱[開始使用 SQL Database 動態資料遮罩 (Azure 入口網站)](sql-database-dynamic-data-masking-get-started.md)。
> 
> 
