---
title: 使用 Azure 入口網站監視和管理彈性資料庫集區 | Microsoft Docs
...
---
# <a name="monitor-and-manage-an-elastic-database-pool-with-the-azure-portal"></a>使用 Azure 入口網站監視和管理彈性資料庫集區
...
## <a name="elastic-pool-monitoring"></a>彈性集區監視
...
## <a name="create-and-manage-elastic-jobs"></a>建立及管理彈性工作
