...
> [!NOTE]
> [Active Geo-Replication](sql-database-geo-replication-overview.md) 現在可供所有服務層中的所有資料庫使用。
> 
> 
...
> [!NOTE]
> **INFORMATION\_SCHEMA** 和 **sys** 使用者擁有 *NULL* SID，而**客體** SID 是 **0x00**。如果資料庫建立者是伺服器系統管理員，而不是 **DbManager** 的成員，**dbo** SID 可能會以 *0x01060000000001648000000000048454* 開頭。
> 
> 
