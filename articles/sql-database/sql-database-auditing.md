...
## <a id="subheading-1"></a>Azure SQL Database 稽核概觀
SQL Database 稽核可讓您：
...
## <a id="subheading-8"></a>伺服器稽核原則繼承中 Blob/資料表的差異
...
## <a id="subheading-5"></a>生產環境中的使用方式作法
