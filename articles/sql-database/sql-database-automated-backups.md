...
降級為較低的效能層之後，還原點的保留期限會立即縮短為目前資料庫效能層的保留期限。如果升級服務層，只有在升級資料庫之後，保留期限才會開始延長。例如，如果資料庫從 P1 降級為 S3，保留期限會立即從 35 天變更為 35 天，而且將無法再使用 35 天以前的所有還原點。之後，如果重新升級為 P1，保留期限一開始會是 35 天，再慢慢延長為 35 天。
