...
[使用 Tedious Node.js Driver for SQL Server 的必要條件](https://msdn.microsoft.com/library/mt652094.aspx)
...
* 更多有關 [Microsoft Node.js Driver for SQL Server](https://msdn.microsoft.com/library/mt652093.aspx)
