...
---
# <a name="move-databases-between-servers-between-subscriptions-and-in-and-out-of-azure"></a>在伺服器之間、訂用帳戶之間移動資料庫，以及將資料庫移入或移出 Azure
...
## <a name="to-migrate-a-sql-database-into-azure"></a>若要將 SQL Database 移轉到 Azure
* 判斷資料庫相容性，然後根據您的需求，挑選正確的移轉方法。 請依照 [移轉 SQL Server 資料庫](sql-database-cloud-migrate.md)中的指導方針和選項操作。

## <a name="to-create-a-copy-of-a-database-for-use-outside-of-azure"></a>若要建立資料庫複本以供 Azure 外部使用
