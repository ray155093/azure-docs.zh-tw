...
## <a name="why-does-the-azure-portal-show-my-web-and-business-edition-databases-as-retired"></a>為什麼 Azure 入口網站沒有將我的 Web 和 Business 版本資料庫顯示為「已淘汰」？
...
## <a name="which-new-service-tier-is-the-best-choice-to-upgrade-my-existing-web-or-business-database-to"></a>哪一個新服務層是將我現有的 Web 或 Business 資料庫升級的最佳選擇？
...
## <a name="why-is-microsoft-introducing-new-service-tiers"></a>Microsoft 為什麼推出新服務層？
...
## <a name="where-can-i-learn-more-about-the-new-service-tiers"></a>我可以在何處進一步了解新的服務層？
...
## <a name="what-features-or-functionality-will-not-be-available-in-basic-standard-and-premium"></a>基本、標準和高階中無法使用哪些特性或功能？
...
## <a name="how-does-basic-standard-and-premium-improve-my-billing-experience"></a>基本、標準和高階如何改善我的計費體驗？
