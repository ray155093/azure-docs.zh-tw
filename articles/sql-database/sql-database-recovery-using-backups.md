...
* 要在目標區域中處理的並行還原要求數目。
  ...
  針對非常大型及/或作用中的資料庫，還原可能需要數小時。如果某區域中的中斷延長，其他區域可能將要處理大量的異地還原要求。如果有大量的要求，可能會增加該區域中的資料庫復原時間。大多數資料庫的還原會在 12 小時內完成。
...
| [Get-AzureRMSqlDeletedDatabaseBackup](https://msdn.microsoft.com/zh-TW/library/azure/mt693387.aspx) |取得可還原的已刪除資料庫。 |
