---
title: "SSMS：從 BACPAC 檔案匯入到 Azure SQL Database | Microsoft Docs"
description: "本文說明如何使用 SQL Server Management Studio 中的「匯出資料層應用程式精靈」從 BACPAC 檔案匯入到 SQL Database。"
keywords: "Microsoft Azure SQL Database、資料庫部署、資料庫移轉、匯入資料庫，匯出資料庫、移轉精靈"
...
---
# <a name="import-from-bacpac-to-sql-database-using-ssms"></a>使用 SSMS 從 BACPAC 匯入到 SQL Database
...
> [!NOTE]
> 下列步驟假設您已佈建 Azure SQL 邏輯執行個體，並且手邊有連接資訊。
> 
> 
