...
---
# <a name="managing-azure-sql-databases-using-the-azure-portal"></a>使用 Azure 入口網站管理 Azure SQL Database
...
## <a name="how-do-i-failover-to-a-geo-replicated-sql-database"></a>如何容錯移轉至異地複寫的 SQL Database？
