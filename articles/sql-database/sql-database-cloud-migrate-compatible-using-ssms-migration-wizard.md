---
title: "SSMS：將 SQL Server 資料庫移轉到 Azure SQL Database | Microsoft Docs"
description: "本文說明如何使用 SQL Server Management Studio 中的「將資料庫部署到 Microsoft Azure 資料庫」精靈，將相容的 SQL Server 資料庫直接移轉到 Azure SQL Database 伺服器。"
keywords: "Microsoft Azure SQL Database, 資料庫移轉, Microsoft Azure 資料庫精靈"
...
---
# <a name="migrate-sql-server-database-to-sql-database-using-deploy-database-to-microsoft-azure-database-wizard"></a>使用「將資料庫部署到 Microsoft Azure Database 精靈」將 SQL Database 移轉到 SQL Database
...
本文說明如何使用 SQL Server Management Studio 中的「將資料庫部署到 Microsoft Azure 資料庫」精靈，將[相容的 SQL Server 資料庫](sql-database-cloud-migrate.md)直接移轉到 Azure SQL Database 伺服器。

## <a name="use-the-deploy-database-to-microsoft-azure-database-wizard"></a>使用「將資料庫部署到 Microsoft Azure Database 精靈」
> [!NOTE]
...
5. 在 [連接到伺服器] 對話方塊中，輸入連接到 SQL Database 伺服器的連接資訊。 若要取得現有伺服器的伺服器名稱，請移至[檢視和更新 SQL Database 伺服器及其設定](sql-database-view-update-server-settings.md)。
