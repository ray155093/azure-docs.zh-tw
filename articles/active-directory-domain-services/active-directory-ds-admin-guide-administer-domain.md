...
# 管理 Azure AD 網域服務受管理的網域
本文說明如何管理 Azure AD 網域服務受管理的網域。
...
- 你不會擁有受管理網域的「網域系統管理員」或「企業系統管理員」權限。
...
## 在虛擬機器上安裝 Active Directory 系統管理工具
