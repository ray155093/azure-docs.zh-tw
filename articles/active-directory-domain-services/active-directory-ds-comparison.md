...
## 比較 Azure AD 網域服務與 Azure 中的 DIY AD 網域
下表可協助您決定使用 Azure AD 網域服務或在 Azure 中管理自己的 AD 基礎結構。

|功能|Azure AD 網域服務|Azure VM 中的「自己動手做」AD|
|---|:---:|:---:|
|[**受管理的服務**](active-directory-ds-comparison.md#managed-service)|是|否|
|[**安全的部署**](active-directory-ds-comparison.md#secure-deployments)|是|系統管理員必須確保部署安全。|
|[**DNS 伺服器**](active-directory-ds-comparison.md#dns-server)|是 (受管理的服務)|是|
|[**網域或企業系統管理員權限**](active-directory-ds-comparison.md#domain-or-enterprise-administrator-privileges)|否|是|
|[**加入網域**](active-directory-ds-comparison.md#domain-join)|是|是|
|[**使用 NTLM 和 Kerberos 的網域驗證**](active-directory-ds-comparison.md#domain-authentication-using-ntlm-and-kerberos)|是|是|
|[**自訂 OU 結構**](active-directory-ds-comparison.md#custom-ou-structure)|是|是|
|[**結構描述擴充功能**](active-directory-ds-comparison.md#schema-extensions)|否|是|
|[**AD 網域/樹系信任**](active-directory-ds-comparison.md#ad-domain-or-forest-trusts)|否|是|
|[**LDAP 讀取**](active-directory-ds-comparison.md#ldap-read)|是|是|
|[**安全的 LDAP (LDAPS)**](active-directory-ds-comparison.md#secure-ldap)|是|是|
|[**LDAP 寫入**](active-directory-ds-comparison.md#ldap-write)|否|是|
|[**群組原則**](active-directory-ds-comparison.md#group-policy)|簡單|完整|
|[**分散各地的部署**](active-directory-ds-comparison.md#geo-dispersed-deployments)|否|是|
