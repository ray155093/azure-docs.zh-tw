---
title: "使用 Resource Manager 範本建立 VNet 對等互連 | Microsoft Docs"
...
---
# <a name="create-vnet-peering-using-resource-manager-templates"></a>使用 Resource Manager 範本建立 VNet 對等互連
