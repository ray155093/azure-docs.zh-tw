...
[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/learn-about-deployment-models-classic-include.md)] 了解如何[使用 Resource Manager 模型執行這些步驟](virtual-network-deploy-multinic-arm-ps.md)。
...
2. 填寫認證提示中所需的資訊，並按一下 [確定]。即會顯示下列輸出。
