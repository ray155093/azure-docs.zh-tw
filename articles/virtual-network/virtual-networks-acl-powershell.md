---
title: "如何使用 PowerShell 管理端點的存取控制清單 (ACL)"
...
---
# <a name="how-to-manage-access-control-lists-acls-for-endpoints-by-using-powershell"></a>如何使用 PowerShell 管理端點的存取控制清單 (ACL)
