---
title: "使用 PowerShell 建立具有靜態公用 IP 的 VM | Microsoft Docs"
description: "了解如何使用 PowerShell 透過 Azure Resource Manager 建立具有靜態公用 IP 位址的 VM。"
...
---
# <a name="create-a-vm-with-a-static-public-ip-using-powershell"></a>使用 PowerShell 建立具有靜態公用 IP 的 VM
