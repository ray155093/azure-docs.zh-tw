---
title: 在資源管理員中使用 Preview 入口網站管理 NSG | Microsoft Docs
...
1. 在資源清單中，尋找顯示 NSG 圖示的項目，如下圖 [資源] 刀鋒視窗所示。
...
1. [輸入安全性規則] 刀鋒視窗隨即會出現，如下圖所示。

![Azure 入口網站 - NSG](./media/virtual-network-manage-nsg-arm-portal/figure6.png)

1. 在 [設定] 索引標籤中，按一下 [輸出安全性規則] 以查看輸出規則。

> [!NOTE]
> 若要檢視預設規則，請按一下顯示規則之刀鋒視窗頂端的 [預設規則] 圖示。
> 
> 
...
1. 在 [設定] 索引標籤中，按一下 [網路介面] 以檢視與 NSG 相關聯的 NIC。
...
> [!NOTE]
> 您也可以從 NSG 的 [設定] 刀鋒視窗建立 NSG 與子網路之間的關聯。
> 
> 
