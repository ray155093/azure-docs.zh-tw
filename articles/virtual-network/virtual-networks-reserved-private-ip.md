...
> [!IMPORTANT]
> Azure 建立和處理資源的部署模型有二種：[資源管理員和傳統](../resource-manager-deployment-model.md)。本文涵蓋之內容包括使用傳統部署模型。Microsoft 建議讓大部分的新部署使用 [Resource Manager 部署模型](virtual-networks-static-private-ip-arm-ps.md)。
> 
> 
...
> [!NOTE]
> 如果您想要在安全環境中測試上述命令，請遵循＜[建立虛擬網路](virtual-networks-create-vnet-classic-portal.md)＞中的指導方針，建立稱為 *TestVnet* 的 VNet，並確保其會使用 *10.0.0.0/8* 位址空間。
> 
> 
