---
title: 使用 ARM 範本建立虛擬網路 | Microsoft Docs
...
本文件說明如何使用資源管理員部署模型建立 VNet。您也可以[在傳統部署模型中建立虛擬網路](virtual-networks-create-vnet-classic-pportal.md)。
...
[!INCLUDE [vvirtual-networks-create-vnet-arm-template-cli-include](../../includes/virtual-networks-create-vnet-arm-template-cli-include.md)]
