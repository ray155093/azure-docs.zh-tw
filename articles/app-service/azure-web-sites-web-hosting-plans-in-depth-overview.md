...
[Azure App Service](http://go.microsoft.com/fwlink/?LinkId=529714) 中的 Web Apps、Mobile Apps、Function Apps 或 API Apps 全部都在 App Service 方案中執行。  相同訂用帳戶及區域和資源群組中的應用程式可以共用 App Service 方案。 
