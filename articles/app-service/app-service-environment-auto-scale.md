...
在本文中，我將導覽設定自動調整時的所有必要考量，以及在我們納入 **App Service 環境** ASE 所裝載的自動調整時派上用場的所有互動。
...
了解及計算 **App Service 方案擴大率**對 **App Service 環境**自動調整來說很重要，因為**背景工作集區**的調整變更並非瞬間完成，需要一些時間才能套用。
