...
> [AZURE.NOTE] 本文不適用於 Enterprise 合約 (EA) 客戶。 如果您對於本文任何內容有需要進一步的協助，請[連絡支援人員](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade)以快速解決您的問題。
...
>[AZURE.NOTE] 若要取得 Office 365 訂用帳戶，註冊所用的帳戶必須是 Azure Active Directory 租用戶中全域管理員或帳務管理員目錄角色的成員。 [了解如何判斷 Azure Active Directory 中的角色](#how-to-know-your-role-in-your-azure-active-directory)。

若要了解將訂用帳戶新增至帳戶時的整體運作情形，請參閱[本文章後續的背景資訊](#background-information)。
...
>[AZURE.NOTE] 若要取得 Office 365 訂用帳戶，登入所用的帳戶必須是 Azure Active Directory 租用戶中全域管理員或帳務管理員目錄角色的成員。 [了解如何得知 Azure Active Directory 中的角色](#how-to-know-your-role-in-your-azure-active-directory)。
...
>[AZURE.NOTE] Azure 訂用帳戶是由目錄中的個別使用者所擁有。

>[AZURE.NOTE] Office 365 訂用帳戶是由目錄本身所擁有。 如果目錄中的使用者擁有必要權限，他們就可以操作這些訂用帳戶。
...
> [AZURE.NOTE] 如果您仍有問題，請[連絡支援人員](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade)以快速解決您的問題。
