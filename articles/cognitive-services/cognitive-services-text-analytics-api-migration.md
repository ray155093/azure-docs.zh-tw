...
---
# <a name="upgrading-to-version-2-of-the-text-analytics-api"></a>升級到第 2 版文字分析 API
...
### <a name="part-2-update-the-headers"></a>第 2 部分。 更新標頭
...
### <a name="part-4a-update-the-formats-for-sentiment-key-phrases-and-languages"></a>第 4a 部分。 更新的情感、主要片語和語言的格式
...
#### <a name="output-from-sentiment"></a>情感的輸出
**第 1 版**
...
#### <a name="output-from-key-phrases"></a>主要片語的輸出
**第 1 版**
...
#### <a name="output-from-languages"></a>語言的輸出
**第 1 版**
...
### <a name="part-4b-update-the-formats-for-topics"></a>第 4b 部分。 更新主題的格式
#### <a name="endpoints"></a>端點
|  | 第 1 版端點 | 第 2 版端點 |
| --- | --- | --- |
...
#### <a name="submission-results"></a>提交結果
**第 1 版 (POST)**
...
### <a name="part-5-test-it"></a>第 5 部分。 測試它！
