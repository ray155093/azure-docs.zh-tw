...
> [AZURE.SELECTOR] - [Graphical](automation-first-runbook-graphical.md) - [PowerShell](automation-first-runbook-textual-powershell.md) - [PowerShell 工作流程](automation-first-runbook-textual.md)  
> 
> 
...
5. 在此情況下，我們要建立 [PowerShell Runbook](automation-runbook-types.md#powershell-runbooks)，因此請選取 [PowerShell] 作為 [Runbook 類型]。  
...
1. 我們的 Runbook 目前是空白的，輸入「Write-Output "Hello World."」 。  
   ![](media/automation-first-runbook-textual-powershell/automation-helloworld.png)  
...
8. 關閉 [輸出] 窗格。
9. 按一下 [所有記錄檔]  以開啟 Runbook 作業的 [資料流] 窗格。 我們應該只會在輸出資料流中看到「Hello World」  ，但可能也會顯示 Runbook 作業的其他資料流，例如 Runbook 寫入時發生的詳細資訊和錯誤。  
   ![](media/automation-first-runbook-textual-powershell/automation-alllogs.png)  
