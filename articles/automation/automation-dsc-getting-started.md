...
> [AZURE.NOTE] 當您在 Azure 自動化中編譯組態時，它會自動將任何已建立的節點組態 MOF 部署至提取伺服器。
...
## 將 Azure VM 上架以供 Azure 自動化 DSC 管理
...
### 將 Azure Resource Manager VM 上架以便 Azure 自動化 DSC 管理
...
6. 在 [選取 VM] 刀鋒視窗中，選取您要上架的 VM，然後按一下 [確定]。
    ...
    >[AZURE.IMPORTANT] 這必須是執行 Windows Server 2008 R2 或更新版本的 Azure Resource Manager VM。
