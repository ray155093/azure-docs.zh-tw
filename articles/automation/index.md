---
title: "Azure 自動化文件 - 教學課程和 API 參考 | Microsoft Docs"
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>建立第一個 PowerShell 工作流程 Runbook</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>利用 PowerShell 工作流程開始使用自動化</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/powershell/servicemanagement/azure.automation/v3.1.0/azure.automation">傳統 PowerShell</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://msdn.microsoft.com/library/azure/mt163781">傳統 REST API</a></p>
                    </div>
                </div>
            </div>
        </div>
