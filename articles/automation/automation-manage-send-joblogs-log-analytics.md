---
title: 從「自動化」將工作狀態和工作資料流轉送到 Log Analytics (OMS) | Microsoft Docs
...
| resultDescription |說明 Runbook 作業的結果狀態。  可能的值包括：<br>- Job is started (作業已啟動)<br>- Job Failed (作業失敗)<br>- Job Completed |
