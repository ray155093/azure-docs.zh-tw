...
# 使用 PowerShell 透過應用程式閘道設定 SSL 原則和端對端 SSL
...
瀏覽 [Web 應用程式防火牆概觀](application-gateway-webapplicationfirewall-overview.md)，以了解如何透過應用程式閘道以 Web 應用程式防火牆強化 Web 應用程式的安全性
