...
>[AZURE.NOTE] 如果您需要為應用程式閘道設定自訂探查，請參閱 [使用 PowerShell 建立具有自訂探查的應用程式閘道](application-gateway-create-probe-ps.md)。 請造訪[自訂探查和健全狀況監視](application-gateway-probe-overview.md)以取得詳細資訊。
...
設定名為 "pool01" 和 "pool2" 的後端 IP 位址集區，"pool1" 的 IP 位址為 "10.0.1.100、10.0.1.101、10.0.1.102"，而 "pool2" 的 IP 位址為 "10.0.1.103、10.0.1.104、10.0.1.105"。
