---
title: 使用 Azure 資源管理員建立、啟動或刪除應用程式閘道 | Microsoft Docs
...
> [!NOTE]
> InstanceCount 的預設值是 2，最大值是 10。GatewaySize 的預設值是 Medium。您可以在 Standard\_Small、Standard\_Medium 和 Standard\_Large 之間選擇。
> 
> 
