<properties 
   pageTitle="監視應用程式閘道的存取和效能記錄檔與度量 | Microsoft Azure"
...
若要查看目前支援的度量清單，請瀏覽[支援 Azure Monitor 的度量](../azure-portal/monitoring-supported-metrics.md)
...
若要深入了解 Webhook 以及其如何與警示搭配使用，請造訪[針對 Azure 度量警示設定 Webhook](../azure-portal/insights-webhooks-alerts.md)
