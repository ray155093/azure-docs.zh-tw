...
## <a name="linking-in-templates"></a>範本中的連結
...
## <a name="linking-with-rest-api"></a>使用 REST API 連結
若要定義已部署資源之間的連結，請執行：
...
如需其他範例，包括如何抓取連結的相關資訊，請參閱[連結的資源](https://docs.microsoft.com/rest/api/resources/resourcelinks)。
