...
---
# <a name="use-azure-resource-explorer-to-view-and-modify-resources"></a>使用 Azure 資源總管來檢視及修改資源
...
## <a name="performing-actions-on-resources"></a>在資源上執行動作
...
## <a name="invoking-the-api-via-powershell"></a>透過 PowerShell 叫用 API
