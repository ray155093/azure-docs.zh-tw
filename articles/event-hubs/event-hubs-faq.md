...
# <a name="event-hubs-faq"></a>事件中樞常見問題集
...
## <a name="can-i-use-a-single-amqp-connection-to-send-and-receive-from-event-hubs-and-service-bus-queues/topics?"></a>我可以使用一個 AMQP 連線在事件中樞與服務匯流排佇列/主題之間傳送及接收嗎？
