...
> [AZURE.NOTE] 適用於 Windows IaaS VM 的 Azure 磁碟加密現已[公開上市](https://blogs.msdn.microsoft.com/azuresecurity/2016/05/20/azure-disk-encryption-for-windows-virtual-machines-reaches-general-availability/)。
