...
我們知道安全性是雲端中的首要工作和其重要性，因為您可在其中找到精確且及時的 Azure 安全性資訊。將 Azure 用於您應用程式和服務的其中一個最佳原因，是利用我們提供的各種安全性工具和功能協助您在安全 Azure 平台上建立安全的解決方案。

這個頁面和這個網站會隨著時間持續發展 - 就像新的 Azure 服務會不斷地上線，並快速更新現有的服務，就像我們在這裡做的一樣。我們的安全性產品會不斷地改善，並在這裡分享這些增強功能的技術詳細資料。建議您定期回到這個網站，並查看最新消息！
...
> [AZURE.NOTE] 我們在 Azure 安全性資訊網站中的所有文章都會出現在這個頁面左側的導覽中。如果您想要查看所有文章，只要按一下或點選 [類別] 清單底部的 [更多資訊]。
