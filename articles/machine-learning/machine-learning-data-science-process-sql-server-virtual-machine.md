---
title: "處理 SQL Azure 的資料 | Microsoft Docs"
...
---
# <a name="a-nameheadingaprocess-data-in-sql-server-virtual-machine-on-azure"></a><a name="heading"></a>在 Azure 上處理 SQL Server 虛擬機器中的資料
...
### <a name="a-namesql-dataexplorationadata-exploration"></a><a name="sql-dataexploration"></a>資料探索
...
### <a name="a-namesql-featuregenafeature-generation"></a><a name="sql-featuregen"></a>功能產生
