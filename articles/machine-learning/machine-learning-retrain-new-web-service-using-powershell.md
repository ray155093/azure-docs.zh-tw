<properties
	pageTitle="使用 Machine Learning Management PowerShell Cmdlet 重新定型新的 Web 服務 | Microsoft Azure"
...
# 使用 Machine Learning Management PowerShell Cmdlet 重新定型新的 Web 服務

當您重新定型新的 Web 服務時，可以更新預測性 Web 服務定義以參考新的定型模型。

### 必要條件

您必須已設定訓練實驗與預測性實驗，如以程式設計方式重新定型機器學習服務模型中所示。如需建立訓練與預測性實驗的相關資訊，請參閱 [以程式設計方式重新定型機器學習服務模型](以程式設計方式重新定型機器學習服務模型.md)。
