...
> [!NOTE]
> Azure Data Lake Store (ADLS) 和 Azure Data Lake Analytics (ADLA) 服務都在預覽階段，您需要經過核准才能使用。當您建立第一個 ADLS 或 ADLA 時會提示您註冊。若要註冊，按一下 [註冊以預覽]、閱讀合約，然後按一下 [確定]。例如，以下是 ADLS 註冊頁面︰
> 
> 
