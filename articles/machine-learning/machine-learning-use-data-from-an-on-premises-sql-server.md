---
title: "在 Machine Learning 中使用來自內部部署 SQL Server 資料庫的資料 | Microsoft Docs"
...
您可以在[利用資料管理閘道在內部部署來源和雲端之間移動資料](../data-factory/data-factory-move-data-between-onprem-and-cloud.md)一文中，找到有關安裝必要條件、安裝步驟及疑難排解秘訣的詳細資訊。
...
8. 如果您已經安裝閘道，請執行 [資料管理閘道組態管理員]，並按一下 [變更金鑰]，再貼上您複製到剪貼簿的 **閘道註冊金鑰**，然後按一下 [確定]。
...
如此即可完成 Azure Machine Learning 中的閘道器設定程序。
您現在可以開始使用內部部署資料。
