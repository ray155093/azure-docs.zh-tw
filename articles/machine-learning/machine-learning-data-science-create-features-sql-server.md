...
[AZURE.INCLUDE [cap-create-features-data-selector](../../includes/cap-create-features-selector.md)] 此選單連結的主題，說明如何在各種環境中建立資料的特性。此工作是 [Team Data Science Process (TDSP)](https://azure.microsoft.com/documentation/learning-paths/cortana-analytics-process/) 中的一個步驟。
...
* 您儲存的資料是在 SQL Server。如果不是，請參閱 [移動資料至 Azure 機器學習的 Azure SQL Database](machine-learning-data-science-move-sql-azure.md)，可以取得如何移動資料到該處的指示。
