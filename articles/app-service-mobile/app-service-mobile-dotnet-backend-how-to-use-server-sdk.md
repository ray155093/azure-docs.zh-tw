...
### <a name="how-to-adjust-the-table-paging-size"></a>做法：調整資料表分頁大小
...
在上述範例中，您應該使用 HTTPS 配置，將 Web.config 檔案中的 authAudience 和 authIssuer 應用程式設定，都設定為您應用程式根目錄的 URL。 同樣地，您應該將 authSigningKey 設定為您應用程式的簽署金鑰值。 若要取得簽署金鑰：
