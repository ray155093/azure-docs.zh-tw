...
1. 開啟 **QSTodoListViewController.cs**。 修改 **ViewDidLoad** 的方法定義，移除結尾附近的 **RefreshAsync()** 呼叫：
...
2. 修改方法 **RefreshAsync**，以驗證 **User** 屬性是否為 null。 在方法定義最上方新增下列程式碼：
...
3. 在 Visual Studio 或連線到您 Mac 上之 Xamarin 建置主機的 Xamarin Studio 中，以裝置或模擬器為目標執行用戶端專案。 確認應用程式未顯示資料。
