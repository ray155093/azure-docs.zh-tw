---
title: 使用 Azure Mobile Apps 新增推播通知至 Apache Cordova 應用程式| Microsoft Docs
...
[!INCLUDE [通知中樞 Xamarin 啟用 Apple 推播通知](../../includes/notification-hubs-xamarin-enable-apple-push-notifications.md)]
...
> [!NOTE]
> 如果您使用 Cordova 5.1.1 之前的 Cordova 版本 (建議使用 6.1.1)，您也必須在 config.xml 中將 [支援快顯通知] 旗標設定為 true。
> 
> 
