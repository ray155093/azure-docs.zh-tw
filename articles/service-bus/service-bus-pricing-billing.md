...
---
# 服務匯流排定價與計費
服務匯流排提供基本、標準和[高階](../service-bus-messaging/service-bus-premium-messaging.md)層。您可以針對建立的每個服務匯流排服務命名空間選擇一個服務層，此選取層會套用至該命名空間內建立的所有佇列、主題/訂用帳戶、轉送及事件中樞。

> [!NOTE]
> 如需目前服務匯流排的價格詳細資訊，請參閱 [Azure 服務匯流排價格頁面](https://azure.microsoft.com/pricing/details/service-bus/)和[服務匯流排常見問題集](../service-bus-messaging/service-bus-faq.md#service-bus-pricing)。
> 
> 
...
> [!NOTE]
> 標準傳訊層隨附 1,000 個代理連線 (包含在基本費用內)，而且可以在相關聯的 Azure 訂用帳戶內，讓所有佇列、主題/訂用帳戶和事件中樞共用。
> 
> [!NOTE]
...
## 常見問題集
### 如何計算轉送時數計量？
請參閱[此主題](../service-bus-messaging/service-bus-faq.md#how-is-the-relay-hours-meter-calculated)。
...
* 請參閱[服務匯流排常見問題集](../service-bus-messaging/service-bus-faq.md#service-bus-pricing)，以了解關於服務匯流排價格與計費的常見問題集。
