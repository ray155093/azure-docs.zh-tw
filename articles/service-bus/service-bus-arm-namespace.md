<properties
    pageTitle="使用 ARM 範本建立服務匯流排命名空間 | Microsoft Azure"
...
# 使用 ARM 範本建立服務匯流排命名空間

本文說明如何使用 Azure Resource Manager (ARM) 範本，建立服務匯流排「訊息」命名空間與標準/基本 SKU。本文也會定義針對部署執行而指定的參數。您可以直接在自己的部署中使用此範本，或自訂此範本以符合您的需求。
...
[![部署至 Azure](./media/service-bus-arm-namespace/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F101-servicebus-create-namespace%2Fazuredeploy.json)
