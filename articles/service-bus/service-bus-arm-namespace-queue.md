<properties
    pageTitle="建立服務匯流排命名空間與佇列 | Microsoft Azure"
    description="使用 ARM 範本建立服務匯流排命名空間和佇列"
...
# 使用 ARM 範本建立服務匯流排命名空間和佇列

本文說明如何使用 Azure Resource Manager (ARM) 範本，建立服務匯流排命名空間和佇列。您將學習如何定義要部署哪些資源，以及如何定義執行部署時所指定的參數。您可以直接在自己的部署中使用此範本，或自訂此範本以符合您的需求
...
[![部署至 Azure](./media/service-bus-arm-namespace-queue/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F201-servicebus-create-queue%2Fazuredeploy.json)
