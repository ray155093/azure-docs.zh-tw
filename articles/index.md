                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Azure IT 操作人員快速入門指南</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <ul class="pivots">
            <li>
                ...
                <ul id="services">
                    ...
                    <li>
                        <a data-default="true" href="#get-started">開始使用</a>
                        <ul id="get-started" class="cardsL">
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>部署基礎結構</h3>
                                                <a class="barLink" href="/azure/virtual-machines/linux/index">Linux 虛擬機器</a>
                                                <a class="barLink" href="/azure/virtual-machines/windows/index">Windows 虛擬機器</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>管理資料</h3>
                                                <a class="barLink" href="/azure/sql-database/index">SQL Database 即服務</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="bottomRightItem">
                              <a href="https://aka.ms/j3wr7y">
                                <button style="cursor: pointer;position: relative; background: #3498db; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">檢視所有 Azure 服務<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z"/></svg></button>
                              </a>
                            </li>
                        </ul>
                    </li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>App Service</h3>
                                                    <p>了解如何建置可擴充的 Web 與 Mobile Apps</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/dotnet/api">取得 .NET SDK</a>
                                                </h3>
                                                <p>
                                                    <a href="/azure/app-service-web/app-service-web-get-started-dotnet">開始使用</a>
                                                </p>
                                                <p>
                                                    <a href="/dotnet/api">API 參考</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/samples/?platform=dotnet">取得範例</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/develop/net/index">深入了解</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="http://azure-sdk-for-python.readthedocs.io/en/latest/index">開始使用</a>
                                                </p>
                                                <p>
                                                    <a href="http://azure-sdk-for-python.readthedocs.io/en/latest/index">API 參考</a>
                                                </p>
                                                <p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="http://azure.github.io/azure-sdk-for-node/index">開始使用</a>
                                                </p>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://github.com/Azure/azure-sdk-for-java#download">取得 Java SDK</a>
                                                </h3>
                                                <p>
                                                    <a href="/java/api/index">開始使用</a>
                                                </p>
                                                <p>
                                                    <a href="/java/api/index">API 參考</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/samples/?platform=java">取得範例</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/develop/java/index">深入了解</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://azure.microsoft.com/develop/ruby/index">深入了解</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/rest/api/index">開始使用 REST</a>
                                                </h3>
                                                <p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/articles/azure-cli-arm-commands/index">參考</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="http://storageexplorer.com/index">儲存體總管</a>
                                                </h3>
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/articles/vs-azure-tools-storage-manage-with-storage-explorer/index">開始使用</a>
                                                </p>
                                                <p>
