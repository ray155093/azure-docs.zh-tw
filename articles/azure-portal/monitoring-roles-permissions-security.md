...
- 使用 [Azure 監視器 REST API](https://msdn.microsoft.com/library/azure/dn931930.aspx)、[PowerShell Cmdlet](insights-powershell-samples.md) 或[跨平台 CLI](insights-cli-samples.md) 查詢度量。
