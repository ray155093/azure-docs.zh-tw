---
title: Azure Insights：Azure Insights CLI 快速入門範例 | Microsoft Docs
...
本文說明可協助您存取 Azure Insights 監視功能的命令列介面 (CLI) 命令範例。Azure Insights 可讓您根據設定的遙測資料值，自動調整雲端服務、虛擬機器和 Web Apps，以及傳送警示通知，或呼叫 Web URL。
...
若要使用 Azure Resource Manager 和 Azure Insights 命令，您必須處於 Azure Resource Manager 模式。
