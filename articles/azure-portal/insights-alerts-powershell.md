<properties
	pageTitle="使用 PowerShell 建立 Azure 服務的警示 | Microsoft Azure"
...
7. 若要建立活動記錄檔中特定條件發生時就會觸發的警示，使用此格式的命令︰
    ...
    -OperationName 對應到活動記錄檔中的事件類型。*Microsoft.Compute/virtualMachines/delete* 和 *microsoft.insights/diagnosticSettings/write* 都是例子。
