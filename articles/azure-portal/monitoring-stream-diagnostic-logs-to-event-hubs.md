<properties
	pageTitle="將 Azure 診斷記錄檔串流至事件中樞 | Microsoft Azure"
...
> [AZURE.WARNING] 啟用和串流來自計算資源 (例如，VM 或 Service Fabric) 的診斷記錄[需要一組不同的步驟](../event-hubs/event-hubs-streaming-azure-diags-data.md)。
