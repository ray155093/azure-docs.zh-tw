...
# 開始使用
## [使用入口網站](data-lake-analytics-get-started-portal.md)
...
### [使用 U-SQL 視窗函式](data-lake-analytics-use-window-functions.md)
### [使用 U-SQL 使用者定義的運算子](data-lake-analytics-u-sql-develop-user-defined-operators.md)

## 建立解決方案
### [分析網站記錄](data-lake-analytics-analyze-weblogs.md)

## 管理
### [使用入口網站](data-lake-analytics-manage-use-portal.md)
...
### [使用 U-SQL 目錄來架構程式碼和資料](data-lake-analytics-use-u-sql-catalog.md)
