---
title: 使用 Azure 入口網站疑難排解 Azure 資料湖分析作業 | Microsoft Docs
...
2. 按一下具有您資料湖分析帳戶名稱的磚。該建立帳戶時它便已釘選在此處。如果帳戶尚未釘選於此處，請參閱[從入口網站開啟分析帳戶](data-lake-analytics-manage-use-portal.md#access-adla-account)。
3. 從頂端功能表按一下 [**新增作業**]。
