...
---
# <a name="debug-c-code-in-u-sql-for-data-lake-analytics-jobs"></a>在 U-SQL 中偵錯 Data Lake Analytics 作業的 C# 程式碼
...
## <a name="debug-the-job"></a>對作業進行偵錯
...
2. 使用以 Visual Studio 為基礎的偵錯體驗 (監看式、變數等) 對問題進行疑難排解。 
3. 在您識別問題之後，請修正程式碼、重建 C# 專案，然後再次測試它，直到所有問題解決為止。 在順利完成偵錯之後，輸出視窗會顯示下列訊息： 
   
     程式 'LocalVertexHost.exe' 已結束，代碼為 0 (0x0)。
