...
description: "了解如何透過 .NET SDK 建立 Data Lake Analytics 帳戶、建立 Data Lake Analytics 工作，以及提交以 U-SQL 撰寫的工作。 "
...
---
# <a name="tutorial-get-started-with-azure-data-lake-analytics-using-net-sdk"></a>教學課程：透過 .NET SDK 開始使用 Azure Data Lake Analytics
[!INCLUDE [get-started-selector](../../includes/data-lake-analytics-selector-get-started.md)]

了解如何使用 Azure .NET SDK 將以 [U-SQL](data-lake-analytics-u-sql-get-started.md) 撰寫的作業提交到 Data Lake Analytics。 如需有關 Data Lake Analytics 的詳細資訊，請參閱 [Azure Data Lake Analytics 概觀](data-lake-analytics-overview.md)。

在本教學課程中，您會開發 C# 主控台應用程式來提交 U-SQL 作業，以讀取定位鍵分隔值 (TSV) 檔案，並將該檔案轉換為逗號分隔值 (CSV) 檔案。 
...
使用下列 U-SQL 指令碼建立 **SampleUSQLScript.usql** 文字檔案，然後將檔案放在 `C:\temp\` 路徑中。  此路徑會在您於下一個程序建立的 .NET 應用程式中硬式編碼。  
...
6. 查看輸出檔案。  預設路徑和檔案名稱是 c:\Temp\SearchLog-from-Data-Lake.csv。
