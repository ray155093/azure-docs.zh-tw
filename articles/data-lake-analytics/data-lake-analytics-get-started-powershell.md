---
title: 透過 Azure PowerShell 開始使用 Azure 資料湖分析 | Microsoft Docs
...
> [!NOTE]
> Azure 入口網站的使用者介面，可讓使用者將資料檔案範例複製到預設的資料湖存放區帳戶。如需相關指示，請參閱[使用 Azure 入口網站開始使用 Azure 資料湖分析](data-lake-analytics-get-started-portal.md#upload-data-to-the-default-data-lake-store-account)。
> 
> 
