...
1. 按一下 [上一步] 和 [下一步] 按鈕以顯示 [發佈精靈] 的每一頁，然後自訂此設定檔的設定。如需相關資訊，請參閱[發佈 Azure 應用程式精靈](http://go.microsoft.com/fwlink/p/?LinkID=623085)。
...
1. 按一下 [上一步] 和 [下一步] 按鈕以顯示 [發佈精靈] 的每一頁，然後變更您想要的設定。如需相關資訊，請參閱[發佈 Azure 應用程式精靈](http://go.microsoft.com/fwlink/p/?LinkID=623085)。
