...
> [AZURE.NOTE] 只有在 [Azure 管理入口網站](https://manage.windowsazure.com)的測試及預備環境中，才需要這些 Azure 訂用帳戶 ID。在 Azure Marketplace 測試不需要這些 ID。
...
> [AZURE.NOTE] 請務必檢閱視窗最上方所顯示的服務文字描述。您的產品若由多個服務呼叫組成，請按一下視窗底部的各個索引標籤記切換到下一項服務，以進行檢閱及測試。
