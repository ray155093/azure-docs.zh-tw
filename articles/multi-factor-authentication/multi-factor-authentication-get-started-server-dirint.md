...
| 繫結 DN 或繫結使用者名稱 |輸入繫結至 LDAP 目錄時要使用的帳戶的使用者記錄辨別名稱。<br><br>只有當 [繫結類型] 為 [簡單] 或 [SSL] 時，才會使用繫結辨別名稱。<br><br>當 [繫結類型] 為 [Windows] 時，輸入當繫結至 LDAP 目錄時要使用的 Windows 帳戶的使用者名稱。如果空白，將使用已登入的使用者帳戶進行繫結。 |
