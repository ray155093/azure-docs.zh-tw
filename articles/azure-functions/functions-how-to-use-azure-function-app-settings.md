...
## <a name="memory-size"></a>記憶體大小
您可以設定要在目前的函式應用程式中為您的函式配置多少記憶體。 

若要設定記憶體，請將滑桿滑到所需的記憶體數量。 最大值為 128 MB。

![設定函式應用程式記憶體大小](./media/functions-how-to-use-azure-function-app-settings/configure-function-app-memory-size.png)
...
## <a name="in-portal-console"></a>入口網站內主控台
