...
此範例指令碼會建立 Azure 函式應用程式，這是您的函式容器。 將會使用取用方案建立函式應用程式，這適用於事件驅動的無伺服器工作負載。
...
[!code-azurecli[主要](../../../cli_scripts/azure-functions/create-function-app-consumption/create-function-app-consumption.sh "在取用方案上建立 Azure 函式")]
