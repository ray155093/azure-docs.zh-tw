...
本主題說明如何建立由 GitHub Webhook 叫用的 Node.js 函式。 新的函式是根據 Azure Functions 入口網站中的預先定義範本所建立。 您也可以觀賞短片，了解如何在入口網站中執行這些步驟。
...
3. 在函式應用程式中，按一下 [+ 新增函式] > [GitHub Webhook - Node] > [建立]。 此步驟會根據指定的範本以預設名稱建立函式。 
