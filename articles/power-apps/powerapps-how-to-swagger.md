---
title: 如何為 PowerApps 和邏輯流程自訂 Swagger 定義 | Microsoft Docs
...
> [!IMPORTANT]
> 本主題已移至 powerapps.microsoft.com，位於：[為 PowerApps 和流程自訂 Swagger 定義](https://powerapps.microsoft.com/tutorials/customapi-how-to-swagger/)。請移至 PowerApps 以取得最新版本。此 Azure 連結會被封存。
> 
> 
