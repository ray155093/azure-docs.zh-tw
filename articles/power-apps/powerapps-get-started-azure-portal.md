...
- 在公司內新增使用者，並使用 [角色型存取控制](../active-directory/role-based-access-control-configure.md)，指定 PowerApps 管理員角色給這些使用者來存取 PowerApps Enterprise 入口網站。
...
一般的 Azure App Service 環境有不同的功能。如需詳細資料，請參閱 [App Service 環境簡介](../app-service-web/app-service-app-service-environment-intro.md)。
