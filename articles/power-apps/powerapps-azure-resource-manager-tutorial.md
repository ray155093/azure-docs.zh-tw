---
title: 教學課程：在 PowerApps 和邏輯流程中使用 Azure Resource Manager 建立自訂 API | Microsoft Docs
...
> [!IMPORTANT]
> 本主題已移至 powerapps.microsoft.com，位於：[教學課程：針對 PowerApps 和流程建立自訂 AAD 保護的 ARM API](https://powerapps.microsoft.com/tutorials/customapi-azure-resource-manager-tutorial/)。請移至 PowerApps 以取得最新版本。此 Azure 連結會被封存。
> 
> 
