...
>[AZURE.IMPORTANT] 本主題已移至 powerapps.microsoft.com，位於：[什麼是自訂 API](https://powerapps.microsoft.com/tutorials/register-custom-api/)。請移至 PowerApps 以取得最新版本。此 Azure 連結會被封存。
