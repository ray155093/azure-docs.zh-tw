...
>[AZURE.NOTE] SQL Database 的許多新功能只在使用 [Azure Resource Manager (ARM) 部署模型](../articles/resource-group-overview.md)時才支援，所以範例使用以 ARM 為基礎的 [Azure SQL Database PowerShell Cmdlet](https://msdn.microsoft.com/library/azure/mt574084.aspx)。現有的傳統部署模型 [Azure SQL Database (傳統) Cmdlet](https://msdn.microsoft.com/library/azure/dn546723.aspx) 支援回溯相容性，但是建議使用以 ARM 為基礎的 Cmdlet。
