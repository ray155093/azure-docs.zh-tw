...
2. 在 Jumpbar 中，按一下 [新增]  >  [物聯網]  >  [IoT 中樞]。
...
3. 在 [IoT 中樞]  刀鋒視窗中，選擇 IoT 中樞的組態。
   ...
   * 選取一個[定價和調整層][lnk-pricing]。 本教學課程不需要特定層。 在本教學課程中，使用免費的 F1 層。
   * 在 [資源群組]中，建立資源群組，或選取現有的資源群組。 如需詳細資訊，請參閱[使用資源群組來管理您的 Azure 資源][lnk-resource-groups]。
