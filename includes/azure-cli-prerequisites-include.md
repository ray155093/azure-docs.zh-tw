...
> [!NOTE]
> 如果您沒有 Azure 帳戶，就需要申請一個。 請 [在此處註冊免費試用](../articles/active-directory/sign-up-organization.md)。 此外，如果想要密切關注，您需要安裝 [jq](https://stedolan.github.io/jq/) 或一些其他的 JSON 剖析工具或程式庫。
> 
> 
