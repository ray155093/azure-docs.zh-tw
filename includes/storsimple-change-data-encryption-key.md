...
### <a name="step-1-authorize-a-device-to-change-the-service-data-encryption-key-in-the-azure-classic-portal"></a>步驟 1：在 Azure 傳統入口網站中授權裝置以變更服務資料加密金鑰
...
#### <a name="to-authorize-a-device-to-change-the-key"></a>授權裝置以變更索引鍵
...
> [!NOTE]
> 除非金鑰變換完成，否則無法在 Azure  傳統入口網站對 StorSimple Manager 服務執行任何作業。
> 
> 
