...
* [如何透過 WebJobs SDK 使用 Azure Blob 儲存體 (英文)](../articles/app-service-web/websites-dotnet-webjobs-sdk-storage-blobs-how-to.md)
* [如何透過 WebJobs SDK 使用 Azure 資料表儲存體 (英文)](../articles/app-service-web/websites-dotnet-webjobs-sdk-storage-tables-how-to.md)
* [如何搭配使用 Azure 服務匯流排與 WebJobs SDK](../articles/app-service-web/websites-dotnet-webjobs-sdk-service-bus.md)
