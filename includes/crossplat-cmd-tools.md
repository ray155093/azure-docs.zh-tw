# <a name="how-to-use-the-azure-command-line-tools-for-mac-and-linux"></a>如何使用適用於 Mac 和 Linux 的 Azure 命令列工具
...
* **Linux**：安裝最新版本的 [Node.js][nodejs-org] (請參閱[透過套件管理員來安裝 Node.js][install-node-linux])，然後執行下列命令：
