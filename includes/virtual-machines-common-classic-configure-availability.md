...
* [選項 2︰將現有的虛擬機器新增至可用性設定組][選項 2︰將現有的虛擬機器新增至可用性設定組]。
...
若要使用 Azure PowerShell 命令建立 Azure 虛擬機器，並將它新增至新的或現有的可用性設定組，請參閱[使用 Azure PowerShell 建立和預先設定以 Windows 為基礎的虛擬機器](../articles/virtual-machines/virtual-machines-windows-classic-create-powershell.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json)
...
[選項 2︰將現有的虛擬機器新增至可用性設定組]: #addmachine
