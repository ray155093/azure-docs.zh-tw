...
1. 若要建立 Twilio 連線，請在邏輯應用程式設計工具中，選取下拉式清單的 [Show Microsoft managed APIs]\(顯示 Microsoft Managed API)，然後在搜尋方塊中輸入 *Twilio*。選取您要使用的觸發程序或動作：  
...
4. Twilio 及邏輯應用程式會使用不同的名稱來識別這兩項資訊。您必須依據下列方法將其對應至邏輯應用程式對話方塊：  
   ![](./media/connectors-create-api-twilio/twilio-3.png)  
5. 選取 [建立連線] 按鈕：  
   ![](./media/connectors-create-api-twilio/twilio-4.png)
6. 請注意，此時已建立連線，您現可進行邏輯應用程式中的其他步驟：  
