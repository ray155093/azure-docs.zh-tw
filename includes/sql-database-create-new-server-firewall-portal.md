...
1. 在 SQL Server 刀鋒視窗的 [設定] 下，按一下 [防火牆] 來開啟 SQL Server 的防火牆刀鋒視窗。
    ...
    ![SQL Server 防火牆](../articles/sql-database/media/sql-database-get-started/sql-server-firewall.png)
...
3. 假設的 IP 位址相符，按一下工具列上的 [新增用戶端 IP]。
    ...
    ![新增用戶端 IP](../articles/sql-database/media/sql-database-get-started/add-client-ip.png)
