...
2. 開啟 MainPage.xaml 檔案，然後以下列程式碼取代第一個 **Task** 元素後面所緊接的 **StackPanel** 元素：
...
3. 以下列程式碼取代 **DataTemplate** 中的 **StackPanel** 元素：
...
4. 開啟 MainPage.xaml.cs 專案檔案並新增下列 **using** 陳述式：
...
7. 以下列程式碼取代現有 `InsertTodoItem` 方法：
