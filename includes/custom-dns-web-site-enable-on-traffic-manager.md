...
1. 在 [Web Apps] 索引標籤中，按一下您 Web 應用程式的名稱，並選取 [設定]，然後選取 [自訂網域]

	![](./media/custom-dns-web-site/dncmntask-cname-6.png)

1. 在 [自訂網域] 刀鋒視窗中，按一下 [新增主機名稱]。
	
1. 使用 [主機名稱] 文字方塊輸入與此 Web 應用程式相關聯的流量管理員網域名稱。
...
8.  成功驗證後，[新增主機名稱] 按鈕將會變成作用中，使您可以指派主機名稱。現在請在瀏覽器中瀏覽到您的自訂網域名稱。您現在應會看到您應用程式正在使用您的自訂網域名稱執行。
