...
| 大小 | CPU 核心 | 記憶體：GiB | 本機磁碟大小：GiB | 最大資料磁碟 | 最大資料磁碟輸送量︰IOPS | 最大 NIC / 網路頻寬 |
|-------------|-----------|--------------|-----------------------|----------------|--------------------|-----------------------|
...
| 大小 | CPU 核心 | 記憶體：GiB | 本機磁碟大小：GiB | 最大資料磁碟 | 最大資料磁碟輸送量︰IOPS | 最大 NIC / 網路頻寬 |
|--------------|-----------|--------------|----------------------|----------------|--------------------|-----------------------|
| 標準\_D1 | 1 | 3\.5 | 50 | 2 | 2x500 | 1 / 中 |
| 標準\_D2 | 2 | 7 | 100 | 4 | 4x500 | 2 / 高 |
| 標準\_D3 | 4 | 14 | 200 | 8 | 8x500 | 4 / 高 |
| 標準\_D4 | 8 | 28 | 400 | 16 | 16x500 | 8 / 高 |
| 標準\_D11 | 2 | 14 | 100 | 4 | 4x500 | 2 / 高 |
| 標準\_D12 | 4 | 28 | 200 | 8 | 8x500 | 4 / 高 |
| 標準\_D13 | 8 | 56 | 400 | 16 | 16x500 | 8 / 高 |
| 標準\_D14 | 16 | 112 | 800 | 32 | 32x500 | 8 / 非常高 |
...
| Standard\_D5\_v2 | 16 | 56 | 800 | 32 | 32x500 | 8 / 極高 |
| Standard\_D11\_v2 | 2 | 14 | 100 | 4 | 4x500 | 2 / 高 |
| Standard\_D12\_v2 | 4 | 28 | 200 | 8 | 8x500 | 4 / 高 |
| Standard\_D13\_v2 | 8 | 56 | 400 | 16 | 16x500 | 8 / 高 |
| Standard\_D14\_v2 | 16 | 112 | 800 | 32 | 32x500 | 8 / 極高 |
| Standard\_D15\_v2 | 20 | 140 | 1,000 | 40 | 40x500 | 8 / 極高 |

<br>
## DS 系列*


| 大小 | CPU 核心 | 記憶體：GiB | 本機磁碟大小：GiB | 最大資料磁碟 | 最大快取的磁碟輸送量︰IOPS / MBps (快取大小以 GiB 為單位) | 最大取消快取的磁碟輸送量︰IOPS / MBps | 最大 NIC / 網路頻寬 |
|---------------|-----------|--------------|--------------------------------|----------------|--------------------------------------------|----------------------------------------------|-----------------------|
...
| 大小 | CPU 核心 | 記憶體：GiB | 本機 SSD 磁碟大小：GiB | 最大資料磁碟 | 最大快取的磁碟輸送量︰IOPS / MBps (快取大小以 GiB 為單位) | 最大取消快取的磁碟輸送量︰IOPS / MBps | 最大 NIC / 網路頻寬 |
|------------------|-----------|--------------|---------------------------|----------------|-------------------------------------------------|-------------------------------------------------|------------------------------|
| Standard\_DS1\_v2 | 1 | 3\.5 | 7 | 2 | 4,000 / 32 (43) | 3,200 / 48 | 1 中度 |
...
| Standard\_DS5\_v2 | 16 | 56 | 112 | 32 | 64,000 / 512 (688) | 51,200 / 768 | 8 極高 |
...
| Standard\_DS14\_v2 | 16 | 112 | 224 | 32 | 64,000 / 512 (576) | 51,200 / 768 | 8 極高 |
| Standard\_DS15\_v2 | 20 | 140 GB | 280 | 40 | 80,000 / 640 (720) | 64,000 / 960 | 8 極高 |
...
| 大小 | CPU 核心 | 記憶體：GiB | 本機 SSD 磁碟大小：GiB | 最大資料磁碟 | 最大磁碟輸送量︰IOPS | 最大 NIC / 網路頻寬 |
|--------------|-----------|--------------|----------------------|----------------|--------------------|-----------------------|
...
| Standard\_F16 | 16 | 32 | 256 | 32 | 32x500 | 8 / 極高 |
...
| Standard\_F16s | 16 | 32 | 64 | 32 | 64,000 / 512 (192) | 51,200 / 768 | 8 / 極高 |
...
| 大小 | CPU 核心 | 記憶體：GiB | 本機 SSD 大小：GiB | 最大資料磁碟 | 最大磁碟輸送量︰IOPS | 最大 NIC / 網路頻寬 |
|-------------|-----------|--------------|----------------------|----------------|--------------------|-----------------------|
| Standard\_G1 | 2 | 28 | 384 | 4 | 4 x 500 | 1 / 高 |
| Standard\_G2 | 4 | 56 | 768 | 8 | 8 x 500 | 2 / 高 |
| Standard\_G3 | 8 | 112 | 1,536 | 16 | 16 x 500 | 4 / 非常高 |
| Standard\_G4 | 16 | 224 | 3,072 | 32 | 32 x 500 | 8 / 極高 |
| Standard\_G5 | 32 | 448 | 6,144 | 64 | 64 x 500 | 8 / 極高 |
...
| 大小 | CPU 核心 | 記憶體：GiB | 本機 SSD 磁碟大小：GiB | 最大資料磁碟 | 最大快取的磁碟輸送量︰IOPS / MBps (快取大小以 GiB 為單位) | 最大取消快取的磁碟輸送量︰IOPS / MBps | 最大 NIC / 網路頻寬 |
|--------------|-----------|--------------|---------------------------|--------------------------------|----------------|--------------------------------------------|----------------------------------------------|-----------------------|
| Standard\_GS1 | 2 | 28 | 56 | 4 | 10,000 / 100 (264) | 5,000 / 125 | 1 / 高 |
| Standard\_GS2 | 4 | 56 | 528 | 8 | 20,000 / 200 (528) | 10,000 / 250 | 2 / 高 |
| Standard\_GS3 | 8 | 112 | 1,056 | 16 | 40,000 / 400 (1,056) | 20,000 / 500 | 4 / 非常高 |
| Standard\_GS4 | 16 | 224 | 2,112 | 32 | 80,000 / 800 (2,112) | 40,000 / 1,000 | 8 / 極高 |
| Standard\_GS5 | 32 | 448 | 4,224 | 64 | 160,000 / 1,600 (4,224) | 80,000 / 2,000 | 8 / 極高 |
...
| 大小 | CPU 核心 | 記憶體：GiB | 本機 SSD 磁碟大小：GiB | GPU |
|---------------|-----------|--------------|---------------------------|----------------|
