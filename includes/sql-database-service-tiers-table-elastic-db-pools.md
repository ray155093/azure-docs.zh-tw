...
|:---|---:|---:|---:| ---: | ---: | ---: | ---: | ---: |
| 每個集區的最大儲存體* | 5 GB| 10 GB| 20 GB| 29 GB| 39 GB| 78 GB| 117 GB| 156 GB|
...
|:---|---:|---:|---:| ---: | ---: | ---: | ---: |---: |---: |---: |---: |
| 每個集區的最大儲存體* | 50 GB| 100 GB| 200 GB | 300 GB| 400 GB | 800 GB | 
...
| 集區大小 (eDTU)  |  **1200** | **1600** | **2000** | **2500** | 
|:---|---:|---:|---:| ---: | ---: | ---: | ---: |---: |---: |---: |
| 每個集區的最大儲存體* | 1.2 TB | 1.6 TB | 2 TB | 2.4 TB | 
| 每個集區的最大 DB 數 | 500 | 500 | 500 | 500 | 500 | 
| 每個集區的並行背景工作數上限 |  2400 | 3200 | 4000 | 5000 |
| 每集區的並行登入數上限 |  2400 | 3200 | 4000 | 5000 | 
...
|:---|---:|---:|---:| ---: | ---: | ---: | ---: |---: |---: |---: |
| 每個集區的最大儲存體* | 250 GB| 500 GB| 750 GB| 750 GB| 750 GB| 
| 每個集區的最大 DB 數 | 50 | 100 | 100 | 100 | 100 |  
| 每個集區的並行背景工作數上限 | 200 | 400 | 800 | 1600 |  2400 | 
| 每集區的並行登入數上限 | 200 | 400 | 800 | 1600 |  2400 |
| 每集區並行工作階段數上限 | 30000 | 30000 | 30000 | 30000 | 30000 | 
| 每資料庫的 eDTU 下限 | {0,25,50,75,<br>125} | {0,25,50,75,<br>125,250} | {0,25,50,75,<br>125,250,500} | {0,25,50,75,<br>125,250,500,<br>1000} | {0,25,50,75,<br>125,250,500,<br>1000} | 
| 每資料庫的 eDTU 上限 | {25,50,75,<br>125} | {25,50,75,<br>125,250} | {25,50,75,<br>125,250,500} | {25,50,75,<br>125,250,500,<br>1000} | {25,50,75,<br>125,250,500,<br>1000} |  
||||||||

### <a name="premium-elastic-pool-limits-continued"></a>高階彈性集區限制 (續)

| 集區大小 (eDTU)  |  **2000** | **2500** | **3000** | **3500** | 
|:---|---:|---:|---:| ---: | ---: | ---: | ---: |---: |---: |---: |
| 每個集區的最大儲存體* | 750 GB| 750 GB| 750 GB| 750 GB| 
| 每個集區的最大 DB 數 | 100 | 100 | 100 | 100 | 100 | 
| 每個集區的並行背景工作數上限 |  3200 | 4000 | 4800 | 5600 | 
| 每集區的並行登入數上限 |  3200 | 4000 | 4800 | 5600 | 
| 每集區並行工作階段數上限 | 30000 | 30000 | 30000 | 30000 | 30000 | 
| 每資料庫的 eDTU 下限 | {0,25,50,75,<br>125,250,500,<br>1000,1750} | {0,25,50,75,<br>125,250,500,<br>1000,1750} | {0,25,50,75,<br>125,250,500,<br>1000,1750} | {0,25,50,75,<br>125,250,500,<br>1000,1750} | 
| 每資料庫的 eDTU 上限 | {25,50,75,<br>125,250,500,<br>1000,1750} | {25,50,75,<br>125,250,500,<br>1000,1750} | {25,50,75,<br>125,250,500,<br>1000,1750} | {25,50,75,<br>125,250,500,<br>1000,1750} | 
||||||||
