...
> [AZURE.IMPORTANT] * 彈性資料庫會共用集區儲存體，所以資料庫儲存體的大小會限制為以下兩者中較小的一個：剩餘的集區儲存體或每個資料庫儲存體的上限。
...
| 每個集區的資料庫數目上限 | &nbsp;200 &nbsp;&nbsp;&nbsp;&nbsp;400 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;400 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;400 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;400 |
| 每個集區的 OLTP 記憶體內部儲存體上限 (GB)| N/A |
| 每個集區的並行背景工作數上限 | &nbsp;&nbsp;200 &nbsp;&nbsp;&nbsp; 750 &nbsp;&nbsp;&nbsp; 1300 &nbsp;&nbsp; 1850 &nbsp;&nbsp;&nbsp; 2400 |
| 每集區的並行登入數上限 | &nbsp;&nbsp;200 &nbsp;&nbsp;&nbsp; 750 &nbsp;&nbsp;&nbsp; 1300 &nbsp;&nbsp; 1850 &nbsp;&nbsp;&nbsp; 2400 |
| 每集區並行工作階段數上限 | 4800 &nbsp; 9600 &nbsp;19200 &nbsp;28800 &nbsp;&nbsp; 28800 |
| 每資料庫的 eDTU 上限 | 10、20、50、100 |
| 每資料庫的 eDTU 下限 | 0、10、20、50、100 |
| 每個資料庫的儲存體上限 (GB)* | 250 |
| 還原時間點 | 過去 35 天內任何一點 |
| 災害復原 | 主動式異地複寫 |
...
| 每集區的並行登入數上限 | &nbsp;&nbsp;200 &nbsp;&nbsp;&nbsp; 750 &nbsp;&nbsp;&nbsp; 1300 &nbsp;&nbsp; 1850 &nbsp;&nbsp;&nbsp; 2400 |
| 每集區並行工作階段數上限 | 4800 &nbsp; 9600 &nbsp;19200 &nbsp;28800 &nbsp;&nbsp; 28800 |
| 每資料庫的 eDTU 上限 | 125、250、500、1000 |
| 每資料庫的 eDTU 下限 | 0、125、250、500、1000 |
| 每個資料庫的儲存體上限 (GB)* | 500 |
| 還原時間點 | 過去 35 天內任何一點 |
| 災害復原 | 主動式異地複寫 |
