...
Dsv3 系列大小以 2.3 GHz Intel XEON ® E5-2673 v4 (Broadwell) 處理器為基礎，且搭配 Intel 渦輪加速技術 2.0 可達 3.5 GHz 並可使用進階儲存體。 Dsv3 系列大小提供 CPU、記憶體與本機磁碟組合，適用於大多數生產環境工作負載。
...
Dv3 系列大小以 2.3 GHz Intel XEON ® E5-2673 v4 (Broadwell) 處理器為基礎，且搭配 Intel 渦輪加速技術 2.0 可達 3.5 GHz。 Dv3 系列大小提供 CPU、記憶體與本機磁碟組合，適用於大多數生產環境工作負載。
...
| 大小 | CPU 核心 | 記憶體：GiB | 本機 HDD: GiB | 最大資料磁碟 | 最大資料磁碟輸送量︰IOPS | 最大 NIC/預期的網路效能 (Mbps)  |
| --- | --- | --- | --- | --- | --- | --- |
